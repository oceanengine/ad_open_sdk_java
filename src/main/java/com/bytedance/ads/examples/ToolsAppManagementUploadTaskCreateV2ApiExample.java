...
public class ToolsAppManagementUploadTaskCreateV2ApiExample {
    ...
    public static void main(String[] args) throws ApiException {
        ...
        ToolsAppManagementUploadTaskCreateV2Response response = api.openApi2ToolsAppManagementUploadTaskCreatePost(version, toolsAppManagementUploadTaskCreateV2Request);

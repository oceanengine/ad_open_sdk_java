...
public class QianchuanReportUniPromotionDimensionDataRoomGetV10ApiExample {
    ...
    public static void main(String[] args) throws ApiException {
        ...
        QianchuanReportUniPromotionDimensionDataRoomGetV10Response response = api.openApiV10QianchuanReportUniPromotionDimensionDataRoomGetGet(advertiserId, roomId, startTime, endTime, dimension, metrics, orderField, orderType, page, pageSize);

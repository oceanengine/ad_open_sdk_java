...
public class AgentQueryRiskPromotionListV2ApiExample {
    ...
    public static void main(String[] args) throws ApiException {
        ...
        List<AgentQueryRiskPromotionListV2BusinessTypeList> businessTypeList = null;
        ApiClient apiClient = api.getApiClient();
        apiClient.addDefaultHeader("Access-Token", "");
        apiClient.setDebugging(true);
        api.setApiClient(apiClient);
        AgentQueryRiskPromotionListV2Response response = api.openApi2AgentQueryRiskPromotionListGet(agentId, startDate, endDate, businessType, cursor, count, filtering, businessTypeList);

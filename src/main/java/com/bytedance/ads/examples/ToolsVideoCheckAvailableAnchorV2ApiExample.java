...
public class ToolsVideoCheckAvailableAnchorV2ApiExample {
    ...
    public static void main(String[] args) throws ApiException {
        ...
        ToolsVideoCheckAvailableAnchorV2Response response = api.openApi2ToolsVideoCheckAvailableAnchorGet(advertiserId, itemIds, landingType, externalAction, version);

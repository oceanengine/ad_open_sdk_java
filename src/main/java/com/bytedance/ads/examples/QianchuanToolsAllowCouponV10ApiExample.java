...
public class QianchuanToolsAllowCouponV10ApiExample {
    ...
    public static void main(String[] args) throws ApiException {
        ...
        Boolean isLabAd = null;
        ApiClient apiClient = api.getApiClient();
        apiClient.addDefaultHeader("Access-Token", "");
        apiClient.setDebugging(true);
        api.setApiClient(apiClient);
        QianchuanToolsAllowCouponV10Response response = api.openApiV10QianchuanToolsAllowCouponGet(advertiserId, marketingGoal, campaignScene, marketingScene, awemeIds, productIds, isLabAd);

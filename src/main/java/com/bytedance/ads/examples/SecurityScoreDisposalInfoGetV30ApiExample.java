...
public class SecurityScoreDisposalInfoGetV30ApiExample {
    ...
    public static void main(String[] args) throws ApiException {
        ...
        SecurityScoreDisposalInfoGetV30Response response = api.openApiV30SecurityScoreDisposalInfoGetGet(advertiserId, businessLine, filtering, page, pageSize, orderField, orderType);

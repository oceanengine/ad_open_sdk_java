...
import com.bytedance.ads.model.QianchuanCarouselAwemeGetV10OrderField;
import com.bytedance.ads.model.QianchuanCarouselAwemeGetV10OrderType;
...
public class QianchuanCarouselAwemeGetV10ApiExample {
    ...
    public static void main(String[] args) throws ApiException {
        ...
        Long cursor = null;
        Long count = null;
        QianchuanCarouselAwemeGetV10OrderField orderField = null;
        QianchuanCarouselAwemeGetV10OrderType orderType = null;
        ApiClient apiClient = api.getApiClient();
        apiClient.addDefaultHeader("Access-Token", "");
        apiClient.setDebugging(true);
        api.setApiClient(apiClient);
        QianchuanCarouselAwemeGetV10Response response = api.openApiV10QianchuanCarouselAwemeGetGet(advertiserId, awemeId, filtering, cursor, count, orderField, orderType);

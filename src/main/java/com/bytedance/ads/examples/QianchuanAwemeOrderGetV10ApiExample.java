...
public class QianchuanAwemeOrderGetV10ApiExample {
    ...
    public static void main(String[] args) throws ApiException {
        ...
        QianchuanAwemeOrderGetV10OrderField orderField = null;
        String orderCreateStartDate = null;
        String orderCreateEndDate = null;
        ApiClient apiClient = api.getApiClient();
        apiClient.addDefaultHeader("Access-Token", "");
        apiClient.setDebugging(true);
        api.setApiClient(apiClient);
        QianchuanAwemeOrderGetV10Response response = api.openApiV10QianchuanAwemeOrderGetGet(advertiserId, filtering, cursor, count, orderField, orderCreateStartDate, orderCreateEndDate);

...
public class DiagnosisTaskAgentListV2ApiExample {
    ...
    public static void main(String[] args) throws ApiException {
        ...
        DiagnosisTaskAgentListV2Response response = api.openApi2DiagnosisTaskAgentListGet(agentId, results, status, startTime, endTime, page, pageSize, startDateTime, endDateTime);

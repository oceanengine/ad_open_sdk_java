...
import com.bytedance.ads.model.ToolsAppManagementBookingGetV2AccountAssetQueryScope;
...
public class ToolsAppManagementBookingGetV2ApiExample {
    ...
    public static void main(String[] args) throws ApiException {
        ...
        ToolsAppManagementBookingGetV2AccountAssetQueryScope accountAssetQueryScope = null;
        ApiClient apiClient = api.getApiClient();
        apiClient.addDefaultHeader("Access-Token", "");
        apiClient.setDebugging(true);
        api.setApiClient(apiClient);
        ToolsAppManagementBookingGetV2Response response = api.openApi2ToolsAppManagementBookingGetGet(advertiserId, page, pageSize, searchKey, searchType, status, scheduledPublishTime, createTime, accountAssetQueryScope);

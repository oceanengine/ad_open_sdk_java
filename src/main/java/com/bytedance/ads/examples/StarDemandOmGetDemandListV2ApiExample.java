...
public class StarDemandOmGetDemandListV2ApiExample {
    ...
    public static void main(String[] args) throws ApiException {
        ...
        StarDemandOmGetDemandListV2Response response = api.openApi2StarDemandOmGetDemandListGet(starId, pageNo, pageSize, createStartTime, createEndTime, universalSettlementType, microAppId);

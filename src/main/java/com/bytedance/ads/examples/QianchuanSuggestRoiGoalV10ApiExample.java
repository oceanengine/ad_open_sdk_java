...
public class QianchuanSuggestRoiGoalV10ApiExample {
    ...
    public static void main(String[] args) throws ApiException {
        ...
        QianchuanSuggestRoiGoalV10EcomGuestType ecomGuestType = null;
        Long shopId = null;
        Long brandId = null;
        ...
        QianchuanSuggestRoiGoalV10Response response = api.openApiV10QianchuanSuggestRoiGoalGet(advertiserId, awemeId, marketingScene, marketingGoal, productId, productNewOpen, externalAction, campaignScene, deepExternalAction, deepBidType, ecomGuestType, shopId, brandId);

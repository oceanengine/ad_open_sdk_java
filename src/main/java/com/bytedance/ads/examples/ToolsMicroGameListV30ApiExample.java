...
public class ToolsMicroGameListV30ApiExample {
    ...
    public static void main(String[] args) throws ApiException {
        ...
        ToolsMicroGameListV30AccountAssetQueryScope accountAssetQueryScope = null;
        ApiClient apiClient = api.getApiClient();
        apiClient.addDefaultHeader("Access-Token", "");
        apiClient.setDebugging(true);
        api.setApiClient(apiClient);
        ToolsMicroGameListV30Response response = api.openApiV30ToolsMicroGameListGet(advertiserId, filtering, page, pageSize, accountAssetQueryScope);

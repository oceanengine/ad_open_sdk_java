...
public class SubscribeAccountsListV30ApiExample {
    ...
    public static void main(String[] args) throws ApiException {
        ...
        Long cursor = null;
        Long count = null;
        Long subscribePackageType = null;
        ApiClient apiClient = api.getApiClient();
        apiClient.addDefaultHeader("Access-Token", "");
        apiClient.setDebugging(true);
        api.setApiClient(apiClient);
        SubscribeAccountsListV30Response response = api.openApiV30SubscribeAccountsListGet(apPAccessToken, appId, subscribeTaskId, events, coreUserId, advertiserIds, statuses, cursor, count, subscribePackageType);

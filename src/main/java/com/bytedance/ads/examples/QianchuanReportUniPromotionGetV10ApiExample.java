...
public class QianchuanReportUniPromotionGetV10ApiExample {
    ...
    public static void main(String[] args) throws ApiException {
        ...
        QianchuanReportUniPromotionGetV10Response response = api.openApiV10QianchuanReportUniPromotionGetGet(advertiserId, startDate, endDate, marketingGoal, fields);

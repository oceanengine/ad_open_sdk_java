...
public class QianchuanReportUniPromotionGetV10ApiExample {
    ...
    public static void main(String[] args) throws ApiException {
        ...
        QianchuanReportUniPromotionGetV10OrderPlatform orderPlatform = null;
        ApiClient apiClient = api.getApiClient();
        apiClient.addDefaultHeader("Access-Token", "");
        apiClient.setDebugging(true);
        api.setApiClient(apiClient);
        QianchuanReportUniPromotionGetV10Response response = api.openApiV10QianchuanReportUniPromotionGetGet(advertiserId, startDate, endDate, fields, marketingGoal, orderPlatform);

...
public class ToolsAppManagementAndroidAppListV2ApiExample {
    ...
    public static void main(String[] args) throws ApiException {
        ...
        ToolsAppManagementAndroidAppListV2AccountAssetQueryScope accountAssetQueryScope = null;
        ApiClient apiClient = api.getApiClient();
        apiClient.addDefaultHeader("Access-Token", "");
        apiClient.setDebugging(true);
        api.setApiClient(apiClient);
        ToolsAppManagementAndroidAppListV2Response response = api.openApi2ToolsAppManagementAndroidAppListGet(accountId, accountType, page, pageSize, filtering, accountAssetQueryScope);

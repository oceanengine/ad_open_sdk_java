...
import com.bytedance.ads.model.LocalProductGetByPoiidsV30LocalDeliveryScene;
...
public class LocalProductGetByPoiidsV30ApiExample {
    ...
    public static void main(String[] args) throws ApiException {
        ...
        LocalProductGetByPoiidsV30LocalDeliveryScene localDeliveryScene = null;
        ApiClient apiClient = api.getApiClient();
        apiClient.addDefaultHeader("Access-Token", "");
        apiClient.setDebugging(true);
        api.setApiClient(apiClient);
        LocalProductGetByPoiidsV30Response response = api.openApiV30LocalProductGetByPoiidsGet(localAccountId, poiIds, localDeliveryScene);

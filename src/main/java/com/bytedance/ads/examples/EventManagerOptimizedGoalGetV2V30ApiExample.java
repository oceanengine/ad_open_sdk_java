...
public class EventManagerOptimizedGoalGetV2V30ApiExample {
    ...
    public static void main(String[] args) throws ApiException {
        ...
        EventManagerOptimizedGoalGetV2V30MultiAssetType multiAssetType = null;
        Long assetId = null;
        ...
        EventManagerOptimizedGoalGetV2V30Response response = api.openApiV30EventManagerOptimizedGoalGetV2Get(advertiserId, landingType, adType, assetType, multiAssetType, assetId, packageName, appType, appPromotionType, marketingGoal, quickAppId, deliveryMode, miniProgramId, dpaAdtype, microPromotionType, microAppInstanceId, deliveryType);

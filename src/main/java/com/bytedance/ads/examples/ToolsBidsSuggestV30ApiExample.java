...
public class ToolsBidsSuggestV30ApiExample {
    ...
    public static void main(String[] args) throws ApiException {
        ...
        List<ToolsBidsSuggestV30Platform> platform = null;
        ToolsBidsSuggestV30MarketingGoal marketingGoal = null;
        ToolsBidsSuggestV30CampaignType campaignType = null;
        ...
        ToolsBidsSuggestV30Response response = api.openApiV30ToolsBidsSuggestGet(advertiserId, pricing, externalAction, projectId, deepExternalAction, deepBidType, platform, marketingGoal, campaignType, packageName, userName, appId);

...
public class QianchuanFileVideoAwemeGetV10ApiExample {
    ...
    public static void main(String[] args) throws ApiException {
        ...
        Long awemeId = null;
        Long adBindAwemeId = null;
        Boolean pullAwemeExcellentVideo = null;
        ...
        QianchuanFileVideoAwemeGetV10Response response = api.openApiV10QianchuanFileVideoAwemeGetGet(advertiserId, awemeId, adBindAwemeId, pullAwemeExcellentVideo, filtering, cursor, count);

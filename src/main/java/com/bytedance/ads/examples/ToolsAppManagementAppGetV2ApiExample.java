...
public class ToolsAppManagementAppGetV2ApiExample {
    ...
    public static void main(String[] args) throws ApiException {
        ...
        ToolsAppManagementAppGetV2AccountAssetQueryScope accountAssetQueryScope = null;
        ApiClient apiClient = api.getApiClient();
        apiClient.addDefaultHeader("Access-Token", "");
        apiClient.setDebugging(true);
        api.setApiClient(apiClient);
        ToolsAppManagementAppGetV2Response response = api.openApi2ToolsAppManagementAppGetGet(advertiserId, page, pageSize, searchKey, searchType, status, publishTime, createTime, accountAssetQueryScope);

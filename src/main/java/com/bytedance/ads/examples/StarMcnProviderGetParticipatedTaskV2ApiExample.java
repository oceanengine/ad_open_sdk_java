...
public class StarMcnProviderGetParticipatedTaskV2ApiExample {
    ...
    public static void main(String[] args) throws ApiException {
        ...
        Boolean isComicTask = null;
        ApiClient apiClient = api.getApiClient();
        apiClient.addDefaultHeader("Access-Token", "");
        apiClient.setDebugging(true);
        api.setApiClient(apiClient);
        StarMcnProviderGetParticipatedTaskV2Response response = api.openApi2StarMcnProviderGetParticipatedTaskGet(starId, page, pageSize, providerOrderTaskStatus, providerTaskCategory, isComicTask);

...
public class DmpDataSourceFileUploadV2ApiExample {
    ...
    public static void main(String[] args) throws ApiException {
        DmpDataSourceFileUploadV2Request dmpDataSourceFileUploadV2Request = null;
        ApiClient apiClient = api.getApiClient();
        apiClient.addDefaultHeader("Access-Token", "");
        apiClient.setDebugging(true);
        api.setApiClient(apiClient);
        DmpDataSourceFileUploadV2Response response = api.openApi2DmpDataSourceFileUploadPost(dmpDataSourceFileUploadV2Request);

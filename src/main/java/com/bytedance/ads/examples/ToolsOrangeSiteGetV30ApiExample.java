...
import com.bytedance.ads.model.ToolsOrangeSiteGetV30MultiAssetType;
...
public class ToolsOrangeSiteGetV30ApiExample {
    ...
    public static void main(String[] args) throws ApiException {
        ...
        ToolsOrangeSiteGetV30MultiAssetType multiAssetType = null;
        ApiClient apiClient = api.getApiClient();
        apiClient.addDefaultHeader("Access-Token", "");
        apiClient.setDebugging(true);
        api.setApiClient(apiClient);
        ToolsOrangeSiteGetV30Response response = api.openApiV30ToolsOrangeSiteGetGet(advertiserId, page, pageSize, optimizeGoal, status, filtering, multiAssetType);

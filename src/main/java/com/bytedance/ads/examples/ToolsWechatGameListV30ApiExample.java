...
public class ToolsWechatGameListV30ApiExample {
    ...
    public static void main(String[] args) throws ApiException {
        ...
        ToolsWechatGameListV30AccountAssetQueryScope accountAssetQueryScope = null;
        ToolsWechatGameListV30Filtering filtering = null;
        ApiClient apiClient = api.getApiClient();
        apiClient.addDefaultHeader("Access-Token", "");
        apiClient.setDebugging(true);
        api.setApiClient(apiClient);
        ToolsWechatGameListV30Response response = api.openApiV30ToolsWechatGameListGet(accountId, accountType, page, pageSize, accountAssetQueryScope, filtering);

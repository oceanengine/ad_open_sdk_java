...
import com.bytedance.ads.model.ToolsMicroAppListV30AccountAssetQueryScope;
...
public class ToolsMicroAppListV30ApiExample {
    ...
    public static void main(String[] args) throws ApiException {
        ...
        ToolsMicroAppListV30AccountAssetQueryScope accountAssetQueryScope = null;
        ApiClient apiClient = api.getApiClient();
        apiClient.addDefaultHeader("Access-Token", "");
        apiClient.setDebugging(true);
        api.setApiClient(apiClient);
        ToolsMicroAppListV30Response response = api.openApiV30ToolsMicroAppListGet(advertiserId, filtering, page, pageSize, accountAssetQueryScope);

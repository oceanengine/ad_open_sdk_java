...
public class ReportStardeliveryTaskDataGetV30ApiExample {
    ...
    public static void main(String[] args) throws ApiException {
        ...
        ReportStardeliveryTaskDataGetV30Response response = api.openApiV30ReportStardeliveryTaskDataGetGet(advertiserId, startDate, endDate, filtering, orderField, orderType, page, pageSize);

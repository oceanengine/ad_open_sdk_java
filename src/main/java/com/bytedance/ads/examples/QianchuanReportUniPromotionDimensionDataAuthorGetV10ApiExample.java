...
public class QianchuanReportUniPromotionDimensionDataAuthorGetV10ApiExample {
    ...
    public static void main(String[] args) throws ApiException {
        ...
        Long awemeId = null;
        QianchuanReportUniPromotionDimensionDataAuthorGetV10MarketingGoal marketingGoal = null;
        ...
        QianchuanReportUniPromotionDimensionDataAuthorGetV10Response response = api.openApiV10QianchuanReportUniPromotionDimensionDataAuthorGetGet(advertiserId, awemeId, marketingGoal, metrics, startTime, endTime, dimension, orderType, orderField, filtering, page, pageSize);

...
public class QianchuanReportUniPromotionDimensionDataAuthorGetV10ApiExample {
    ...
    public static void main(String[] args) throws ApiException {
        ...
        QianchuanReportUniPromotionDimensionDataAuthorGetV10Response response = api.openApiV10QianchuanReportUniPromotionDimensionDataAuthorGetGet(advertiserId, awemeId, metrics, startTime, endTime, dimension, orderType, orderField, page, pageSize);

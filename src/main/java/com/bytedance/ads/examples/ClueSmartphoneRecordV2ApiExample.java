...
public class ClueSmartphoneRecordV2ApiExample {
    ...
    public static void main(String[] args) throws ApiException {
        ...
        ClueSmartphoneRecordV2Response response = api.openApi2ClueSmartphoneRecordGet(advertiserId, version, instanceIds, clueIds, siteIds, adIds, startTime, endTime, page, pageSize);

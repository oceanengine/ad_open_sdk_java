...
public class ToolsAppManagementHarmonyAppListV2ApiExample {
    ...
    public static void main(String[] args) throws ApiException {
        ...
        ToolsAppManagementHarmonyAppListV2Response response = api.openApi2ToolsAppManagementHarmonyAppListGet(accountId, accountType, page, pageSize, filtering, accountAssetQueryScope);

...
public class ToolsAppManagementHarmonyAppListV2ApiExample {
    ...
    public static void main(String[] args) throws ApiException {
        ...
        ToolsAppManagementHarmonyAppListV2AccountAssetQueryScope accountAssetQueryScope = null;
        ToolsAppManagementHarmonyAppListV2AssetGeneration assetGeneration = null;
        ApiClient apiClient = api.getApiClient();
        apiClient.addDefaultHeader("Access-Token", "");
        apiClient.setDebugging(true);
        api.setApiClient(apiClient);
        ToolsAppManagementHarmonyAppListV2Response response = api.openApi2ToolsAppManagementHarmonyAppListGet(accountId, accountType, page, pageSize, filtering, accountAssetQueryScope, assetGeneration);

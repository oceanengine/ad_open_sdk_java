...
public class QianchuanUniPromotionListV10ApiExample {
    ...
    public static void main(String[] args) throws ApiException {
        ...
        QianchuanUniPromotionListV10Response response = api.openApiV10QianchuanUniPromotionListGet(advertiserId, startTime, endTime, marketingGoal, fields, filtering, needCompensateInfo, orderType, orderField, page, pageSize, adlabScene);

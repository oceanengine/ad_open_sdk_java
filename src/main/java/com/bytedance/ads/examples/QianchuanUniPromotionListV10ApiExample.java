...
public class QianchuanUniPromotionListV10ApiExample {
    ...
    public static void main(String[] args) throws ApiException {
        ...
        QianchuanUniPromotionListV10Filtering filtering = null;
        Boolean needCompensateInfo = null;
        ...
        QianchuanUniPromotionListV10AdlabScene adlabScene = null;
        QianchuanUniPromotionListV10DataPeriod dataPeriod = null;
        ApiClient apiClient = api.getApiClient();
        apiClient.addDefaultHeader("Access-Token", "");
        apiClient.setDebugging(true);
        api.setApiClient(apiClient);
        QianchuanUniPromotionListV10Response response = api.openApiV10QianchuanUniPromotionListGet(advertiserId, startTime, endTime, marketingGoal, fields, filtering, needCompensateInfo, orderType, orderField, page, pageSize, adlabScene, dataPeriod);

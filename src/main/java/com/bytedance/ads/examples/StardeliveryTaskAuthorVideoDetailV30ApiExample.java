...
public class StardeliveryTaskAuthorVideoDetailV30ApiExample {
    ...
    public static void main(String[] args) throws ApiException {
        ...
        StardeliveryTaskAuthorVideoDetailV30Response response = api.openApiV30StardeliveryTaskAuthorVideoDetailGet(advertiserId, starTaskId, awemeId, filtering, cursor, count);

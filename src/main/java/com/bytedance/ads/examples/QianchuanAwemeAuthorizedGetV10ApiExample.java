...
public class QianchuanAwemeAuthorizedGetV10ApiExample {
    ...
    public static void main(String[] args) throws ApiException {
        ...
        QianchuanAwemeAuthorizedGetV10Filtering filtering = null;
        ApiClient apiClient = api.getApiClient();
        apiClient.addDefaultHeader("Access-Token", "");
        apiClient.setDebugging(true);
        api.setApiClient(apiClient);
        QianchuanAwemeAuthorizedGetV10Response response = api.openApiV10QianchuanAwemeAuthorizedGetGet(advertiserId, page, pageSize, filtering);

...
public class EventManagerDeepBidTypeGetV30ApiExample {
    ...
    public static void main(String[] args) throws ApiException {
        ...
        EventManagerDeepBidTypeGetV30Response response = api.openApiV30EventManagerDeepBidTypeGetGet(advertiserId, externalAction, assetId, deepExternalAction, convertId, deliveryMode, landingType, adType, marketingGoal);

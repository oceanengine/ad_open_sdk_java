...
public class EventManagerDeepBidTypeGetV30ApiExample {
    ...
    public static void main(String[] args) throws ApiException {
        ...
        EventManagerDeepBidTypeGetV30AdType adType = null;
        EventManagerDeepBidTypeGetV30MarketingGoal marketingGoal = null;
        EventManagerDeepBidTypeGetV30MicroPromotionType microPromotionType = null;
        EventManagerDeepBidTypeGetV30ProductSetting productSetting = null;
        EventManagerDeepBidTypeGetV30ValueOptimizedType valueOptimizedType = null;
        ApiClient apiClient = api.getApiClient();
        apiClient.addDefaultHeader("Access-Token", "");
        apiClient.setDebugging(true);
        api.setApiClient(apiClient);
        EventManagerDeepBidTypeGetV30Response response = api.openApiV30EventManagerDeepBidTypeGetGet(advertiserId, externalAction, assetId, deepExternalAction, convertId, deliveryMode, landingType, adType, marketingGoal, microPromotionType, productSetting, valueOptimizedType);

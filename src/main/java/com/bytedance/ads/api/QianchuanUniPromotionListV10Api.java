...
import com.bytedance.ads.model.QianchuanUniPromotionListV10AdlabScene;
import com.bytedance.ads.model.QianchuanUniPromotionListV10DataPeriod;
...
public class QianchuanUniPromotionListV10Api {
     ...
     * @param needCompensateInfo 是否获取成本保障信息 (optional, default to false)
     * @param orderType  (optional)
     * @param orderField  (optional)
     * @param page  (optional, default to 1)
     * @param pageSize  (optional)
     * @param adlabScene 计划类型（全域 or 乘方） (optional)
     * @param dataPeriod  (optional)
     ...
     */
    public okhttp3.Call openApiV10QianchuanUniPromotionListGetCall(Long advertiserId, String startTime, String endTime, QianchuanUniPromotionListV10MarketingGoal marketingGoal, List<QianchuanUniPromotionListV10Fields> fields, QianchuanUniPromotionListV10Filtering filtering, Boolean needCompensateInfo, QianchuanUniPromotionListV10OrderType orderType, QianchuanUniPromotionListV10OrderField orderField, Integer page, QianchuanUniPromotionListV10PageSize pageSize, QianchuanUniPromotionListV10AdlabScene adlabScene, QianchuanUniPromotionListV10DataPeriod dataPeriod, final ApiCallback _callback) throws ApiException {
        ...
        if (needCompensateInfo != null) {
            localVarQueryParams.addAll(localVarApiClient.parameterToPair("need_compensate_info", needCompensateInfo));
        }
    ...
    private okhttp3.Call openApiV10QianchuanUniPromotionListGetValidateBeforeCall(Long advertiserId, String startTime, String endTime, QianchuanUniPromotionListV10MarketingGoal marketingGoal, List<QianchuanUniPromotionListV10Fields> fields, QianchuanUniPromotionListV10Filtering filtering, Boolean needCompensateInfo, QianchuanUniPromotionListV10OrderType orderType, QianchuanUniPromotionListV10OrderField orderField, Integer page, QianchuanUniPromotionListV10PageSize pageSize, QianchuanUniPromotionListV10AdlabScene adlabScene, QianchuanUniPromotionListV10DataPeriod dataPeriod, final ApiCallback _callback) throws ApiException {
        ...
        return openApiV10QianchuanUniPromotionListGetCall(advertiserId, startTime, endTime, marketingGoal, fields, filtering, needCompensateInfo, orderType, orderField, page, pageSize, adlabScene, dataPeriod, _callback);
     ...
     */
    public QianchuanUniPromotionListV10Response openApiV10QianchuanUniPromotionListGet(Long advertiserId, String startTime, String endTime, QianchuanUniPromotionListV10MarketingGoal marketingGoal, List<QianchuanUniPromotionListV10Fields> fields, QianchuanUniPromotionListV10Filtering filtering, Boolean needCompensateInfo, QianchuanUniPromotionListV10OrderType orderType, QianchuanUniPromotionListV10OrderField orderField, Integer page, QianchuanUniPromotionListV10PageSize pageSize, QianchuanUniPromotionListV10AdlabScene adlabScene, QianchuanUniPromotionListV10DataPeriod dataPeriod) throws ApiException {
        ApiResponse<QianchuanUniPromotionListV10Response> localVarResp = openApiV10QianchuanUniPromotionListGetWithHttpInfo(advertiserId, startTime, endTime, marketingGoal, fields, filtering, needCompensateInfo, orderType, orderField, page, pageSize, adlabScene, dataPeriod);
    ...
    public ApiResponse<QianchuanUniPromotionListV10Response> openApiV10QianchuanUniPromotionListGetWithHttpInfo(Long advertiserId, String startTime, String endTime, QianchuanUniPromotionListV10MarketingGoal marketingGoal, List<QianchuanUniPromotionListV10Fields> fields, QianchuanUniPromotionListV10Filtering filtering, Boolean needCompensateInfo, QianchuanUniPromotionListV10OrderType orderType, QianchuanUniPromotionListV10OrderField orderField, Integer page, QianchuanUniPromotionListV10PageSize pageSize, QianchuanUniPromotionListV10AdlabScene adlabScene, QianchuanUniPromotionListV10DataPeriod dataPeriod) throws ApiException {
        okhttp3.Call localVarCall = openApiV10QianchuanUniPromotionListGetValidateBeforeCall(advertiserId, startTime, endTime, marketingGoal, fields, filtering, needCompensateInfo, orderType, orderField, page, pageSize, adlabScene, dataPeriod, null);
     ...
     */
    public okhttp3.Call openApiV10QianchuanUniPromotionListGetAsync(Long advertiserId, String startTime, String endTime, QianchuanUniPromotionListV10MarketingGoal marketingGoal, List<QianchuanUniPromotionListV10Fields> fields, QianchuanUniPromotionListV10Filtering filtering, Boolean needCompensateInfo, QianchuanUniPromotionListV10OrderType orderType, QianchuanUniPromotionListV10OrderField orderField, Integer page, QianchuanUniPromotionListV10PageSize pageSize, QianchuanUniPromotionListV10AdlabScene adlabScene, QianchuanUniPromotionListV10DataPeriod dataPeriod, final ApiCallback<QianchuanUniPromotionListV10Response> _callback) throws ApiException {

        okhttp3.Call localVarCall = openApiV10QianchuanUniPromotionListGetValidateBeforeCall(advertiserId, startTime, endTime, marketingGoal, fields, filtering, needCompensateInfo, orderType, orderField, page, pageSize, adlabScene, dataPeriod, _callback);
        Type localVarReturnType = new TypeToken<QianchuanUniPromotionListV10Response>(){}.getType();

...
public class ClueCouponGetV2Api {
     ...
     */
    public okhttp3.Call openApi2ClueCouponGetGetCall(List<Long> activityIds, List<String> activityTypes, Long advertiserId, String endTime, Object isDel, Long page, Long pageSize, String startTime, final ApiCallback _callback) throws ApiException {
    ...
    private okhttp3.Call openApi2ClueCouponGetGetValidateBeforeCall(List<Long> activityIds, List<String> activityTypes, Long advertiserId, String endTime, Object isDel, Long page, Long pageSize, String startTime, final ApiCallback _callback) throws ApiException {
     ...
     */
    public ClueCouponGetV2Response openApi2ClueCouponGetGet(List<Long> activityIds, List<String> activityTypes, Long advertiserId, String endTime, Object isDel, Long page, Long pageSize, String startTime) throws ApiException {
     ...
     */
    public ApiResponse<ClueCouponGetV2Response> openApi2ClueCouponGetGetWithHttpInfo(List<Long> activityIds, List<String> activityTypes, Long advertiserId, String endTime, Object isDel, Long page, Long pageSize, String startTime) throws ApiException {
     ...
     */
    public okhttp3.Call openApi2ClueCouponGetGetAsync(List<Long> activityIds, List<String> activityTypes, Long advertiserId, String endTime, Object isDel, Long page, Long pageSize, String startTime, final ApiCallback<ClueCouponGetV2Response> _callback) throws ApiException {

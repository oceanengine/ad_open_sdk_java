...
public class ToolsRubeexGetV2Api {
     ...
     */
    public okhttp3.Call openApi2ToolsRubeexGetGetCall(Long advertiserId, ToolsRubeexGetV2Filtering filtering, Long page, Long pageSize, List<String> platformName, List<String> projectStatus, final ApiCallback _callback) throws ApiException {
    ...
    private okhttp3.Call openApi2ToolsRubeexGetGetValidateBeforeCall(Long advertiserId, ToolsRubeexGetV2Filtering filtering, Long page, Long pageSize, List<String> platformName, List<String> projectStatus, final ApiCallback _callback) throws ApiException {
     ...
     */
    public ToolsRubeexGetV2Response openApi2ToolsRubeexGetGet(Long advertiserId, ToolsRubeexGetV2Filtering filtering, Long page, Long pageSize, List<String> platformName, List<String> projectStatus) throws ApiException {
     ...
     */
    public ApiResponse<ToolsRubeexGetV2Response> openApi2ToolsRubeexGetGetWithHttpInfo(Long advertiserId, ToolsRubeexGetV2Filtering filtering, Long page, Long pageSize, List<String> platformName, List<String> projectStatus) throws ApiException {
     ...
     */
    public okhttp3.Call openApi2ToolsRubeexGetGetAsync(Long advertiserId, ToolsRubeexGetV2Filtering filtering, Long page, Long pageSize, List<String> platformName, List<String> projectStatus, final ApiCallback<ToolsRubeexGetV2Response> _callback) throws ApiException {

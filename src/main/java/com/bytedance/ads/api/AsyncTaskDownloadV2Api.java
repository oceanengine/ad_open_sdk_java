...
public class AsyncTaskDownloadV2Api {
     ...
     */
    public  byte[] openApi2AsyncTaskDownloadGet(Long advertiserId, Long taskId, Long rangeFrom, Long rangeTo) throws ApiException {
        ApiResponse< byte[] > localVarResp = openApi2AsyncTaskDownloadGetWithHttpInfo(advertiserId, taskId, rangeFrom, rangeTo);
     ...
     */
    public ApiResponse< byte[] > openApi2AsyncTaskDownloadGetWithHttpInfo(Long advertiserId, Long taskId, Long rangeFrom, Long rangeTo) throws ApiException {
     ...
     */
    public okhttp3.Call openApi2AsyncTaskDownloadGetAsync(Long advertiserId, Long taskId, Long rangeFrom, Long rangeTo, final ApiCallback< byte[] > _callback) throws ApiException {

...
public class StarMcnProviderGetUnparticipatedTaskV2Api {
    ...
    private okhttp3.Call openApi2StarMcnProviderGetUnparticipatedTaskGetValidateBeforeCall(Long starId, Integer page, Integer pageSize, Long payType, Long minCreateTimeStamp, Long maxCreateTimeStamp, Integer firstClassCategory, Integer secondClassCategory, Integer productCategory, String appId, String appName, Long demandId, Long gameType, final ApiCallback _callback) throws ApiException {
        ...
        return openApi2StarMcnProviderGetUnparticipatedTaskGetCall(starId, page, pageSize, payType, minCreateTimeStamp, maxCreateTimeStamp, firstClassCategory, secondClassCategory, productCategory, appId, appName, demandId, gameType, _callback);
     ...
     */
    public StarMcnProviderGetUnparticipatedTaskV2Response openApi2StarMcnProviderGetUnparticipatedTaskGet(Long starId, Integer page, Integer pageSize, Long payType, Long minCreateTimeStamp, Long maxCreateTimeStamp, Integer firstClassCategory, Integer secondClassCategory, Integer productCategory, String appId, String appName, Long demandId, Long gameType) throws ApiException {
        ApiResponse<StarMcnProviderGetUnparticipatedTaskV2Response> localVarResp = openApi2StarMcnProviderGetUnparticipatedTaskGetWithHttpInfo(starId, page, pageSize, payType, minCreateTimeStamp, maxCreateTimeStamp, firstClassCategory, secondClassCategory, productCategory, appId, appName, demandId, gameType);
    ...
    public ApiResponse<StarMcnProviderGetUnparticipatedTaskV2Response> openApi2StarMcnProviderGetUnparticipatedTaskGetWithHttpInfo(Long starId, Integer page, Integer pageSize, Long payType, Long minCreateTimeStamp, Long maxCreateTimeStamp, Integer firstClassCategory, Integer secondClassCategory, Integer productCategory, String appId, String appName, Long demandId, Long gameType) throws ApiException {
        okhttp3.Call localVarCall = openApi2StarMcnProviderGetUnparticipatedTaskGetValidateBeforeCall(starId, page, pageSize, payType, minCreateTimeStamp, maxCreateTimeStamp, firstClassCategory, secondClassCategory, productCategory, appId, appName, demandId, gameType, null);
     ...
     */
    public okhttp3.Call openApi2StarMcnProviderGetUnparticipatedTaskGetAsync(Long starId, Integer page, Integer pageSize, Long payType, Long minCreateTimeStamp, Long maxCreateTimeStamp, Integer firstClassCategory, Integer secondClassCategory, Integer productCategory, String appId, String appName, Long demandId, Long gameType, final ApiCallback<StarMcnProviderGetUnparticipatedTaskV2Response> _callback) throws ApiException {

        okhttp3.Call localVarCall = openApi2StarMcnProviderGetUnparticipatedTaskGetValidateBeforeCall(starId, page, pageSize, payType, minCreateTimeStamp, maxCreateTimeStamp, firstClassCategory, secondClassCategory, productCategory, appId, appName, demandId, gameType, _callback);
        Type localVarReturnType = new TypeToken<StarMcnProviderGetUnparticipatedTaskV2Response>(){}.getType();

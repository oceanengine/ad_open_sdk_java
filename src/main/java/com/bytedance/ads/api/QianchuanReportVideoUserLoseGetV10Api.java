...
public class QianchuanReportVideoUserLoseGetV10Api {
     ...
     */
    public okhttp3.Call openApiV10QianchuanReportVideoUserLoseGetGetCall(List<String> fields, LocalDate startDate, LocalDate endDate, QianchuanReportVideoUserLoseGetV10Filtering filtering, Long advertiserId, final ApiCallback _callback) throws ApiException {
    ...
    private okhttp3.Call openApiV10QianchuanReportVideoUserLoseGetGetValidateBeforeCall(List<String> fields, LocalDate startDate, LocalDate endDate, QianchuanReportVideoUserLoseGetV10Filtering filtering, Long advertiserId, final ApiCallback _callback) throws ApiException {
     ...
     */
    public QianchuanReportVideoUserLoseGetV10Response openApiV10QianchuanReportVideoUserLoseGetGet(List<String> fields, LocalDate startDate, LocalDate endDate, QianchuanReportVideoUserLoseGetV10Filtering filtering, Long advertiserId) throws ApiException {
     ...
     */
    public ApiResponse<QianchuanReportVideoUserLoseGetV10Response> openApiV10QianchuanReportVideoUserLoseGetGetWithHttpInfo(List<String> fields, LocalDate startDate, LocalDate endDate, QianchuanReportVideoUserLoseGetV10Filtering filtering, Long advertiserId) throws ApiException {
     ...
     */
    public okhttp3.Call openApiV10QianchuanReportVideoUserLoseGetGetAsync(List<String> fields, LocalDate startDate, LocalDate endDate, QianchuanReportVideoUserLoseGetV10Filtering filtering, Long advertiserId, final ApiCallback<QianchuanReportVideoUserLoseGetV10Response> _callback) throws ApiException {

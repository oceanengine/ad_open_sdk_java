...
public class ToolsBidSuggestV2Api {
     ...
     */
    public okhttp3.Call openApi2ToolsBidSuggestGetCall(List<String> ac, List<Long> actionCategories, ToolsBidSuggestV2ActionDays actionDays, List<String> actionScene, List<Long> actionWords, List<String> activateType, Long adId, List<Long> adTag, Long advertiserId, List<String> age, Object androidOsv, Object appBehaviorTarget, List<Long> appCategory, List<Long> appIds, List<String> articleCategory, Long audiencePackageId, List<String> autoExtendTargets, List<Long> awemeFanAccounts, List<String> awemeFanBehaviors, List<Long> awemeFanCategories, Object awemeFanTimeScope, List<Long> awemeFansNumbers, Object bidMode, Long budget, Object budgetMode, List<Long> businessIds, Long campaignId, List<String> career, List<String> carrier, List<Long> city, Long convertId, Object convertedTimeDuration, List<String> deviceBrand, List<String> deviceType, Object district, ToolsBidSuggestV2DpaLocalAudience dpaLocalAudience, Object dpaRtaRecommendType, Object dpaRtaSwitch, List<ToolsBidSuggestV2ExcludeCustomActionsInner> excludeCustomActions, List<Long> excludeFlowPackage, ToolsBidSuggestV2FilterAwemeAbnormalActive filterAwemeAbnormalActive, Long filterAwemeFansCount, ToolsBidSuggestV2FilterOwnAwemeFans filterOwnAwemeFans, Object flowControlMode, List<Long> flowPackage, Object gender, List<AudiencePackageUpdateV2RequestGeolocationInner> geolocation, Object hideIfConverted, ToolsBidSuggestV2HideIfExists hideIfExists, List<ToolsBidSuggestV2ExcludeCustomActionsInner> includeCustomActions, Object interestActionMode, List<Long> interestCategories, List<Long> interestTags, List<Long> interestWords, Object iosOsv, List<Long> launchPrice, Object locationType, List<String> platform, Object pricing, String regionVersion, List<Long> retargetingTags, List<Long> retargetingTagsExclude, List<Long> retargetingTagsInclude, Object retargetingType, Object scheduleType, Object superiorPopularityType, List<Long> userType, final ApiCallback _callback) throws ApiException {
     ...
     */
    public ToolsBidSuggestV2Response openApi2ToolsBidSuggestGet(List<String> ac, List<Long> actionCategories, ToolsBidSuggestV2ActionDays actionDays, List<String> actionScene, List<Long> actionWords, List<String> activateType, Long adId, List<Long> adTag, Long advertiserId, List<String> age, Object androidOsv, Object appBehaviorTarget, List<Long> appCategory, List<Long> appIds, List<String> articleCategory, Long audiencePackageId, List<String> autoExtendTargets, List<Long> awemeFanAccounts, List<String> awemeFanBehaviors, List<Long> awemeFanCategories, Object awemeFanTimeScope, List<Long> awemeFansNumbers, Object bidMode, Long budget, Object budgetMode, List<Long> businessIds, Long campaignId, List<String> career, List<String> carrier, List<Long> city, Long convertId, Object convertedTimeDuration, List<String> deviceBrand, List<String> deviceType, Object district, ToolsBidSuggestV2DpaLocalAudience dpaLocalAudience, Object dpaRtaRecommendType, Object dpaRtaSwitch, List<ToolsBidSuggestV2ExcludeCustomActionsInner> excludeCustomActions, List<Long> excludeFlowPackage, ToolsBidSuggestV2FilterAwemeAbnormalActive filterAwemeAbnormalActive, Long filterAwemeFansCount, ToolsBidSuggestV2FilterOwnAwemeFans filterOwnAwemeFans, Object flowControlMode, List<Long> flowPackage, Object gender, List<AudiencePackageUpdateV2RequestGeolocationInner> geolocation, Object hideIfConverted, ToolsBidSuggestV2HideIfExists hideIfExists, List<ToolsBidSuggestV2ExcludeCustomActionsInner> includeCustomActions, Object interestActionMode, List<Long> interestCategories, List<Long> interestTags, List<Long> interestWords, Object iosOsv, List<Long> launchPrice, Object locationType, List<String> platform, Object pricing, String regionVersion, List<Long> retargetingTags, List<Long> retargetingTagsExclude, List<Long> retargetingTagsInclude, Object retargetingType, Object scheduleType, Object superiorPopularityType, List<Long> userType) throws ApiException {

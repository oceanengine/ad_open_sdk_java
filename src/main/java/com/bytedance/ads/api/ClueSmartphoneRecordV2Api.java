...
public class ClueSmartphoneRecordV2Api {
     ...
     */
    public okhttp3.Call openApi2ClueSmartphoneRecordGetCall(Long advertiserId, List<Long> instanceIds, List<Long> clueIds, List<Long> siteIds, List<Long> adIds, LocalDate startTime, LocalDate endTime, Integer page, Integer pageSize, final ApiCallback _callback) throws ApiException {
    ...
    private okhttp3.Call openApi2ClueSmartphoneRecordGetValidateBeforeCall(Long advertiserId, List<Long> instanceIds, List<Long> clueIds, List<Long> siteIds, List<Long> adIds, LocalDate startTime, LocalDate endTime, Integer page, Integer pageSize, final ApiCallback _callback) throws ApiException {
     ...
     */
    public ClueSmartphoneRecordV2Response openApi2ClueSmartphoneRecordGet(Long advertiserId, List<Long> instanceIds, List<Long> clueIds, List<Long> siteIds, List<Long> adIds, LocalDate startTime, LocalDate endTime, Integer page, Integer pageSize) throws ApiException {
     ...
     */
    public ApiResponse<ClueSmartphoneRecordV2Response> openApi2ClueSmartphoneRecordGetWithHttpInfo(Long advertiserId, List<Long> instanceIds, List<Long> clueIds, List<Long> siteIds, List<Long> adIds, LocalDate startTime, LocalDate endTime, Integer page, Integer pageSize) throws ApiException {
     ...
     */
    public okhttp3.Call openApi2ClueSmartphoneRecordGetAsync(Long advertiserId, List<Long> instanceIds, List<Long> clueIds, List<Long> siteIds, List<Long> adIds, LocalDate startTime, LocalDate endTime, Integer page, Integer pageSize, final ApiCallback<ClueSmartphoneRecordV2Response> _callback) throws ApiException {

...
public class ToolsVideoCheckAvailableAnchorV2Api {
     ...
     */
    public okhttp3.Call openApi2ToolsVideoCheckAvailableAnchorGetCall(Long advertiserId, List<Long> itemIds, ToolsVideoCheckAvailableAnchorV2LandingType landingType, ToolsVideoCheckAvailableAnchorV2ExternalAction externalAction, final ApiCallback _callback) throws ApiException {
    ...
    private okhttp3.Call openApi2ToolsVideoCheckAvailableAnchorGetValidateBeforeCall(Long advertiserId, List<Long> itemIds, ToolsVideoCheckAvailableAnchorV2LandingType landingType, ToolsVideoCheckAvailableAnchorV2ExternalAction externalAction, final ApiCallback _callback) throws ApiException {
     ...
     */
    public ToolsVideoCheckAvailableAnchorV2Response openApi2ToolsVideoCheckAvailableAnchorGet(Long advertiserId, List<Long> itemIds, ToolsVideoCheckAvailableAnchorV2LandingType landingType, ToolsVideoCheckAvailableAnchorV2ExternalAction externalAction) throws ApiException {
     ...
     */
    public ApiResponse<ToolsVideoCheckAvailableAnchorV2Response> openApi2ToolsVideoCheckAvailableAnchorGetWithHttpInfo(Long advertiserId, List<Long> itemIds, ToolsVideoCheckAvailableAnchorV2LandingType landingType, ToolsVideoCheckAvailableAnchorV2ExternalAction externalAction) throws ApiException {

...
public class BrandPolicyListV30Api {
    ...
    private okhttp3.Call openApiV30BrandPolicyListGetValidateBeforeCall(Long advertiserId, BrandPolicyListV30Classify classify, BrandPolicyListV30ProType proType, BrandPolicyListV30AdForm adForm, BrandPolicyListV30AppOrigin appOrigin, BrandPolicyListV30PricingType pricingType, BrandPolicyListV30GdSendType gdSendType, BrandPolicyListV30DeliveryInfo deliveryInfo, String intentionNo, BrandPolicyListV30AudienceInfo audienceInfo, final ApiCallback _callback) throws ApiException {
        ...
        return openApiV30BrandPolicyListGetCall(advertiserId, classify, proType, adForm, appOrigin, pricingType, gdSendType, deliveryInfo, intentionNo, audienceInfo, _callback);
     ...
     */
    public BrandPolicyListV30Response openApiV30BrandPolicyListGet(Long advertiserId, BrandPolicyListV30Classify classify, BrandPolicyListV30ProType proType, BrandPolicyListV30AdForm adForm, BrandPolicyListV30AppOrigin appOrigin, BrandPolicyListV30PricingType pricingType, BrandPolicyListV30GdSendType gdSendType, BrandPolicyListV30DeliveryInfo deliveryInfo, String intentionNo, BrandPolicyListV30AudienceInfo audienceInfo) throws ApiException {
        ApiResponse<BrandPolicyListV30Response> localVarResp = openApiV30BrandPolicyListGetWithHttpInfo(advertiserId, classify, proType, adForm, appOrigin, pricingType, gdSendType, deliveryInfo, intentionNo, audienceInfo);
    ...
    public ApiResponse<BrandPolicyListV30Response> openApiV30BrandPolicyListGetWithHttpInfo(Long advertiserId, BrandPolicyListV30Classify classify, BrandPolicyListV30ProType proType, BrandPolicyListV30AdForm adForm, BrandPolicyListV30AppOrigin appOrigin, BrandPolicyListV30PricingType pricingType, BrandPolicyListV30GdSendType gdSendType, BrandPolicyListV30DeliveryInfo deliveryInfo, String intentionNo, BrandPolicyListV30AudienceInfo audienceInfo) throws ApiException {
        okhttp3.Call localVarCall = openApiV30BrandPolicyListGetValidateBeforeCall(advertiserId, classify, proType, adForm, appOrigin, pricingType, gdSendType, deliveryInfo, intentionNo, audienceInfo, null);
     ...
     */
    public okhttp3.Call openApiV30BrandPolicyListGetAsync(Long advertiserId, BrandPolicyListV30Classify classify, BrandPolicyListV30ProType proType, BrandPolicyListV30AdForm adForm, BrandPolicyListV30AppOrigin appOrigin, BrandPolicyListV30PricingType pricingType, BrandPolicyListV30GdSendType gdSendType, BrandPolicyListV30DeliveryInfo deliveryInfo, String intentionNo, BrandPolicyListV30AudienceInfo audienceInfo, final ApiCallback<BrandPolicyListV30Response> _callback) throws ApiException {

        okhttp3.Call localVarCall = openApiV30BrandPolicyListGetValidateBeforeCall(advertiserId, classify, proType, adForm, appOrigin, pricingType, gdSendType, deliveryInfo, intentionNo, audienceInfo, _callback);
        Type localVarReturnType = new TypeToken<BrandPolicyListV30Response>(){}.getType();

...
public class AgentInfoV2Api {
     ...
     */
    public okhttp3.Call openApi2AgentInfoGetCall(List<Long> advertiserIds, List<String> fields, final ApiCallback _callback) throws ApiException {
    ...
    private okhttp3.Call openApi2AgentInfoGetValidateBeforeCall(List<Long> advertiserIds, List<String> fields, final ApiCallback _callback) throws ApiException {
     ...
     */
    public AgentInfoV2Response openApi2AgentInfoGet(List<Long> advertiserIds, List<String> fields) throws ApiException {
     ...
     */
    public ApiResponse<AgentInfoV2Response> openApi2AgentInfoGetWithHttpInfo(List<Long> advertiserIds, List<String> fields) throws ApiException {
     ...
     */
    public okhttp3.Call openApi2AgentInfoGetAsync(List<Long> advertiserIds, List<String> fields, final ApiCallback<AgentInfoV2Response> _callback) throws ApiException {

...
public class FileRebateCommonDownloadDownloadFileV2Api {
     ...
     */
    public FileRebateCommonDownloadDownloadFileV2Response openApi2FileRebateCommonDownloadDownloadFileGet(Long agentId, String taskId) throws ApiException {
        ApiResponse<FileRebateCommonDownloadDownloadFileV2Response> localVarResp = openApi2FileRebateCommonDownloadDownloadFileGetWithHttpInfo(agentId, taskId);
     ...
     */
    public ApiResponse<FileRebateCommonDownloadDownloadFileV2Response> openApi2FileRebateCommonDownloadDownloadFileGetWithHttpInfo(Long agentId, String taskId) throws ApiException {
        okhttp3.Call localVarCall = openApi2FileRebateCommonDownloadDownloadFileGetValidateBeforeCall(agentId, taskId, null);
        Type localVarReturnType = new TypeToken<FileRebateCommonDownloadDownloadFileV2Response>(){}.getType();
     ...
     */
    public okhttp3.Call openApi2FileRebateCommonDownloadDownloadFileGetAsync(Long agentId, String taskId, final ApiCallback<FileRebateCommonDownloadDownloadFileV2Response> _callback) throws ApiException {

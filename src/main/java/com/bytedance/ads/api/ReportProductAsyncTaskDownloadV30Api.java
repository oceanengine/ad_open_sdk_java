...
public class ReportProductAsyncTaskDownloadV30Api {
     ...
     */
    public  byte[] openApiV30ReportProductAsyncTaskDownloadGet(Long advertiserId, Long taskId, Long rangeFrom, Long rangeTo) throws ApiException {
        ApiResponse< byte[] > localVarResp = openApiV30ReportProductAsyncTaskDownloadGetWithHttpInfo(advertiserId, taskId, rangeFrom, rangeTo);
     ...
     */
    public ApiResponse< byte[] > openApiV30ReportProductAsyncTaskDownloadGetWithHttpInfo(Long advertiserId, Long taskId, Long rangeFrom, Long rangeTo) throws ApiException {
     ...
     */
    public okhttp3.Call openApiV30ReportProductAsyncTaskDownloadGetAsync(Long advertiserId, Long taskId, Long rangeFrom, Long rangeTo, final ApiCallback< byte[] > _callback) throws ApiException {

...
public class ToolsBidsSuggestV30Api {
    ...
    private okhttp3.Call openApiV30ToolsBidsSuggestGetValidateBeforeCall(Long advertiserId, ToolsBidsSuggestV30Pricing pricing, ToolsBidsSuggestV30ExternalAction externalAction, Long projectId, ToolsBidsSuggestV30DeepExternalAction deepExternalAction, ToolsBidsSuggestV30DeepBidType deepBidType, final ApiCallback _callback) throws ApiException {
        ...
        return openApiV30ToolsBidsSuggestGetCall(advertiserId, pricing, externalAction, projectId, deepExternalAction, deepBidType, _callback);
     ...
     */
    public ToolsBidsSuggestV30Response openApiV30ToolsBidsSuggestGet(Long advertiserId, ToolsBidsSuggestV30Pricing pricing, ToolsBidsSuggestV30ExternalAction externalAction, Long projectId, ToolsBidsSuggestV30DeepExternalAction deepExternalAction, ToolsBidsSuggestV30DeepBidType deepBidType) throws ApiException {
        ApiResponse<ToolsBidsSuggestV30Response> localVarResp = openApiV30ToolsBidsSuggestGetWithHttpInfo(advertiserId, pricing, externalAction, projectId, deepExternalAction, deepBidType);
    ...
    public ApiResponse<ToolsBidsSuggestV30Response> openApiV30ToolsBidsSuggestGetWithHttpInfo(Long advertiserId, ToolsBidsSuggestV30Pricing pricing, ToolsBidsSuggestV30ExternalAction externalAction, Long projectId, ToolsBidsSuggestV30DeepExternalAction deepExternalAction, ToolsBidsSuggestV30DeepBidType deepBidType) throws ApiException {
        okhttp3.Call localVarCall = openApiV30ToolsBidsSuggestGetValidateBeforeCall(advertiserId, pricing, externalAction, projectId, deepExternalAction, deepBidType, null);
     ...
     */
    public okhttp3.Call openApiV30ToolsBidsSuggestGetAsync(Long advertiserId, ToolsBidsSuggestV30Pricing pricing, ToolsBidsSuggestV30ExternalAction externalAction, Long projectId, ToolsBidsSuggestV30DeepExternalAction deepExternalAction, ToolsBidsSuggestV30DeepBidType deepBidType, final ApiCallback<ToolsBidsSuggestV30Response> _callback) throws ApiException {

        okhttp3.Call localVarCall = openApiV30ToolsBidsSuggestGetValidateBeforeCall(advertiserId, pricing, externalAction, projectId, deepExternalAction, deepBidType, _callback);
        Type localVarReturnType = new TypeToken<ToolsBidsSuggestV30Response>(){}.getType();

...
public class ReportCustomConfigGetV30Api {
    ...
    public ReportCustomConfigGetV30Api() {
        this(Configuration.getDefaultApiClient());
    }

    public ReportCustomConfigGetV30Api(ApiClient apiClient) {
    ...
    /**
     * Build call for openApiV30ReportCustomConfigGetGet
     * @param advertiserId  (required)
     * @param dataTopics 数据主题查询列表 (required)
     ...
     * @param advertiserId  (required)
     * @param dataTopics 数据主题查询列表 (required)
     * @return ApiResponse&lt;ReportCustomConfigGetV30Response&gt;
     * @throws ApiException If fail to call the API, e.g. server error or cannot deserialize the response body
     * @http.response.details
     <table summary="Response Details" border="1">
        <tr><td> Status Code </td><td> Description </td><td> Response Headers </td></tr>
    ...
    public ApiResponse<ReportCustomConfigGetV30Response> openApiV30ReportCustomConfigGetGetWithHttpInfo(Long advertiserId, List<ReportCustomConfigGetV30DataTopics> dataTopics) throws ApiException {
        okhttp3.Call localVarCall = openApiV30ReportCustomConfigGetGetValidateBeforeCall(advertiserId, dataTopics, null);
     ...
     */
    public okhttp3.Call openApiV30ReportCustomConfigGetGetAsync(Long advertiserId, List<ReportCustomConfigGetV30DataTopics> dataTopics, final ApiCallback<ReportCustomConfigGetV30Response> _callback) throws ApiException {

        okhttp3.Call localVarCall = openApiV30ReportCustomConfigGetGetValidateBeforeCall(advertiserId, dataTopics, _callback);
        Type localVarReturnType = new TypeToken<ReportCustomConfigGetV30Response>(){}.getType();

...
public class ToolsCommentMid2itemIdV30Api {
     ...
     */
    public okhttp3.Call openApiV30ToolsCommentMid2itemIdGetCall(Long advertiserId, LocalDate startTime, LocalDate endTime, Long materialId, Long page, Long pageSize, final ApiCallback _callback) throws ApiException {
    ...
    private okhttp3.Call openApiV30ToolsCommentMid2itemIdGetValidateBeforeCall(Long advertiserId, LocalDate startTime, LocalDate endTime, Long materialId, Long page, Long pageSize, final ApiCallback _callback) throws ApiException {
     ...
     */
    public ToolsCommentMid2itemIdV30Response openApiV30ToolsCommentMid2itemIdGet(Long advertiserId, LocalDate startTime, LocalDate endTime, Long materialId, Long page, Long pageSize) throws ApiException {
     ...
     */
    public ApiResponse<ToolsCommentMid2itemIdV30Response> openApiV30ToolsCommentMid2itemIdGetWithHttpInfo(Long advertiserId, LocalDate startTime, LocalDate endTime, Long materialId, Long page, Long pageSize) throws ApiException {
     ...
     */
    public okhttp3.Call openApiV30ToolsCommentMid2itemIdGetAsync(Long advertiserId, LocalDate startTime, LocalDate endTime, Long materialId, Long page, Long pageSize, final ApiCallback<ToolsCommentMid2itemIdV30Response> _callback) throws ApiException {

...
public class FileVideoGetV2Filtering {
  ...
  public static final String SERIALIZED_NAME_STAR_AUTHOR_IDS = "star_author_ids";
  @SerializedName(SERIALIZED_NAME_STAR_AUTHOR_IDS)
  private List<String> starAuthorIds = null;
  ...
  **/
  ...
  public FileVideoGetV2Filtering starAuthorIds(List<String> starAuthorIds) {
    
    this.starAuthorIds = starAuthorIds;
    return this;
  }

  public FileVideoGetV2Filtering addStarAuthorIdsItem(String starAuthorIdsItem) {
    if (this.starAuthorIds == null) {
      this.starAuthorIds = new ArrayList<>();
    }
    this.starAuthorIds.add(starAuthorIdsItem);
    return this;
  }

   /**
   * 星图达人 id 检索，最大 支持 20 个
   * @return starAuthorIds
  **/
  @javax.annotation.Nullable
  public List<String> getStarAuthorIds() {
    return starAuthorIds;
  }


  public void setStarAuthorIds(List<String> starAuthorIds) {
    this.starAuthorIds = starAuthorIds;
  }
  ...
  **/
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.endTime, fileVideoGetV2Filtering.endTime) &&
        ...
        Objects.equals(this.starAuthorIds, fileVideoGetV2Filtering.starAuthorIds) &&
  ...
  @Override
  public int hashCode() {
    return Objects.hash(endTime, height, labels, materialIds, ratio, signatures, source, starAuthorIds, startTime, videoIds, width);
  }
  ...
  public String toString() {
    ...
    sb.append("    starAuthorIds: ").append(toIndentedString(starAuthorIds)).append("\n");
  ...
  static {
    ...
    openapiFields.add("star_author_ids");

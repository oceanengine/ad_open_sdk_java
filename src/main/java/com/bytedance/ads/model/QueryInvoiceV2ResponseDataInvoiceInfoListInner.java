...
public class QueryInvoiceV2ResponseDataInvoiceInfoListInner {
  ...
  **/
  ...
  @Override
  public int hashCode() {
    return Objects.hash(abandonedAmount, actualInvoiceAmount, applyAmount, contractName, contractSerial, contractSubjectName, customerName, invoiceAmount, invoiceCodes, invoiceId, invoiceNos, invoiceSerial, invoiceStatus, invoiceStatusName, invoiceType, invoiceTypeName, issueTime, platformName, revertAmount, revertFrozenAmount, revertStatus, revertStatusName);
  }

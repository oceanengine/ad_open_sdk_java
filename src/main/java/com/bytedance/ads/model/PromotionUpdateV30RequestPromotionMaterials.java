...
public class PromotionUpdateV30RequestPromotionMaterials {
  ...
  **/
  ...
  @Override
  public int hashCode() {
    return Objects.hash(advancedDcSettings, anchorMaterialList, blueFlowMaterialRecommend, callToActionButtons, carouselMaterialList, componentMaterialList, dynamicCreativeSwitch, externalUrlField, externalUrlMaterialList, externalUrlParams, imageMaterialList, instantPlayMaterialList, intelligentGeneration, miniProgramInfo, openUrl, openUrlField, openUrlParams, openUrls, originalVideoTitle, playableUrlMaterialList, playletSeriesUrlList, productInfo, textAbstractList, titleMaterialList, trialPlayMaterialList, ulink, ulinkType, videoMaterialList, webUrlMaterialList);
  }

...
public class PromotionUpdateV30RequestPromotionMaterials {
  ...
  **/
  ...
  @Override
  public int hashCode() {
    return Objects.hash(advancedDcSettings, anchorMaterialList, blueFlowMaterialRecommend, callToActionButtons, carouselMaterialList, componentMaterialList, decorationMaterial, dynamicCreativeSwitch, externalUrlField, externalUrlMaterialList, externalUrlParams, imageMaterialList, intelligentGeneration, miniProgramInfo, openUrl, openUrlField, openUrlParams, openUrls, playableUrlMaterialList, playletSeriesUrlList, productInfo, textAbstractList, titleMaterialList, ulink, ulinkType, videoMaterialList, webUrlMaterialList);
  }

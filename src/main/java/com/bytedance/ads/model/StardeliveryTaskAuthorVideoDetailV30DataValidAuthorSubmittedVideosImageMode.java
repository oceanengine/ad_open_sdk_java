 ...
 * 
 */
@JsonAdapter(StardeliveryTaskAuthorVideoDetailV30DataValidAuthorSubmittedVideosImageMode.Adapter.class)
public enum StardeliveryTaskAuthorVideoDetailV30DataValidAuthorSubmittedVideosImageMode {
  ...
  StardeliveryTaskAuthorVideoDetailV30DataValidAuthorSubmittedVideosImageMode(String value) {
    this.value = value;
  }
  ...
  public static StardeliveryTaskAuthorVideoDetailV30DataValidAuthorSubmittedVideosImageMode fromValue(String value) {
    for (StardeliveryTaskAuthorVideoDetailV30DataValidAuthorSubmittedVideosImageMode b : StardeliveryTaskAuthorVideoDetailV30DataValidAuthorSubmittedVideosImageMode.values()) {
  ...
  public static class Adapter extends TypeAdapter<StardeliveryTaskAuthorVideoDetailV30DataValidAuthorSubmittedVideosImageMode> {
    @Override
    public void write(final JsonWriter jsonWriter, final StardeliveryTaskAuthorVideoDetailV30DataValidAuthorSubmittedVideosImageMode enumeration) throws IOException {
      jsonWriter.value(enumeration.getValue());
    }

    @Override
    public StardeliveryTaskAuthorVideoDetailV30DataValidAuthorSubmittedVideosImageMode read(final JsonReader jsonReader) throws IOException {
      String value = jsonReader.nextString();
      return StardeliveryTaskAuthorVideoDetailV30DataValidAuthorSubmittedVideosImageMode.fromValue(value);
    }
  }
}

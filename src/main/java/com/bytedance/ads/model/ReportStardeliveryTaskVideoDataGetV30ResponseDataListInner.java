...
public class ReportStardeliveryTaskVideoDataGetV30ResponseDataListInner {
  ...
  **/
  ...
  @Override
  public int hashCode() {
    return Objects.hash(active, activePay, activeRegister, gamePayCount, iesAvatarUrl, iesNickname, inAppPaymentAmountRange, inAppPaymentAmountRangeT1, inAppStatCostRange, inAppStatCostRangeT1, installFinishCnt, isvId, isvName, materialId, nonAdStatCost, starActiveCount, starActivePayCount, starActiveRegisterCount, starConvertCnt, starCpm, starDeepPurchaseCount, starInstallFinishCount, starMaterialCreativeOrient, starMaterialDisplayFormat, starMaterialNaturalViewsT1, starMaterialPurchaseMethod, starMaterialStatCost, starMaterialTotalViews, starMaterialType, starSaleMaterialStatCost, starStatCost, starTaskId, starVideoMaterialAssessment, starVideoRelatePromotionCount, starVideoStatus, statCost, videoCoverUrl, videoPlayLink, videoTitle);
  }

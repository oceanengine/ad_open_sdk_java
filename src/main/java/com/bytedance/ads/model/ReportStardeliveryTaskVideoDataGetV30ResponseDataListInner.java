...
public class ReportStardeliveryTaskVideoDataGetV30ResponseDataListInner {
  ...
  **/
  ...
  @Override
  public int hashCode() {
    return Objects.hash(active, activePay, activeRegister, gamePayCount, iesAvatarUrl, iesNickname, inAppPaymentAmountRange, inAppPaymentAmountRangeT1, inAppStatCostRange, inAppStatCostRangeT1, installFinishCnt, materialId, nonAdStatCost, starActiveCount, starActivePayCount, starActiveRegisterCount, starConvertCnt, starCpm, starDeepPurchaseCount, starInstallFinishCount, starMaterialFirstName, starMaterialFirstType, starMaterialNaturalViewsT1, starMaterialPurchaseMethod, starMaterialSecondName, starMaterialSecondType, starMaterialStatCost, starMaterialTotalViews, starMaterialType, starSaleMaterialStatCost, starStatCost, starTaskId, starVideoRelatePromotionCount, starVideoStatus, statCost, videoCoverUrl, videoPlayLink, videoTitle);
  }

...
public class ReportStardeliveryTaskVideoDataGetV30ResponseDataListInner {
  ...
  **/
  ...
  @Override
  public int hashCode() {
    return Objects.hash(active, activePay, activeRegister, gamePayCount, iesAvatarUrl, iesNickname, inAppPaymentAmountRange, inAppPaymentAmountRangeT1, inAppStatCostRange, inAppStatCostRangeT1, installFinishCnt, materialId, nonAdStatCost, starActiveCount, starActivePayCount, starActiveRegisterCount, starConvertCnt, starCpm, starDeepPurchaseCount, starInstallFinishCount, starMaterialFirstName, starMaterialFirstType, starMaterialNaturalViewsT1, starMaterialSecondName, starMaterialSecondType, starMaterialStatCost, starMaterialTotalViews, starSaleMaterialStatCost, starStatCost, starTaskId, starVideoRelatePromotionCount, starVideoStatus, statCost, videoCoverUrl, videoPlayLink, videoTitle);
  }

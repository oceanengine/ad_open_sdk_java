...
import com.bytedance.ads.model.ToolsAwemeAuthListV2DataListAuthScenarios;
...
public class ToolsAwemeAuthListV2ResponseDataListInner {
  ...
  public static final String SERIALIZED_NAME_AUTH_SCENARIOS = "auth_scenarios";
  @SerializedName(SERIALIZED_NAME_AUTH_SCENARIOS)
  private List<ToolsAwemeAuthListV2DataListAuthScenarios> authScenarios = null;
  ...
  **/
  ...
  public ToolsAwemeAuthListV2ResponseDataListInner authScenarios(List<ToolsAwemeAuthListV2DataListAuthScenarios> authScenarios) {
    
    this.authScenarios = authScenarios;
    return this;
  }

  public ToolsAwemeAuthListV2ResponseDataListInner addAuthScenariosItem(ToolsAwemeAuthListV2DataListAuthScenarios authScenariosItem) {
    if (this.authScenarios == null) {
      this.authScenarios = new ArrayList<>();
    }
    this.authScenarios.add(authScenariosItem);
    return this;
  }
  ...
  **/
  @javax.annotation.Nullable
  public List<ToolsAwemeAuthListV2DataListAuthScenarios> getAuthScenarios() {
    return authScenarios;
  }


  public void setAuthScenarios(List<ToolsAwemeAuthListV2DataListAuthScenarios> authScenarios) {
    this.authScenarios = authScenarios;
  }
  ...
  **/
  ...
  public ToolsAwemeAuthListV2ResponseDataListInner openId(String openId) {
  ...
  **/
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.authAutoExpireDate, toolsAwemeAuthListV2ResponseDataListInner.authAutoExpireDate) &&
        Objects.equals(this.authScenarios, toolsAwemeAuthListV2ResponseDataListInner.authScenarios) &&
        ...
        Objects.equals(this.openId, toolsAwemeAuthListV2ResponseDataListInner.openId) &&
  ...
  @Override
  public int hashCode() {
    return Objects.hash(authAutoExpireDate, authScenarios, authStatus, authThresholdInfo, authType, awemeCancelImageList, awemeCancelNote, awemeCancelReason, awemeId, awemeName, awemeUserType, endTime, hasVideoHpVisibilityLimit, note, openId, shareType, startTime, subStatus, videoInfo, warningContent, warningTypes);
  }
  ...
  public String toString() {
    ...
    sb.append("    authScenarios: ").append(toIndentedString(authScenarios)).append("\n");
  ...
  static {
    ...
    openapiFields.add("auth_scenarios");

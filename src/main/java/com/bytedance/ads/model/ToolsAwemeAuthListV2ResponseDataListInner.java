...
public class ToolsAwemeAuthListV2ResponseDataListInner {
  ...
  **/
  ...
  @Override
  public int hashCode() {
    return Objects.hash(authAutoExpireDate, authStatus, authThresholdInfo, authType, awemeCancelImageList, awemeCancelNote, awemeCancelReason, awemeId, awemeName, awemeUserType, endTime, hasVideoHpVisibilityLimit, note, openId, shareType, startTime, subStatus, videoInfo, warningContent, warningTypes);
  }

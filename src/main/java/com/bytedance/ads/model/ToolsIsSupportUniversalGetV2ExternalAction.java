 ...
 * 
 */
@JsonAdapter(ToolsIsSupportUniversalGetV2ExternalAction.Adapter.class)
public enum ToolsIsSupportUniversalGetV2ExternalAction {
  ...
  ToolsIsSupportUniversalGetV2ExternalAction(String value) {
    this.value = value;
  }
  ...
  public static ToolsIsSupportUniversalGetV2ExternalAction fromValue(String value) {
    for (ToolsIsSupportUniversalGetV2ExternalAction b : ToolsIsSupportUniversalGetV2ExternalAction.values()) {
  ...
  public static class Adapter extends TypeAdapter<ToolsIsSupportUniversalGetV2ExternalAction> {
    @Override
    public void write(final JsonWriter jsonWriter, final ToolsIsSupportUniversalGetV2ExternalAction enumeration) throws IOException {
      jsonWriter.value(enumeration.getValue());
    }

    @Override
    public ToolsIsSupportUniversalGetV2ExternalAction read(final JsonReader jsonReader) throws IOException {
      String value = jsonReader.nextString();
      return ToolsIsSupportUniversalGetV2ExternalAction.fromValue(value);
    }
  }
}

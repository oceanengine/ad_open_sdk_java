 ...
 * 
 */
@JsonAdapter(EventManagerDbtGetV30ExternalAction.Adapter.class)
public enum EventManagerDbtGetV30ExternalAction {
  ...
  EventManagerDbtGetV30ExternalAction(String value) {
    this.value = value;
  }
  ...
  public static EventManagerDbtGetV30ExternalAction fromValue(String value) {
    for (EventManagerDbtGetV30ExternalAction b : EventManagerDbtGetV30ExternalAction.values()) {
  ...
  public static class Adapter extends TypeAdapter<EventManagerDbtGetV30ExternalAction> {
    @Override
    public void write(final JsonWriter jsonWriter, final EventManagerDbtGetV30ExternalAction enumeration) throws IOException {
      jsonWriter.value(enumeration.getValue());
    }

    @Override
    public EventManagerDbtGetV30ExternalAction read(final JsonReader jsonReader) throws IOException {
      String value = jsonReader.nextString();
      return EventManagerDbtGetV30ExternalAction.fromValue(value);
    }
  }
}

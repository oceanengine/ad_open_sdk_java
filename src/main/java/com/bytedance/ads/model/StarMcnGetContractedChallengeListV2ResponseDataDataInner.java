...
public class StarMcnGetContractedChallengeListV2ResponseDataDataInner {
  ...
  **/
  ...
  @Override
  public int hashCode() {
    return Objects.hash(brand, challengeStatus, commissionRate, createTime, demandIcon, demandId, demandName, evaluateType, expirationTime, expirationTimeEnd, firstClassCategory, itemComponentType, mcnProfitRate, payType, price, productCategory, realCost, secondClassCategory, totalBudget, videoType);
  }

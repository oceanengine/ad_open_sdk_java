...
public class ClueCouponEmployeeDeleteV2Request {
  ...
  **/
  ...
  public ClueCouponEmployeeDeleteV2Request _list(List<ClueCouponEmployeeCreateV2RequestListInner> _list) {
    
    this._list = _list;
    return this;
  }

  public ClueCouponEmployeeDeleteV2Request addListItem(ClueCouponEmployeeCreateV2RequestListInner _listItem) {
    if (this._list == null) {

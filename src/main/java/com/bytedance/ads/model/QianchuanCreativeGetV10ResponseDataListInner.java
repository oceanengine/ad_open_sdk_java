...
public class QianchuanCreativeGetV10ResponseDataListInner {
  ...
  **/
  ...
  @Override
  public int hashCode() {
    return Objects.hash(adId, creativeCreateTime, creativeId, creativeMaterialMode, creativeModifyTime, imageMaterial, imageMaterialList, imageMode, labAdType, marketingScene, optStatus, promotionCardMaterial, status, titleMaterial, titleMaterialList, videoMaterial, videoMaterialList);
  }

 ...
 * 
 */
@JsonAdapter(ToolsAdConvertOptimizedTargetGetV2ExternalAction.Adapter.class)
public enum ToolsAdConvertOptimizedTargetGetV2ExternalAction {
  ...
  ToolsAdConvertOptimizedTargetGetV2ExternalAction(String value) {
    this.value = value;
  }
  ...
  public static ToolsAdConvertOptimizedTargetGetV2ExternalAction fromValue(String value) {
    for (ToolsAdConvertOptimizedTargetGetV2ExternalAction b : ToolsAdConvertOptimizedTargetGetV2ExternalAction.values()) {
  ...
  public static class Adapter extends TypeAdapter<ToolsAdConvertOptimizedTargetGetV2ExternalAction> {
    @Override
    public void write(final JsonWriter jsonWriter, final ToolsAdConvertOptimizedTargetGetV2ExternalAction enumeration) throws IOException {
      jsonWriter.value(enumeration.getValue());
    }

    @Override
    public ToolsAdConvertOptimizedTargetGetV2ExternalAction read(final JsonReader jsonReader) throws IOException {
      String value = jsonReader.nextString();
      return ToolsAdConvertOptimizedTargetGetV2ExternalAction.fromValue(value);
    }
  }
}

 ...
 * 
 */
@JsonAdapter(PromotionListV30DataListPromotionRelatedProductVideoMaterialListImageMode.Adapter.class)
public enum PromotionListV30DataListPromotionRelatedProductVideoMaterialListImageMode {
  ...
  PromotionListV30DataListPromotionRelatedProductVideoMaterialListImageMode(String value) {
    this.value = value;
  }
  ...
  public static PromotionListV30DataListPromotionRelatedProductVideoMaterialListImageMode fromValue(String value) {
    for (PromotionListV30DataListPromotionRelatedProductVideoMaterialListImageMode b : PromotionListV30DataListPromotionRelatedProductVideoMaterialListImageMode.values()) {
  ...
  public static class Adapter extends TypeAdapter<PromotionListV30DataListPromotionRelatedProductVideoMaterialListImageMode> {
    @Override
    public void write(final JsonWriter jsonWriter, final PromotionListV30DataListPromotionRelatedProductVideoMaterialListImageMode enumeration) throws IOException {
      jsonWriter.value(enumeration.getValue());
    }

    @Override
    public PromotionListV30DataListPromotionRelatedProductVideoMaterialListImageMode read(final JsonReader jsonReader) throws IOException {
      String value = jsonReader.nextString();
      return PromotionListV30DataListPromotionRelatedProductVideoMaterialListImageMode.fromValue(value);
    }
  }
}

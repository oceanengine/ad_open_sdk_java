...
import com.bytedance.ads.model.BrandOrderListV30ResponseDataOrdersInnerAdInfos;
...
public class BrandOrderListV30ResponseDataOrdersInner {
  ...
  private BrandOrderListV30ResponseDataOrdersInnerAdInfos adInfos = null;
  ...
  **/
  ...
  public BrandOrderListV30ResponseDataOrdersInner adInfos(BrandOrderListV30ResponseDataOrdersInnerAdInfos adInfos) {
  ...
  **/
  @javax.annotation.Nullable
  public BrandOrderListV30ResponseDataOrdersInnerAdInfos getAdInfos() {
    return adInfos;
  }


  public void setAdInfos(BrandOrderListV30ResponseDataOrdersInnerAdInfos adInfos) {
    this.adInfos = adInfos;
  }
  ...
  **/
  ...
  @Override
  public int hashCode() {
    return Objects.hash(adForm, adInfos, advancedCreativeType, advertiserId, appOrigin, audienceInfo, auditStatus, bookingQuantityInfo, budget, campaignId, campaignName, classify, createTime, frequencyInfo, gdSendType, magazinePriceInfo, merchantIntention, orderId, orderName, policy, pricingType, proType, remark, status);
  }

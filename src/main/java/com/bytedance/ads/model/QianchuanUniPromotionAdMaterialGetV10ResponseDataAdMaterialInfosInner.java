...
public class QianchuanUniPromotionAdMaterialGetV10ResponseDataAdMaterialInfosInner {
  ...
  private List<String> deliveryNotReason = null;
  ...
  public static final String SERIALIZED_NAME_PRODUCT_ID_LIST = "product_id_list";
  ...
  **/
  ...
  public QianchuanUniPromotionAdMaterialGetV10ResponseDataAdMaterialInfosInner awemeIdList(List<Long> awemeIdList) {
    
    this.awemeIdList = awemeIdList;
    return this;
  }

  public QianchuanUniPromotionAdMaterialGetV10ResponseDataAdMaterialInfosInner addAwemeIdListItem(Long awemeIdListItem) {
  ...
  **/
  ...
  public QianchuanUniPromotionAdMaterialGetV10ResponseDataAdMaterialInfosInner deliveryNotReason(List<String> deliveryNotReason) {
    
    this.deliveryNotReason = deliveryNotReason;
    return this;
  }

  public QianchuanUniPromotionAdMaterialGetV10ResponseDataAdMaterialInfosInner addDeliveryNotReasonItem(String deliveryNotReasonItem) {
    if (this.deliveryNotReason == null) {
      this.deliveryNotReason = new ArrayList<>();
    }
    this.deliveryNotReason.add(deliveryNotReasonItem);
    return this;
  }
  ...
  **/
  @javax.annotation.Nullable
  public List<String> getDeliveryNotReason() {
    return deliveryNotReason;
  }


  public void setDeliveryNotReason(List<String> deliveryNotReason) {
    this.deliveryNotReason = deliveryNotReason;
  }
  ...
  **/
  ...
  public QianchuanUniPromotionAdMaterialGetV10ResponseDataAdMaterialInfosInner productIdList(List<Long> productIdList) {
    
    this.productIdList = productIdList;
    return this;
  }

  public QianchuanUniPromotionAdMaterialGetV10ResponseDataAdMaterialInfosInner addProductIdListItem(Long productIdListItem) {
  ...
  **/
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.auditStatus, qianchuanUniPromotionAdMaterialGetV10ResponseDataAdMaterialInfosInner.auditStatus) &&
        Objects.equals(this.awemeIdList, qianchuanUniPromotionAdMaterialGetV10ResponseDataAdMaterialInfosInner.awemeIdList) &&
        Objects.equals(this.deliveryNotReason, qianchuanUniPromotionAdMaterialGetV10ResponseDataAdMaterialInfosInner.deliveryNotReason) &&
        ...
        Objects.equals(this.productIdList, qianchuanUniPromotionAdMaterialGetV10ResponseDataAdMaterialInfosInner.productIdList) &&
  ...
  @Override
  public int hashCode() {
    return Objects.hash(auditStatus, awemeIdList, deliveryNotReason, isDelete, materialInfo, materialSelectType, materialStatus, productIdList, productInfo, statsInfo);
  }
  ...
  static {
    ...
    openapiFields.add("product_id_list");

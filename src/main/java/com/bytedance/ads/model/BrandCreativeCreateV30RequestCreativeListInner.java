...
public class BrandCreativeCreateV30RequestCreativeListInner {
  ...
  **/
  ...
  @Override
  public int hashCode() {
    return Objects.hash(advancedCreative, advancedCreativeInfo, awemeId, creativeIsAIGC, externalOpenUrl, externalUrl, externalUrlIsDownload, externalUrlTitle, iesCoreUserId, itemId, materialPackageId, openUrl, title, videoId, webUrl, webUrlIsDownload);
  }

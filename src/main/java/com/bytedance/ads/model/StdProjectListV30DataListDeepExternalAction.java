 ...
 * 深度优化目标
 */
@JsonAdapter(StdProjectListV30DataListDeepExternalAction.Adapter.class)
public enum StdProjectListV30DataListDeepExternalAction {
  ...
  StdProjectListV30DataListDeepExternalAction(String value) {
    this.value = value;
  }
  ...
  public static StdProjectListV30DataListDeepExternalAction fromValue(String value) {
    for (StdProjectListV30DataListDeepExternalAction b : StdProjectListV30DataListDeepExternalAction.values()) {
  ...
  public static class Adapter extends TypeAdapter<StdProjectListV30DataListDeepExternalAction> {
    @Override
    public void write(final JsonWriter jsonWriter, final StdProjectListV30DataListDeepExternalAction enumeration) throws IOException {
      jsonWriter.value(enumeration.getValue());
    }

    @Override
    public StdProjectListV30DataListDeepExternalAction read(final JsonReader jsonReader) throws IOException {
      String value = jsonReader.nextString();
      return StdProjectListV30DataListDeepExternalAction.fromValue(value);
    }
  }
}

 ...
 * 
 */
@JsonAdapter(AdConvertOptimizedTargetGetV30DataListConvertsExternalActionsExternalAction.Adapter.class)
public enum AdConvertOptimizedTargetGetV30DataListConvertsExternalActionsExternalAction {
  ...
  AdConvertOptimizedTargetGetV30DataListConvertsExternalActionsExternalAction(String value) {
    this.value = value;
  }
  ...
  public static AdConvertOptimizedTargetGetV30DataListConvertsExternalActionsExternalAction fromValue(String value) {
    for (AdConvertOptimizedTargetGetV30DataListConvertsExternalActionsExternalAction b : AdConvertOptimizedTargetGetV30DataListConvertsExternalActionsExternalAction.values()) {
  ...
  public static class Adapter extends TypeAdapter<AdConvertOptimizedTargetGetV30DataListConvertsExternalActionsExternalAction> {
    @Override
    public void write(final JsonWriter jsonWriter, final AdConvertOptimizedTargetGetV30DataListConvertsExternalActionsExternalAction enumeration) throws IOException {
      jsonWriter.value(enumeration.getValue());
    }

    @Override
    public AdConvertOptimizedTargetGetV30DataListConvertsExternalActionsExternalAction read(final JsonReader jsonReader) throws IOException {
      String value = jsonReader.nextString();
      return AdConvertOptimizedTargetGetV30DataListConvertsExternalActionsExternalAction.fromValue(value);
    }
  }
}

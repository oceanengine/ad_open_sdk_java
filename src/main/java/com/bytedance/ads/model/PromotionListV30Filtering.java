...
public class PromotionListV30Filtering {
  ...
  **/
  ...
  @Override
  public int hashCode() {
    return Objects.hash(blueFlowPackageSetting, deliveryMode, hasCarryMaterial, ids, learningPhase, name, projectId, promotionCreateTime, promotionModifyTime, rejectReasonType, starAutoDeliverySwitch, starDeliveryType, status, statusFirst, statusSecond);
  }

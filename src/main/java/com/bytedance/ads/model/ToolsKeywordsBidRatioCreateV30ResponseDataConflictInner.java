...
public class ToolsKeywordsBidRatioCreateV30ResponseDataConflictInner {
  ...
  private List<Float> bidCoefs = null;
  ...
  **/
  ...
  public ToolsKeywordsBidRatioCreateV30ResponseDataConflictInner bidCoefs(List<Float> bidCoefs) {
    
    this.bidCoefs = bidCoefs;
    return this;
  }

  public ToolsKeywordsBidRatioCreateV30ResponseDataConflictInner addBidCoefsItem(Float bidCoefsItem) {
  ...
  **/
  @javax.annotation.Nullable
  public List<Float> getBidCoefs() {
    return bidCoefs;
  }


  public void setBidCoefs(List<Float> bidCoefs) {
    this.bidCoefs = bidCoefs;
  }

...
public class ProjectCreateV30RequestDeliverySetting {
  ...
  **/
  ...
  @Override
  public int hashCode() {
    return Objects.hash(bid, bidType, budget, budgetMode, budgetOptimizeSwitch, cpaBid, deepBidType, deepCpabid, endTime, filterNightSwitch, firstRoiGoal, liveDuration, pricing, projectCustom, roiGoal, scheduleTime, scheduleType, searchContinueDelivery, sevenRoiGoal, startTime);
  }

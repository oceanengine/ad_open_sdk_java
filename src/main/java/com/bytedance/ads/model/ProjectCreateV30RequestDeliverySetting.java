...
public class ProjectCreateV30RequestDeliverySetting {
  ...
  **/
  ...
  @Override
  public int hashCode() {
    return Objects.hash(bid, bidSpeed, bidType, budget, budgetMode, budgetOptimizeSwitch, cpaBid, deepBidType, deepCpabid, endTime, filterNightSwitch, firstRoiGoal, pricing, projectCustom, roiGoal, scheduleTime, scheduleType, searchContinueDelivery, shopMultiRoiGoals, startTime);
  }

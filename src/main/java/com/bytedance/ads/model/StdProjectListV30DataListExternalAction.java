 ...
 * 优化目标
 */
@JsonAdapter(StdProjectListV30DataListExternalAction.Adapter.class)
public enum StdProjectListV30DataListExternalAction {
  ...
  StdProjectListV30DataListExternalAction(String value) {
    this.value = value;
  }
  ...
  public static StdProjectListV30DataListExternalAction fromValue(String value) {
    for (StdProjectListV30DataListExternalAction b : StdProjectListV30DataListExternalAction.values()) {
  ...
  public static class Adapter extends TypeAdapter<StdProjectListV30DataListExternalAction> {
    @Override
    public void write(final JsonWriter jsonWriter, final StdProjectListV30DataListExternalAction enumeration) throws IOException {
      jsonWriter.value(enumeration.getValue());
    }

    @Override
    public StdProjectListV30DataListExternalAction read(final JsonReader jsonReader) throws IOException {
      String value = jsonReader.nextString();
      return StdProjectListV30DataListExternalAction.fromValue(value);
    }
  }
}

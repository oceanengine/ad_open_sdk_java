...
public class StarDemandCreateChallengeV2RequestDemandInfo {
  ...
  **/
  ...
  @Override
  public int hashCode() {
    return Objects.hash(adSyncConf, attachmentText, attachments, attatchmentsUrl, brandName, challengeRequirement, componentClickMonitorUrl, componentInfo, contactName, contactPhone, demandName, expirationTime, expirationTimeEnd, ipActId, itemShowMonitorUrl, productCategory, productIndustry, productInformation, productLink, productName, projectId, promotionTarget);
  }

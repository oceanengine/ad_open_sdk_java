 ...
 * 
 */
@JsonAdapter(CreativeDetailGetV30DataCreativeImageMaterialsImageMode.Adapter.class)
public enum CreativeDetailGetV30DataCreativeImageMaterialsImageMode {
  ...
  CreativeDetailGetV30DataCreativeImageMaterialsImageMode(String value) {
    this.value = value;
  }
  ...
  public static CreativeDetailGetV30DataCreativeImageMaterialsImageMode fromValue(String value) {
    for (CreativeDetailGetV30DataCreativeImageMaterialsImageMode b : CreativeDetailGetV30DataCreativeImageMaterialsImageMode.values()) {
  ...
  public static class Adapter extends TypeAdapter<CreativeDetailGetV30DataCreativeImageMaterialsImageMode> {
    @Override
    public void write(final JsonWriter jsonWriter, final CreativeDetailGetV30DataCreativeImageMaterialsImageMode enumeration) throws IOException {
      jsonWriter.value(enumeration.getValue());
    }

    @Override
    public CreativeDetailGetV30DataCreativeImageMaterialsImageMode read(final JsonReader jsonReader) throws IOException {
      String value = jsonReader.nextString();
      return CreativeDetailGetV30DataCreativeImageMaterialsImageMode.fromValue(value);
    }
  }
}

 ...
 * 
 */
@JsonAdapter(CreativeProceduralCreativeCreateV2CreativeDecorationMaterialImageMode.Adapter.class)
public enum CreativeProceduralCreativeCreateV2CreativeDecorationMaterialImageMode {
  ...
  CreativeProceduralCreativeCreateV2CreativeDecorationMaterialImageMode(String value) {
    this.value = value;
  }
  ...
  public static CreativeProceduralCreativeCreateV2CreativeDecorationMaterialImageMode fromValue(String value) {
    for (CreativeProceduralCreativeCreateV2CreativeDecorationMaterialImageMode b : CreativeProceduralCreativeCreateV2CreativeDecorationMaterialImageMode.values()) {
  ...
  public static class Adapter extends TypeAdapter<CreativeProceduralCreativeCreateV2CreativeDecorationMaterialImageMode> {
    @Override
    public void write(final JsonWriter jsonWriter, final CreativeProceduralCreativeCreateV2CreativeDecorationMaterialImageMode enumeration) throws IOException {
      jsonWriter.value(enumeration.getValue());
    }

    @Override
    public CreativeProceduralCreativeCreateV2CreativeDecorationMaterialImageMode read(final JsonReader jsonReader) throws IOException {
      String value = jsonReader.nextString();
      return CreativeProceduralCreativeCreateV2CreativeDecorationMaterialImageMode.fromValue(value);
    }
  }
}

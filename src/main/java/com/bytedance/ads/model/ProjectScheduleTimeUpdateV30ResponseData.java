...
public class ProjectScheduleTimeUpdateV30ResponseData {
  ...
  public ProjectScheduleTimeUpdateV30ResponseData errors(List<ProjectDeleteV30ResponseDataErrorsInner> errors) {
    
    this.errors = errors;
    return this;
  }

  public ProjectScheduleTimeUpdateV30ResponseData addErrorsItem(ProjectDeleteV30ResponseDataErrorsInner errorsItem) {
    if (this.errors == null) {

 ...
 * 
 */
@JsonAdapter(StdProjectCreateV30DeepBidType.Adapter.class)
public enum StdProjectCreateV30DeepBidType {
  ...
  StdProjectCreateV30DeepBidType(String value) {
    this.value = value;
  }
  ...
  public static StdProjectCreateV30DeepBidType fromValue(String value) {
    for (StdProjectCreateV30DeepBidType b : StdProjectCreateV30DeepBidType.values()) {
  ...
  public static class Adapter extends TypeAdapter<StdProjectCreateV30DeepBidType> {
    @Override
    public void write(final JsonWriter jsonWriter, final StdProjectCreateV30DeepBidType enumeration) throws IOException {
      jsonWriter.value(enumeration.getValue());
    }

    @Override
    public StdProjectCreateV30DeepBidType read(final JsonReader jsonReader) throws IOException {
      String value = jsonReader.nextString();
      return StdProjectCreateV30DeepBidType.fromValue(value);
    }
  }
}

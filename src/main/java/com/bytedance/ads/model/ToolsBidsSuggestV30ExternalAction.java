 ...
 * 
 */
@JsonAdapter(ToolsBidsSuggestV30ExternalAction.Adapter.class)
public enum ToolsBidsSuggestV30ExternalAction {
  ...
  ToolsBidsSuggestV30ExternalAction(String value) {
    this.value = value;
  }
  ...
  public static ToolsBidsSuggestV30ExternalAction fromValue(String value) {
    for (ToolsBidsSuggestV30ExternalAction b : ToolsBidsSuggestV30ExternalAction.values()) {
  ...
  public static class Adapter extends TypeAdapter<ToolsBidsSuggestV30ExternalAction> {
    @Override
    public void write(final JsonWriter jsonWriter, final ToolsBidsSuggestV30ExternalAction enumeration) throws IOException {
      jsonWriter.value(enumeration.getValue());
    }

    @Override
    public ToolsBidsSuggestV30ExternalAction read(final JsonReader jsonReader) throws IOException {
      String value = jsonReader.nextString();
      return ToolsBidsSuggestV30ExternalAction.fromValue(value);
    }
  }
}

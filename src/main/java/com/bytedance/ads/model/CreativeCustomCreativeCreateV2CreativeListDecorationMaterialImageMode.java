 ...
 * 
 */
@JsonAdapter(CreativeCustomCreativeCreateV2CreativeListDecorationMaterialImageMode.Adapter.class)
public enum CreativeCustomCreativeCreateV2CreativeListDecorationMaterialImageMode {
  ...
  CreativeCustomCreativeCreateV2CreativeListDecorationMaterialImageMode(String value) {
    this.value = value;
  }
  ...
  public static CreativeCustomCreativeCreateV2CreativeListDecorationMaterialImageMode fromValue(String value) {
    for (CreativeCustomCreativeCreateV2CreativeListDecorationMaterialImageMode b : CreativeCustomCreativeCreateV2CreativeListDecorationMaterialImageMode.values()) {
  ...
  public static class Adapter extends TypeAdapter<CreativeCustomCreativeCreateV2CreativeListDecorationMaterialImageMode> {
    @Override
    public void write(final JsonWriter jsonWriter, final CreativeCustomCreativeCreateV2CreativeListDecorationMaterialImageMode enumeration) throws IOException {
      jsonWriter.value(enumeration.getValue());
    }

    @Override
    public CreativeCustomCreativeCreateV2CreativeListDecorationMaterialImageMode read(final JsonReader jsonReader) throws IOException {
      String value = jsonReader.nextString();
      return CreativeCustomCreativeCreateV2CreativeListDecorationMaterialImageMode.fromValue(value);
    }
  }
}

...
public class StardeliveryTaskDetailV30ResponseData {
  ...
  **/
  ...
  @Override
  public int hashCode() {
    return Objects.hash(androidAppPackageName, androidDownloadUrl, audienceSettings, authorSubmitFrequency, authorTaskName, briefType, firstIndustryId, firstIndustryName, iosAppPackageName, iosDownloadUrl, microAppId, microAppLink, microAppName, microAppPath, productAdditionalIntroduction, productIntroduction, productName, secondIndustryId, secondIndustryName, starAccountName, starAdCostDivideRatio, starId, starMaterialBid, starMaterialBidRange, starMaterialFirstType, starMaterialSecondType, starTaskAlbumMicroAppInfo, starTaskAnchorId, starTaskAnchorType, starTaskAssetInfo, starTaskBanReasonDetail, starTaskBid, starTaskBudget, starTaskCreateTime, starTaskExternalAction, starTaskId, starTaskMaterialPurchaseMethod, starTaskMaterialsRequirements, starTaskName, starTaskPostEndTime, starTaskSource, starTaskStartTime, starTaskStatus, starTaskSubStatus, starTaskTags, taskAvatarId, taskAvatarUrl, taskContactInfo, taskHeadImageId);
  }

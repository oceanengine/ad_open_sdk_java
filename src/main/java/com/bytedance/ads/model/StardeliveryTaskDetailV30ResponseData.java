...
public class StardeliveryTaskDetailV30ResponseData {
  ...
  **/
  ...
  @Override
  public int hashCode() {
    return Objects.hash(androidAppPackageName, androidDownloadUrl, authorSubmitFrequency, authorTaskName, firstIndustryId, firstIndustryName, iosAppPackageName, iosDownloadUrl, microAppId, microAppLink, microAppName, microAppPath, productIntroduction, productName, secondIndustryId, secondIndustryName, starAccountName, starAdCostDivideRatio, starId, starMaterialBid, starMaterialFirstType, starMaterialSecondType, starTaskAlbumMicroAppInfo, starTaskAnchorId, starTaskAnchorType, starTaskAssetInfo, starTaskBanReasonDetail, starTaskBid, starTaskBudget, starTaskCreateTime, starTaskExternalAction, starTaskId, starTaskMaterialsRequirements, starTaskName, starTaskPostEndTime, starTaskSource, starTaskStartTime, starTaskStatus, starTaskSubStatus, starTaskTags, taskAvatarId, taskAvatarUrl, taskContactInfo, taskHeadImageId);
  }

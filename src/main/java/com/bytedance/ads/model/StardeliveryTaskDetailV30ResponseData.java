...
public class StardeliveryTaskDetailV30ResponseData {
  ...
  **/
  ...
  @Override
  public int hashCode() {
    return Objects.hash(androidAppPackageName, androidDownloadUrl, authorSubmitFrequency, authorTaskName, firstIndustryId, iosAppPackageName, iosDownloadUrl, microAppId, microAppLink, microAppName, microAppPath, productIntroduction, productName, secondIndustryId, starAdCostDivideRatio, starMaterialBid, starMaterialFirstType, starMaterialSecondType, starTaskAnchorId, starTaskAnchorType, starTaskAssetInfo, starTaskBanReasonDetail, starTaskBid, starTaskBudget, starTaskCreateTime, starTaskExternalAction, starTaskId, starTaskMaterialsRequirements, starTaskName, starTaskPostEndTime, starTaskSource, starTaskStartTime, starTaskStatus, starTaskSubStatus, taskAvatarId, taskContactInfo, taskHeadImageId);
  }

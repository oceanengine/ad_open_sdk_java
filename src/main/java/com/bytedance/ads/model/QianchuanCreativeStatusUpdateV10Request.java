...
public class QianchuanCreativeStatusUpdateV10Request {
   ...
   * 
   */
  @JsonAdapter(OptStatusEnum.Adapter.class)
  public enum OptStatusEnum {
    ...
    public static OptStatusEnum fromValue(String value) {
      for (OptStatusEnum b : OptStatusEnum.values()) {
    ...
    public static class Adapter extends TypeAdapter<OptStatusEnum> {
      @Override
      public void write(final JsonWriter jsonWriter, final OptStatusEnum enumeration) throws IOException {
        jsonWriter.value(enumeration.getValue());
      }

      @Override
      public OptStatusEnum read(final JsonReader jsonReader) throws IOException {
        String value =  jsonReader.nextString();
        return OptStatusEnum.fromValue(value);
      }
    }
  }
  ...
  private OptStatusEnum optStatus = null;
  ...
  **/
  ...
  public QianchuanCreativeStatusUpdateV10Request optStatus(OptStatusEnum optStatus) {
  ...
  **/
  @javax.annotation.Nonnull
  public OptStatusEnum getOptStatus() {
    return optStatus;
  }


  public void setOptStatus(OptStatusEnum optStatus) {
    this.optStatus = optStatus;
  }

...
public class ReportStardeliveryTaskDataGetV30ResponseDataListInner {
  ...
  **/
  ...
  @Override
  public int hashCode() {
    return Objects.hash(active, activePay, activeRegister, gamePayCount, installFinishCnt, nonAdStatCost, starActiveCount, starActivePayCount, starActiveRegisterCount, starConvertCnt, starDeepPurchaseCount, starInstallFinishCount, starMaterialStatCost, starSaleMaterialStatCost, starStatCost, starTaskAlbumId, starTaskAlbumName, starTaskAnchorType, starTaskApproachingBudgetLimitIsvCount, starTaskBudget, starTaskBudgetCostRate, starTaskCanDeliveryItemCount, starTaskCategoryName, starTaskCategoryType, starTaskExternalAction, starTaskId, starTaskLockAmount, starTaskName, starTaskPostItemCount, starTaskRelateProjectCount, starTaskSource, starTaskStartTime, starTaskStatus, starTaskUnfrozenAmount, statCost);
  }

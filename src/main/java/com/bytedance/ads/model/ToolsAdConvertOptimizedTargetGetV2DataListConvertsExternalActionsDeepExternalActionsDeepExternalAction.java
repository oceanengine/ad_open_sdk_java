 ...
 * 
 */
@JsonAdapter(ToolsAdConvertOptimizedTargetGetV2DataListConvertsExternalActionsDeepExternalActionsDeepExternalAction.Adapter.class)
public enum ToolsAdConvertOptimizedTargetGetV2DataListConvertsExternalActionsDeepExternalActionsDeepExternalAction {
  ...
  ToolsAdConvertOptimizedTargetGetV2DataListConvertsExternalActionsDeepExternalActionsDeepExternalAction(String value) {
    this.value = value;
  }
  ...
  public static ToolsAdConvertOptimizedTargetGetV2DataListConvertsExternalActionsDeepExternalActionsDeepExternalAction fromValue(String value) {
    for (ToolsAdConvertOptimizedTargetGetV2DataListConvertsExternalActionsDeepExternalActionsDeepExternalAction b : ToolsAdConvertOptimizedTargetGetV2DataListConvertsExternalActionsDeepExternalActionsDeepExternalAction.values()) {
  ...
  public static class Adapter extends TypeAdapter<ToolsAdConvertOptimizedTargetGetV2DataListConvertsExternalActionsDeepExternalActionsDeepExternalAction> {
    @Override
    public void write(final JsonWriter jsonWriter, final ToolsAdConvertOptimizedTargetGetV2DataListConvertsExternalActionsDeepExternalActionsDeepExternalAction enumeration) throws IOException {
      jsonWriter.value(enumeration.getValue());
    }

    @Override
    public ToolsAdConvertOptimizedTargetGetV2DataListConvertsExternalActionsDeepExternalActionsDeepExternalAction read(final JsonReader jsonReader) throws IOException {
      String value = jsonReader.nextString();
      return ToolsAdConvertOptimizedTargetGetV2DataListConvertsExternalActionsDeepExternalActionsDeepExternalAction.fromValue(value);
    }
  }
}

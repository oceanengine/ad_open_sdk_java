 ...
 * 
 */
@JsonAdapter(ToolsAdConvertDeepbidReadV2ExternalAction.Adapter.class)
public enum ToolsAdConvertDeepbidReadV2ExternalAction {
  ...
  ToolsAdConvertDeepbidReadV2ExternalAction(String value) {
    this.value = value;
  }
  ...
  public static ToolsAdConvertDeepbidReadV2ExternalAction fromValue(String value) {
    for (ToolsAdConvertDeepbidReadV2ExternalAction b : ToolsAdConvertDeepbidReadV2ExternalAction.values()) {
  ...
  public static class Adapter extends TypeAdapter<ToolsAdConvertDeepbidReadV2ExternalAction> {
    @Override
    public void write(final JsonWriter jsonWriter, final ToolsAdConvertDeepbidReadV2ExternalAction enumeration) throws IOException {
      jsonWriter.value(enumeration.getValue());
    }

    @Override
    public ToolsAdConvertDeepbidReadV2ExternalAction read(final JsonReader jsonReader) throws IOException {
      String value = jsonReader.nextString();
      return ToolsAdConvertDeepbidReadV2ExternalAction.fromValue(value);
    }
  }
}

 ...
 * 
 */
@JsonAdapter(CreativeProceduralCreativeUpdateV2CreativeImageMaterialsImageMode.Adapter.class)
public enum CreativeProceduralCreativeUpdateV2CreativeImageMaterialsImageMode {
  ...
  CreativeProceduralCreativeUpdateV2CreativeImageMaterialsImageMode(String value) {
    this.value = value;
  }
  ...
  public static CreativeProceduralCreativeUpdateV2CreativeImageMaterialsImageMode fromValue(String value) {
    for (CreativeProceduralCreativeUpdateV2CreativeImageMaterialsImageMode b : CreativeProceduralCreativeUpdateV2CreativeImageMaterialsImageMode.values()) {
  ...
  public static class Adapter extends TypeAdapter<CreativeProceduralCreativeUpdateV2CreativeImageMaterialsImageMode> {
    @Override
    public void write(final JsonWriter jsonWriter, final CreativeProceduralCreativeUpdateV2CreativeImageMaterialsImageMode enumeration) throws IOException {
      jsonWriter.value(enumeration.getValue());
    }

    @Override
    public CreativeProceduralCreativeUpdateV2CreativeImageMaterialsImageMode read(final JsonReader jsonReader) throws IOException {
      String value = jsonReader.nextString();
      return CreativeProceduralCreativeUpdateV2CreativeImageMaterialsImageMode.fromValue(value);
    }
  }
}

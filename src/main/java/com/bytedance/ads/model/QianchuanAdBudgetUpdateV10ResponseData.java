...
public class QianchuanAdBudgetUpdateV10ResponseData {
  ...
  **/
  ...
  public QianchuanAdBudgetUpdateV10ResponseData errors(List<AdUpdateBidV2ResponseDataErrorsInner> errors) {
    
    this.errors = errors;
    return this;
  }

  public QianchuanAdBudgetUpdateV10ResponseData addErrorsItem(AdUpdateBidV2ResponseDataErrorsInner errorsItem) {
    if (this.errors == null) {

...
public class QianchuanAdBudgetUpdateV10ResponseData {
  ...
  **/
  ...
  public QianchuanAdBudgetUpdateV10ResponseData errors(List<AdUpdateStatusV2ResponseDataErrorsInner> errors) {
    
    this.errors = errors;
    return this;
  }

  public QianchuanAdBudgetUpdateV10ResponseData addErrorsItem(AdUpdateStatusV2ResponseDataErrorsInner errorsItem) {
    if (this.errors == null) {

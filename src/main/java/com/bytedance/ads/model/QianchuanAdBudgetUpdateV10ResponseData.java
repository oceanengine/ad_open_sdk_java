...
public class QianchuanAdBudgetUpdateV10ResponseData {
  ...
  **/
  ...
  public QianchuanAdBudgetUpdateV10ResponseData errors(List<QianchuanAdBidUpdateV10ResponseDataErrorsInner> errors) {
    
    this.errors = errors;
    return this;
  }

  public QianchuanAdBudgetUpdateV10ResponseData addErrorsItem(QianchuanAdBidUpdateV10ResponseDataErrorsInner errorsItem) {
    if (this.errors == null) {

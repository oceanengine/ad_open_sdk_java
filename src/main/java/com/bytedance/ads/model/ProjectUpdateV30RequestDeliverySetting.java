...
public class ProjectUpdateV30RequestDeliverySetting {
  ...
  **/
  ...
  @Override
  public int hashCode() {
    return Objects.hash(bid, budget, budgetMode, cpaBid, deepCpabid, endTime, filterNightSwitch, firstRoiGoal, roiGoal, scheduleTime, scheduleType, searchContinueDelivery, sevenRoiGoal, shopMultiRoiGoals);
  }

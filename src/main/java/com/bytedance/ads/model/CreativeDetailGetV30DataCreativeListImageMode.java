 ...
 * 
 */
@JsonAdapter(CreativeDetailGetV30DataCreativeListImageMode.Adapter.class)
public enum CreativeDetailGetV30DataCreativeListImageMode {
  ...
  CreativeDetailGetV30DataCreativeListImageMode(String value) {
    this.value = value;
  }
  ...
  public static CreativeDetailGetV30DataCreativeListImageMode fromValue(String value) {
    for (CreativeDetailGetV30DataCreativeListImageMode b : CreativeDetailGetV30DataCreativeListImageMode.values()) {
  ...
  public static class Adapter extends TypeAdapter<CreativeDetailGetV30DataCreativeListImageMode> {
    @Override
    public void write(final JsonWriter jsonWriter, final CreativeDetailGetV30DataCreativeListImageMode enumeration) throws IOException {
      jsonWriter.value(enumeration.getValue());
    }

    @Override
    public CreativeDetailGetV30DataCreativeListImageMode read(final JsonReader jsonReader) throws IOException {
      String value = jsonReader.nextString();
      return CreativeDetailGetV30DataCreativeListImageMode.fromValue(value);
    }
  }
}

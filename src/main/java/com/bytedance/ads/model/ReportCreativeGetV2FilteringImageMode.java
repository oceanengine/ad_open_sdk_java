 ...
 * 
 */
@JsonAdapter(ReportCreativeGetV2FilteringImageMode.Adapter.class)
public enum ReportCreativeGetV2FilteringImageMode {
  ...
  ReportCreativeGetV2FilteringImageMode(String value) {
    this.value = value;
  }
  ...
  public static ReportCreativeGetV2FilteringImageMode fromValue(String value) {
    for (ReportCreativeGetV2FilteringImageMode b : ReportCreativeGetV2FilteringImageMode.values()) {
  ...
  public static class Adapter extends TypeAdapter<ReportCreativeGetV2FilteringImageMode> {
    @Override
    public void write(final JsonWriter jsonWriter, final ReportCreativeGetV2FilteringImageMode enumeration) throws IOException {
      jsonWriter.value(enumeration.getValue());
    }

    @Override
    public ReportCreativeGetV2FilteringImageMode read(final JsonReader jsonReader) throws IOException {
      String value = jsonReader.nextString();
      return ReportCreativeGetV2FilteringImageMode.fromValue(value);
    }
  }
}

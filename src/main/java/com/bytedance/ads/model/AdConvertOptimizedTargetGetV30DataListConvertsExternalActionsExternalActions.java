 ...
 * 
 */
@JsonAdapter(AdConvertOptimizedTargetGetV30DataListConvertsExternalActionsExternalActions.Adapter.class)
public enum AdConvertOptimizedTargetGetV30DataListConvertsExternalActionsExternalActions {
  ...
  AdConvertOptimizedTargetGetV30DataListConvertsExternalActionsExternalActions(String value) {
    this.value = value;
  }
  ...
  public static AdConvertOptimizedTargetGetV30DataListConvertsExternalActionsExternalActions fromValue(String value) {
    for (AdConvertOptimizedTargetGetV30DataListConvertsExternalActionsExternalActions b : AdConvertOptimizedTargetGetV30DataListConvertsExternalActionsExternalActions.values()) {
  ...
  public static class Adapter extends TypeAdapter<AdConvertOptimizedTargetGetV30DataListConvertsExternalActionsExternalActions> {
    @Override
    public void write(final JsonWriter jsonWriter, final AdConvertOptimizedTargetGetV30DataListConvertsExternalActionsExternalActions enumeration) throws IOException {
      jsonWriter.value(enumeration.getValue());
    }

    @Override
    public AdConvertOptimizedTargetGetV30DataListConvertsExternalActionsExternalActions read(final JsonReader jsonReader) throws IOException {
      String value = jsonReader.nextString();
      return AdConvertOptimizedTargetGetV30DataListConvertsExternalActionsExternalActions.fromValue(value);
    }
  }
}

...
public class AdvertiserFundDailyStatV2ResponseDataListInner {
  ...
  **/
  ...
  @Override
  public int hashCode() {
    return Objects.hash(advertiserId, balance, cashCost, companyWalletCost, cost, date, deductionCost, frozen, grantBalance, income, nonGrantBalance, realtimeCouponCost, rewardCost, sharedWalletCost, transferIn, transferOut);
  }

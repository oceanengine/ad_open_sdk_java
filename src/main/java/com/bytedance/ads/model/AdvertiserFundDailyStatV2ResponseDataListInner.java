...
public class AdvertiserFundDailyStatV2ResponseDataListInner {
  ...
  public static final String SERIALIZED_NAME_COMPENSATION_REWARD_COST = "compensation_reward_cost";
  @SerializedName(SERIALIZED_NAME_COMPENSATION_REWARD_COST)
  private Double compensationRewardCost = null;
  ...
  private Double deductionCost = null;
  ...
  public static final String SERIALIZED_NAME_REALTIME_COUPON_COST = "realtime_coupon_cost";
  @SerializedName(SERIALIZED_NAME_REALTIME_COUPON_COST)
  private Double realtimeCouponCost = null;

  public static final String SERIALIZED_NAME_RETURN_GOODS_REWARD_COST = "return_goods_reward_cost";
  @SerializedName(SERIALIZED_NAME_RETURN_GOODS_REWARD_COST)
  private Double returnGoodsRewardCost = null;
  ...
  **/
  ...
  public AdvertiserFundDailyStatV2ResponseDataListInner compensationRewardCost(Double compensationRewardCost) {
    
    this.compensationRewardCost = compensationRewardCost;
    return this;
  }

   /**
   * 
   * @return compensationRewardCost
  **/
  @javax.annotation.Nullable
  public Double getCompensationRewardCost() {
    return compensationRewardCost;
  }


  public void setCompensationRewardCost(Double compensationRewardCost) {
    this.compensationRewardCost = compensationRewardCost;
  }
  ...
  **/
  ...
  public AdvertiserFundDailyStatV2ResponseDataListInner deductionCost(Double deductionCost) {
  ...
  **/
  ...
  public void setDeductionCost(Double deductionCost) {
    this.deductionCost = deductionCost;
  }
  ...
  **/
  ...
  public AdvertiserFundDailyStatV2ResponseDataListInner realtimeCouponCost(Double realtimeCouponCost) {
    
    this.realtimeCouponCost = realtimeCouponCost;
    return this;
  }

   /**
   * 
   * @return realtimeCouponCost
  **/
  @javax.annotation.Nullable
  public Double getRealtimeCouponCost() {
    return realtimeCouponCost;
  }


  public void setRealtimeCouponCost(Double realtimeCouponCost) {
    this.realtimeCouponCost = realtimeCouponCost;
  }


  public AdvertiserFundDailyStatV2ResponseDataListInner returnGoodsRewardCost(Double returnGoodsRewardCost) {
    
    this.returnGoodsRewardCost = returnGoodsRewardCost;
    return this;
  }

   /**
   * 
   * @return returnGoodsRewardCost
  **/
  @javax.annotation.Nullable
  public Double getReturnGoodsRewardCost() {
    return returnGoodsRewardCost;
  }


  public void setReturnGoodsRewardCost(Double returnGoodsRewardCost) {
    this.returnGoodsRewardCost = returnGoodsRewardCost;
  }
  ...
  **/
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.advertiserId, advertiserFundDailyStatV2ResponseDataListInner.advertiserId) &&
        ...
        Objects.equals(this.compensationRewardCost, advertiserFundDailyStatV2ResponseDataListInner.compensationRewardCost) &&
        ...
        Objects.equals(this.deductionCost, advertiserFundDailyStatV2ResponseDataListInner.deductionCost) &&
        ...
        Objects.equals(this.realtimeCouponCost, advertiserFundDailyStatV2ResponseDataListInner.realtimeCouponCost) &&
        Objects.equals(this.returnGoodsRewardCost, advertiserFundDailyStatV2ResponseDataListInner.returnGoodsRewardCost) &&
  ...
  @Override
  public int hashCode() {
    return Objects.hash(advertiserId, balance, cashCost, companyWalletCost, compensationRewardCost, cost, date, deductionCost, frozen, grantBalance, income, nonGrantBalance, realtimeCouponCost, returnGoodsRewardCost, rewardCost, sharedWalletCost, transferIn, transferOut);
  }
  ...
  public String toString() {
    ...
    sb.append("    compensationRewardCost: ").append(toIndentedString(compensationRewardCost)).append("\n");
    ...
    sb.append("    realtimeCouponCost: ").append(toIndentedString(realtimeCouponCost)).append("\n");
    sb.append("    returnGoodsRewardCost: ").append(toIndentedString(returnGoodsRewardCost)).append("\n");
  ...
  static {
    ...
    openapiFields.add("compensation_reward_cost");
    ...
    openapiFields.add("realtime_coupon_cost");
    openapiFields.add("return_goods_reward_cost");

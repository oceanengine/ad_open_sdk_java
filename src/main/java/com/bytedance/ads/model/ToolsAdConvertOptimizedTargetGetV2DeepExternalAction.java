 ...
 * 
 */
@JsonAdapter(ToolsAdConvertOptimizedTargetGetV2DeepExternalAction.Adapter.class)
public enum ToolsAdConvertOptimizedTargetGetV2DeepExternalAction {
  ...
  ToolsAdConvertOptimizedTargetGetV2DeepExternalAction(String value) {
    this.value = value;
  }
  ...
  public static ToolsAdConvertOptimizedTargetGetV2DeepExternalAction fromValue(String value) {
    for (ToolsAdConvertOptimizedTargetGetV2DeepExternalAction b : ToolsAdConvertOptimizedTargetGetV2DeepExternalAction.values()) {
  ...
  public static class Adapter extends TypeAdapter<ToolsAdConvertOptimizedTargetGetV2DeepExternalAction> {
    @Override
    public void write(final JsonWriter jsonWriter, final ToolsAdConvertOptimizedTargetGetV2DeepExternalAction enumeration) throws IOException {
      jsonWriter.value(enumeration.getValue());
    }

    @Override
    public ToolsAdConvertOptimizedTargetGetV2DeepExternalAction read(final JsonReader jsonReader) throws IOException {
      String value = jsonReader.nextString();
      return ToolsAdConvertOptimizedTargetGetV2DeepExternalAction.fromValue(value);
    }
  }
}

...
public class QianchuanUniPromotionAdDetailV10ResponseDataDeliverySetting {
  ...
  **/
  ...
  @Override
  public int hashCode() {
    return Objects.hash(budget, budgetMode, deepBidType, deepExternalAction, endTime, externalAction, liveScheduleType, pricingType, qcpxMode, roi2Goal, smartBidType, startTime);
  }

...
public class PromotionListV30ResponseDataListInner {
  ...
  **/
  ...
  @Override
  public int hashCode() {
    return Objects.hash(_7dRetention, adDownloadStatus, advertiserId, aigcDynamicCreativeSwitch, autoExtendTraffic, bid, blueFlowPackage, brandInfo, budget, budgetMode, configId, cpaBid, creativeAutoGenerateSwitch, deepCpabid, hasCarryMaterial, isCommentDisable, keywords, learningPhase, materialScoreInfo, materialsType, nativeSetting, optStatus, projectId, promotionCreateTime, promotionId, promotionMaterials, promotionModifyTime, promotionName, roiGoal, scheduleTime, shopMultiRoiGoals, source, starTaskId, status, statusFirst, statusSecond, unionBid, unionBidRatio, unionCpaBid, unionDeepCpabid, unionRoiGoal);
  }

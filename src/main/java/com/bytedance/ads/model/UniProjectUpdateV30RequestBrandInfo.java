...
public class UniProjectUpdateV30RequestBrandInfo {
  ...
  public UniProjectUpdateV30RequestBrandInfo() {
  }

  public UniProjectUpdateV30RequestBrandInfo brandNameId(Long brandNameId) {
  ...
  **/
  ...
  public UniProjectUpdateV30RequestBrandInfo cdpBrandId(Long cdpBrandId) {
  ...
  **/
  ...
  public UniProjectUpdateV30RequestBrandInfo cdpBrandName(String cdpBrandName) {
  ...
  **/
  ...
  public UniProjectUpdateV30RequestBrandInfo ecomBrandId(Long ecomBrandId) {
  ...
  **/
  ...
  public UniProjectUpdateV30RequestBrandInfo subBrandNameIds(List<String> subBrandNameIds) {
    
    this.subBrandNameIds = subBrandNameIds;
    return this;
  }

  public UniProjectUpdateV30RequestBrandInfo addSubBrandNameIdsItem(String subBrandNameIdsItem) {
  ...
  **/
  ...
  public UniProjectUpdateV30RequestBrandInfo subBrandNames(List<String> subBrandNames) {
    
    this.subBrandNames = subBrandNames;
    return this;
  }

  public UniProjectUpdateV30RequestBrandInfo addSubBrandNamesItem(String subBrandNamesItem) {
  ...
  **/
  ...
  public UniProjectUpdateV30RequestBrandInfo yuntuCategoryId(Long yuntuCategoryId) {
  ...
  **/
  ...
  public boolean equals(Object o) {
    ...
    UniProjectUpdateV30RequestBrandInfo uniProjectUpdateV30RequestBrandInfo = (UniProjectUpdateV30RequestBrandInfo) o;
    return Objects.equals(this.brandNameId, uniProjectUpdateV30RequestBrandInfo.brandNameId) &&
        Objects.equals(this.cdpBrandId, uniProjectUpdateV30RequestBrandInfo.cdpBrandId) &&
        Objects.equals(this.cdpBrandName, uniProjectUpdateV30RequestBrandInfo.cdpBrandName) &&
        Objects.equals(this.ecomBrandId, uniProjectUpdateV30RequestBrandInfo.ecomBrandId) &&
        Objects.equals(this.subBrandNameIds, uniProjectUpdateV30RequestBrandInfo.subBrandNameIds) &&
        Objects.equals(this.subBrandNames, uniProjectUpdateV30RequestBrandInfo.subBrandNames) &&
        Objects.equals(this.yuntuCategoryId, uniProjectUpdateV30RequestBrandInfo.yuntuCategoryId);
  }
  ...
  public String toString() {
    ...
    sb.append("class UniProjectUpdateV30RequestBrandInfo {\n");
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!UniProjectUpdateV30RequestBrandInfo.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'UniProjectUpdateV30RequestBrandInfo' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<UniProjectUpdateV30RequestBrandInfo> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(UniProjectUpdateV30RequestBrandInfo.class));

       return (TypeAdapter<T>) new TypeAdapter<UniProjectUpdateV30RequestBrandInfo>() {
           @Override
           public void write(JsonWriter out, UniProjectUpdateV30RequestBrandInfo value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public UniProjectUpdateV30RequestBrandInfo read(JsonReader in) throws IOException {
 ...
 /**
  * Create an instance of UniProjectUpdateV30RequestBrandInfo given an JSON string
  *
  * @param jsonString JSON string
  * @return An instance of UniProjectUpdateV30RequestBrandInfo
  * @throws IOException if the JSON string is invalid with respect to UniProjectUpdateV30RequestBrandInfo
  */
  public static UniProjectUpdateV30RequestBrandInfo fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, UniProjectUpdateV30RequestBrandInfo.class);
  }

 /**
  * Convert an instance of UniProjectUpdateV30RequestBrandInfo to an JSON string
  *
  * @return JSON string
  */

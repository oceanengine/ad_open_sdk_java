...
public class StarDemandOmGetChallengeItemsDataV2ResponseDataDataListInner {
  ...
  **/
  ...
  @Override
  public int hashCode() {
    return Objects.hash(androidActivateCnt, authorId, authorNickname, commentCnt, componentClickCnt, estAdCost, estSales, iosActivateCnt, itemId, itemInfoDailyList, likeCnt, link, play, playVv, promoteCnt, providerId, releaseTime, relevanceAuditResult, rewardAmount, rewardLevel, settleAdShare, settleCps, shareCnt, title, uid, validLikeCnt, validPlayVv);
  }

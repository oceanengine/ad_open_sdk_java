...
public class StarDemandOmCreateChallengeV2RequestChallengeInfo {
  ...
  **/
  ...
  @Override
  public int hashCode() {
    return Objects.hash(accountDivideDay, anchorTitle, authorScope, authorTaskName, commissionInfo, commissionRate, commissionType, demandDesc, microAppId, omTaskTag, participateAuthorRange, sampleVideo, startPage, taskHeadImage, taskIcon);
  }

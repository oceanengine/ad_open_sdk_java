 ...
 * 
 */
@JsonAdapter(ToolsOrangeSiteGetV30DataOptimizeGoalDeepExternalAction.Adapter.class)
public enum ToolsOrangeSiteGetV30DataOptimizeGoalDeepExternalAction {
  ...
  ToolsOrangeSiteGetV30DataOptimizeGoalDeepExternalAction(String value) {
    this.value = value;
  }
  ...
  public static ToolsOrangeSiteGetV30DataOptimizeGoalDeepExternalAction fromValue(String value) {
    for (ToolsOrangeSiteGetV30DataOptimizeGoalDeepExternalAction b : ToolsOrangeSiteGetV30DataOptimizeGoalDeepExternalAction.values()) {
  ...
  public static class Adapter extends TypeAdapter<ToolsOrangeSiteGetV30DataOptimizeGoalDeepExternalAction> {
    @Override
    public void write(final JsonWriter jsonWriter, final ToolsOrangeSiteGetV30DataOptimizeGoalDeepExternalAction enumeration) throws IOException {
      jsonWriter.value(enumeration.getValue());
    }

    @Override
    public ToolsOrangeSiteGetV30DataOptimizeGoalDeepExternalAction read(final JsonReader jsonReader) throws IOException {
      String value = jsonReader.nextString();
      return ToolsOrangeSiteGetV30DataOptimizeGoalDeepExternalAction.fromValue(value);
    }
  }
}

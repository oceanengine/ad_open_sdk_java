...
public class AgentAdvCostReportListQueryV2RequestFiltering {
  ...
  **/
  ...
  @Override
  public int hashCode() {
    return Objects.hash(advertiserIds, agentCustomerId, agentCustomerIds, appName, companyName, costSource, ecommerceType, firstIndustry, pricingCategory, projectName, projectSerial, promotionType, secondAdAgentId, secondIndustry, secondIndustryList, spuLabelName);
  }

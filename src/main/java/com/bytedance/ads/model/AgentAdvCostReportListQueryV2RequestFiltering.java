...
public class AgentAdvCostReportListQueryV2RequestFiltering {
  ...
  public static final String SERIALIZED_NAME_AGENT_CUSTOMER_IDS = "agent_customer_ids";
  @SerializedName(SERIALIZED_NAME_AGENT_CUSTOMER_IDS)
  private List<Long> agentCustomerIds = null;
  ...
  public static final String SERIALIZED_NAME_SECOND_INDUSTRY_LIST = "second_industry_list";
  @SerializedName(SERIALIZED_NAME_SECOND_INDUSTRY_LIST)
  private List<String> secondIndustryList = null;
  ...
  **/
  ...
  public AgentAdvCostReportListQueryV2RequestFiltering agentCustomerIds(List<Long> agentCustomerIds) {
    
    this.agentCustomerIds = agentCustomerIds;
    return this;
  }

  public AgentAdvCostReportListQueryV2RequestFiltering addAgentCustomerIdsItem(Long agentCustomerIdsItem) {
    if (this.agentCustomerIds == null) {
      this.agentCustomerIds = new ArrayList<>();
    }
    this.agentCustomerIds.add(agentCustomerIdsItem);
    return this;
  }

   /**
   * 代理商客户id列表，支持多选查询
   * @return agentCustomerIds
  **/
  @javax.annotation.Nullable
  public List<Long> getAgentCustomerIds() {
    return agentCustomerIds;
  }


  public void setAgentCustomerIds(List<Long> agentCustomerIds) {
    this.agentCustomerIds = agentCustomerIds;
  }
  ...
  **/
  ...
  public AgentAdvCostReportListQueryV2RequestFiltering companyIds(List<Long> companyIds) {
    
    this.companyIds = companyIds;
    return this;
  }

  public AgentAdvCostReportListQueryV2RequestFiltering addCompanyIdsItem(Long companyIdsItem) {
  ...
  **/
  ...
  public AgentAdvCostReportListQueryV2RequestFiltering secondIndustryList(List<String> secondIndustryList) {
    
    this.secondIndustryList = secondIndustryList;
    return this;
  }

  public AgentAdvCostReportListQueryV2RequestFiltering addSecondIndustryListItem(String secondIndustryListItem) {
    if (this.secondIndustryList == null) {
      this.secondIndustryList = new ArrayList<>();
    }
    this.secondIndustryList.add(secondIndustryListItem);
    return this;
  }

   /**
   * 二级行业列表，支持多个行业查询。可从【获取行业列表】接口获取。
   * @return secondIndustryList
  **/
  @javax.annotation.Nullable
  public List<String> getSecondIndustryList() {
    return secondIndustryList;
  }


  public void setSecondIndustryList(List<String> secondIndustryList) {
    this.secondIndustryList = secondIndustryList;
  }
  ...
  **/
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.advertiserIds, agentAdvCostReportListQueryV2RequestFiltering.advertiserIds) &&
        ...
        Objects.equals(this.agentCustomerIds, agentAdvCostReportListQueryV2RequestFiltering.agentCustomerIds) &&
        Objects.equals(this.appName, agentAdvCostReportListQueryV2RequestFiltering.appName) &&
        Objects.equals(this.companyIds, agentAdvCostReportListQueryV2RequestFiltering.companyIds) &&
        ...
        Objects.equals(this.secondIndustryList, agentAdvCostReportListQueryV2RequestFiltering.secondIndustryList) &&
        Objects.equals(this.spuLabelName, agentAdvCostReportListQueryV2RequestFiltering.spuLabelName);
  }

  @Override
  public int hashCode() {
    return Objects.hash(advertiserIds, agentCustomerId, agentCustomerIds, appName, companyIds, companyName, costSource, ecommerceType, firstIndustry, pricingCategory, projectName, projectSerial, promotionType, secondAdAgentId, secondIndustry, secondIndustryList, spuLabelName);
  }
  ...
  public String toString() {
    ...
    sb.append("    agentCustomerIds: ").append(toIndentedString(agentCustomerIds)).append("\n");
    ...
    sb.append("    secondIndustryList: ").append(toIndentedString(secondIndustryList)).append("\n");
  ...
  static {
    ...
    openapiFields.add("agent_customer_ids");
    ...
    openapiFields.add("second_industry_list");

 ...
 * 
 */
@JsonAdapter(PromotionAidGetV30DataPromotionMapDataAdsCreativesVideoMaterialImageMode.Adapter.class)
public enum PromotionAidGetV30DataPromotionMapDataAdsCreativesVideoMaterialImageMode {
  ...
  PromotionAidGetV30DataPromotionMapDataAdsCreativesVideoMaterialImageMode(String value) {
    this.value = value;
  }
  ...
  public static PromotionAidGetV30DataPromotionMapDataAdsCreativesVideoMaterialImageMode fromValue(String value) {
    for (PromotionAidGetV30DataPromotionMapDataAdsCreativesVideoMaterialImageMode b : PromotionAidGetV30DataPromotionMapDataAdsCreativesVideoMaterialImageMode.values()) {
  ...
  public static class Adapter extends TypeAdapter<PromotionAidGetV30DataPromotionMapDataAdsCreativesVideoMaterialImageMode> {
    @Override
    public void write(final JsonWriter jsonWriter, final PromotionAidGetV30DataPromotionMapDataAdsCreativesVideoMaterialImageMode enumeration) throws IOException {
      jsonWriter.value(enumeration.getValue());
    }

    @Override
    public PromotionAidGetV30DataPromotionMapDataAdsCreativesVideoMaterialImageMode read(final JsonReader jsonReader) throws IOException {
      String value = jsonReader.nextString();
      return PromotionAidGetV30DataPromotionMapDataAdsCreativesVideoMaterialImageMode.fromValue(value);
    }
  }
}

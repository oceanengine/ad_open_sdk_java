 ...
 * 
 */
@JsonAdapter(PromotionListV30DataListPromotionMaterialsVideoMaterialListMaterialStatus.Adapter.class)
public enum PromotionListV30DataListPromotionMaterialsVideoMaterialListMaterialStatus {
  ...
  PromotionListV30DataListPromotionMaterialsVideoMaterialListMaterialStatus(String value) {
    this.value = value;
  }
  ...
  public static PromotionListV30DataListPromotionMaterialsVideoMaterialListMaterialStatus fromValue(String value) {
    for (PromotionListV30DataListPromotionMaterialsVideoMaterialListMaterialStatus b : PromotionListV30DataListPromotionMaterialsVideoMaterialListMaterialStatus.values()) {
  ...
  public static class Adapter extends TypeAdapter<PromotionListV30DataListPromotionMaterialsVideoMaterialListMaterialStatus> {
    @Override
    public void write(final JsonWriter jsonWriter, final PromotionListV30DataListPromotionMaterialsVideoMaterialListMaterialStatus enumeration) throws IOException {
      jsonWriter.value(enumeration.getValue());
    }

    @Override
    public PromotionListV30DataListPromotionMaterialsVideoMaterialListMaterialStatus read(final JsonReader jsonReader) throws IOException {
      String value = jsonReader.nextString();
      return PromotionListV30DataListPromotionMaterialsVideoMaterialListMaterialStatus.fromValue(value);
    }
  }
}

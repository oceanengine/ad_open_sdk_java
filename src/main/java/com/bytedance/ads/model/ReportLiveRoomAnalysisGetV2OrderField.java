 ...
 * 
 */
@JsonAdapter(ReportLiveRoomAnalysisGetV2OrderField.Adapter.class)
public enum ReportLiveRoomAnalysisGetV2OrderField {
  ...
  ReportLiveRoomAnalysisGetV2OrderField(String value) {
    this.value = value;
  }
  ...
  public static ReportLiveRoomAnalysisGetV2OrderField fromValue(String value) {
    for (ReportLiveRoomAnalysisGetV2OrderField b : ReportLiveRoomAnalysisGetV2OrderField.values()) {
  ...
  public static class Adapter extends TypeAdapter<ReportLiveRoomAnalysisGetV2OrderField> {
    @Override
    public void write(final JsonWriter jsonWriter, final ReportLiveRoomAnalysisGetV2OrderField enumeration) throws IOException {
      jsonWriter.value(enumeration.getValue());
    }

    @Override
    public ReportLiveRoomAnalysisGetV2OrderField read(final JsonReader jsonReader) throws IOException {
      String value = jsonReader.nextString();
      return ReportLiveRoomAnalysisGetV2OrderField.fromValue(value);
    }
  }
}

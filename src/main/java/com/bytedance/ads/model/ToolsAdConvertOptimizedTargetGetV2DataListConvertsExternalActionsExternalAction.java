 ...
 * 
 */
@JsonAdapter(ToolsAdConvertOptimizedTargetGetV2DataListConvertsExternalActionsExternalAction.Adapter.class)
public enum ToolsAdConvertOptimizedTargetGetV2DataListConvertsExternalActionsExternalAction {
  ...
  ToolsAdConvertOptimizedTargetGetV2DataListConvertsExternalActionsExternalAction(String value) {
    this.value = value;
  }
  ...
  public static ToolsAdConvertOptimizedTargetGetV2DataListConvertsExternalActionsExternalAction fromValue(String value) {
    for (ToolsAdConvertOptimizedTargetGetV2DataListConvertsExternalActionsExternalAction b : ToolsAdConvertOptimizedTargetGetV2DataListConvertsExternalActionsExternalAction.values()) {
  ...
  public static class Adapter extends TypeAdapter<ToolsAdConvertOptimizedTargetGetV2DataListConvertsExternalActionsExternalAction> {
    @Override
    public void write(final JsonWriter jsonWriter, final ToolsAdConvertOptimizedTargetGetV2DataListConvertsExternalActionsExternalAction enumeration) throws IOException {
      jsonWriter.value(enumeration.getValue());
    }

    @Override
    public ToolsAdConvertOptimizedTargetGetV2DataListConvertsExternalActionsExternalAction read(final JsonReader jsonReader) throws IOException {
      String value = jsonReader.nextString();
      return ToolsAdConvertOptimizedTargetGetV2DataListConvertsExternalActionsExternalAction.fromValue(value);
    }
  }
}

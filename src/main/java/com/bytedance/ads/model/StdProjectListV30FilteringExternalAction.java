 ...
 * 优化目标
 */
@JsonAdapter(StdProjectListV30FilteringExternalAction.Adapter.class)
public enum StdProjectListV30FilteringExternalAction {
  ...
  StdProjectListV30FilteringExternalAction(String value) {
    this.value = value;
  }
  ...
  public static StdProjectListV30FilteringExternalAction fromValue(String value) {
    for (StdProjectListV30FilteringExternalAction b : StdProjectListV30FilteringExternalAction.values()) {
  ...
  public static class Adapter extends TypeAdapter<StdProjectListV30FilteringExternalAction> {
    @Override
    public void write(final JsonWriter jsonWriter, final StdProjectListV30FilteringExternalAction enumeration) throws IOException {
      jsonWriter.value(enumeration.getValue());
    }

    @Override
    public StdProjectListV30FilteringExternalAction read(final JsonReader jsonReader) throws IOException {
      String value = jsonReader.nextString();
      return StdProjectListV30FilteringExternalAction.fromValue(value);
    }
  }
}

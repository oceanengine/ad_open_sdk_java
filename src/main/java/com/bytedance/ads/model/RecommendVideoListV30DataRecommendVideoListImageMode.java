 ...
 * 
 */
@JsonAdapter(RecommendVideoListV30DataRecommendVideoListImageMode.Adapter.class)
public enum RecommendVideoListV30DataRecommendVideoListImageMode {
  ...
  RecommendVideoListV30DataRecommendVideoListImageMode(String value) {
    this.value = value;
  }
  ...
  public static RecommendVideoListV30DataRecommendVideoListImageMode fromValue(String value) {
    for (RecommendVideoListV30DataRecommendVideoListImageMode b : RecommendVideoListV30DataRecommendVideoListImageMode.values()) {
  ...
  public static class Adapter extends TypeAdapter<RecommendVideoListV30DataRecommendVideoListImageMode> {
    @Override
    public void write(final JsonWriter jsonWriter, final RecommendVideoListV30DataRecommendVideoListImageMode enumeration) throws IOException {
      jsonWriter.value(enumeration.getValue());
    }

    @Override
    public RecommendVideoListV30DataRecommendVideoListImageMode read(final JsonReader jsonReader) throws IOException {
      String value = jsonReader.nextString();
      return RecommendVideoListV30DataRecommendVideoListImageMode.fromValue(value);
    }
  }
}

 ...
 * 
 */
@JsonAdapter(ToolsAdConvertQueryV2DataListExternalActionsDeepExternalActionsDeepExternalAction.Adapter.class)
public enum ToolsAdConvertQueryV2DataListExternalActionsDeepExternalActionsDeepExternalAction {
  ...
  ToolsAdConvertQueryV2DataListExternalActionsDeepExternalActionsDeepExternalAction(String value) {
    this.value = value;
  }
  ...
  public static ToolsAdConvertQueryV2DataListExternalActionsDeepExternalActionsDeepExternalAction fromValue(String value) {
    for (ToolsAdConvertQueryV2DataListExternalActionsDeepExternalActionsDeepExternalAction b : ToolsAdConvertQueryV2DataListExternalActionsDeepExternalActionsDeepExternalAction.values()) {
  ...
  public static class Adapter extends TypeAdapter<ToolsAdConvertQueryV2DataListExternalActionsDeepExternalActionsDeepExternalAction> {
    @Override
    public void write(final JsonWriter jsonWriter, final ToolsAdConvertQueryV2DataListExternalActionsDeepExternalActionsDeepExternalAction enumeration) throws IOException {
      jsonWriter.value(enumeration.getValue());
    }

    @Override
    public ToolsAdConvertQueryV2DataListExternalActionsDeepExternalActionsDeepExternalAction read(final JsonReader jsonReader) throws IOException {
      String value = jsonReader.nextString();
      return ToolsAdConvertQueryV2DataListExternalActionsDeepExternalActionsDeepExternalAction.fromValue(value);
    }
  }
}

 ...
 * 
 */
@JsonAdapter(FileMediaGetV2FilteringExternalAction.Adapter.class)
public enum FileMediaGetV2FilteringExternalAction {
  ...
  FileMediaGetV2FilteringExternalAction(String value) {
    this.value = value;
  }
  ...
  public static FileMediaGetV2FilteringExternalAction fromValue(String value) {
    for (FileMediaGetV2FilteringExternalAction b : FileMediaGetV2FilteringExternalAction.values()) {
  ...
  public static class Adapter extends TypeAdapter<FileMediaGetV2FilteringExternalAction> {
    @Override
    public void write(final JsonWriter jsonWriter, final FileMediaGetV2FilteringExternalAction enumeration) throws IOException {
      jsonWriter.value(enumeration.getValue());
    }

    @Override
    public FileMediaGetV2FilteringExternalAction read(final JsonReader jsonReader) throws IOException {
      String value = jsonReader.nextString();
      return FileMediaGetV2FilteringExternalAction.fromValue(value);
    }
  }
}

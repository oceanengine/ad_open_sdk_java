 ...
 * 
 */
@JsonAdapter(StdProjectListV30DataListDeepBidType.Adapter.class)
public enum StdProjectListV30DataListDeepBidType {
  ...
  StdProjectListV30DataListDeepBidType(String value) {
    this.value = value;
  }
  ...
  public static StdProjectListV30DataListDeepBidType fromValue(String value) {
    for (StdProjectListV30DataListDeepBidType b : StdProjectListV30DataListDeepBidType.values()) {
  ...
  public static class Adapter extends TypeAdapter<StdProjectListV30DataListDeepBidType> {
    @Override
    public void write(final JsonWriter jsonWriter, final StdProjectListV30DataListDeepBidType enumeration) throws IOException {
      jsonWriter.value(enumeration.getValue());
    }

    @Override
    public StdProjectListV30DataListDeepBidType read(final JsonReader jsonReader) throws IOException {
      String value = jsonReader.nextString();
      return StdProjectListV30DataListDeepBidType.fromValue(value);
    }
  }
}

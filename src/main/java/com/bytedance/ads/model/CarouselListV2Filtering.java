...
import com.bytedance.ads.model.CarouselListV2FilteringSource;
...
public class CarouselListV2Filtering {
  ...
  private List<CarouselListV2FilteringSource> source = null;
  ...
  **/
  ...
  public CarouselListV2Filtering source(List<CarouselListV2FilteringSource> source) {
    
    this.source = source;
    return this;
  }

  public CarouselListV2Filtering addSourceItem(CarouselListV2FilteringSource sourceItem) {
    if (this.source == null) {
  ...
  **/
  @javax.annotation.Nullable
  public List<CarouselListV2FilteringSource> getSource() {
    return source;
  }


  public void setSource(List<CarouselListV2FilteringSource> source) {
    this.source = source;
  }
  ...
  **/
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.audioId, carouselListV2Filtering.audioId) &&
        ...
        Objects.equals(this.source, carouselListV2Filtering.source) &&
        Objects.equals(this.startTime, carouselListV2Filtering.startTime);
  }

  @Override
  public int hashCode() {
    return Objects.hash(audioId, carouselIds, endTime, fileName, imageIds, source, startTime);
  }

 ...
 * 
 */
@JsonAdapter(PromotionListV30DataListPromotionMaterialsInstantPlayMaterialListMaterialStatus.Adapter.class)
public enum PromotionListV30DataListPromotionMaterialsInstantPlayMaterialListMaterialStatus {
  ...
  PromotionListV30DataListPromotionMaterialsInstantPlayMaterialListMaterialStatus(String value) {
    this.value = value;
  }
  ...
  public static PromotionListV30DataListPromotionMaterialsInstantPlayMaterialListMaterialStatus fromValue(String value) {
    for (PromotionListV30DataListPromotionMaterialsInstantPlayMaterialListMaterialStatus b : PromotionListV30DataListPromotionMaterialsInstantPlayMaterialListMaterialStatus.values()) {
  ...
  public static class Adapter extends TypeAdapter<PromotionListV30DataListPromotionMaterialsInstantPlayMaterialListMaterialStatus> {
    @Override
    public void write(final JsonWriter jsonWriter, final PromotionListV30DataListPromotionMaterialsInstantPlayMaterialListMaterialStatus enumeration) throws IOException {
      jsonWriter.value(enumeration.getValue());
    }

    @Override
    public PromotionListV30DataListPromotionMaterialsInstantPlayMaterialListMaterialStatus read(final JsonReader jsonReader) throws IOException {
      String value = jsonReader.nextString();
      return PromotionListV30DataListPromotionMaterialsInstantPlayMaterialListMaterialStatus.fromValue(value);
    }
  }
}

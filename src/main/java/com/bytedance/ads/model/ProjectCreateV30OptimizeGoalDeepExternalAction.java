 ...
 * 
 */
@JsonAdapter(ProjectCreateV30OptimizeGoalDeepExternalAction.Adapter.class)
public enum ProjectCreateV30OptimizeGoalDeepExternalAction {
  ...
  ProjectCreateV30OptimizeGoalDeepExternalAction(String value) {
    this.value = value;
  }
  ...
  public static ProjectCreateV30OptimizeGoalDeepExternalAction fromValue(String value) {
    for (ProjectCreateV30OptimizeGoalDeepExternalAction b : ProjectCreateV30OptimizeGoalDeepExternalAction.values()) {
  ...
  public static class Adapter extends TypeAdapter<ProjectCreateV30OptimizeGoalDeepExternalAction> {
    @Override
    public void write(final JsonWriter jsonWriter, final ProjectCreateV30OptimizeGoalDeepExternalAction enumeration) throws IOException {
      jsonWriter.value(enumeration.getValue());
    }

    @Override
    public ProjectCreateV30OptimizeGoalDeepExternalAction read(final JsonReader jsonReader) throws IOException {
      String value = jsonReader.nextString();
      return ProjectCreateV30OptimizeGoalDeepExternalAction.fromValue(value);
    }
  }
}

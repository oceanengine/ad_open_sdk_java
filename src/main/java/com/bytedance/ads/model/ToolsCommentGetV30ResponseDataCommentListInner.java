...
public class ToolsCommentGetV30ResponseDataCommentListInner {
  ...
  **/
  ...
  @Override
  public int hashCode() {
    return Objects.hash(awemeId, awemeName, commentId, commentImages, commentPermission, commentType, createTime, emotionType, hideStatus, isStick, itemId, itemTitle, levelType, likeCount, materialId, promotionId, replyCount, text);
  }

...
public class StarChallengeItemsDataV2ResponseDataDataListInner {
  ...
  **/
  ...
  @Override
  public int hashCode() {
    return Objects.hash(androidActivateCnt, authorAmount, authorNickname, commentCnt, componentClickCnt, iosActivateCnt, itemId, likeCnt, link, mid, payAmountEstimated, playVv, playletId, playletName, promoteCnt, releaseTime, relevanceAuditResult, rewardAmount, rewardLevel, shareCnt, title, uid, validLikeCnt, validPlayVv);
  }

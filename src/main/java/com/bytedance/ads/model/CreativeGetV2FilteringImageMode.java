...
/**
 * 按照创意素材类型过滤，[【附录-素材类型】](https://ad.oceanengine.com/openapi/doc/index.html?id&#x3D;1696710760171535#custom-anchor-素材类型)
 */
@JsonAdapter(CreativeGetV2FilteringImageMode.Adapter.class)
public enum CreativeGetV2FilteringImageMode {
  ...
  CreativeGetV2FilteringImageMode(String value) {
    this.value = value;
  }
  ...
  public static CreativeGetV2FilteringImageMode fromValue(String value) {
    for (CreativeGetV2FilteringImageMode b : CreativeGetV2FilteringImageMode.values()) {
  ...
  public static class Adapter extends TypeAdapter<CreativeGetV2FilteringImageMode> {
    @Override
    public void write(final JsonWriter jsonWriter, final CreativeGetV2FilteringImageMode enumeration) throws IOException {
      jsonWriter.value(enumeration.getValue());
    }

    @Override
    public CreativeGetV2FilteringImageMode read(final JsonReader jsonReader) throws IOException {
      String value = jsonReader.nextString();
      return CreativeGetV2FilteringImageMode.fromValue(value);
    }
  }
}

 ...
 * 
 */
@JsonAdapter(CreativeDetailGetV30DataCreativeDecorationMaterialImageMode.Adapter.class)
public enum CreativeDetailGetV30DataCreativeDecorationMaterialImageMode {
  ...
  CreativeDetailGetV30DataCreativeDecorationMaterialImageMode(String value) {
    this.value = value;
  }
  ...
  public static CreativeDetailGetV30DataCreativeDecorationMaterialImageMode fromValue(String value) {
    for (CreativeDetailGetV30DataCreativeDecorationMaterialImageMode b : CreativeDetailGetV30DataCreativeDecorationMaterialImageMode.values()) {
  ...
  public static class Adapter extends TypeAdapter<CreativeDetailGetV30DataCreativeDecorationMaterialImageMode> {
    @Override
    public void write(final JsonWriter jsonWriter, final CreativeDetailGetV30DataCreativeDecorationMaterialImageMode enumeration) throws IOException {
      jsonWriter.value(enumeration.getValue());
    }

    @Override
    public CreativeDetailGetV30DataCreativeDecorationMaterialImageMode read(final JsonReader jsonReader) throws IOException {
      String value = jsonReader.nextString();
      return CreativeDetailGetV30DataCreativeDecorationMaterialImageMode.fromValue(value);
    }
  }
}

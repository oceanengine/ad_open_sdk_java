 ...
 * 
 */
@JsonAdapter(CreativeProceduralCreativeCreateV2CreativeImageMaterialsImageMode.Adapter.class)
public enum CreativeProceduralCreativeCreateV2CreativeImageMaterialsImageMode {
  ...
  CreativeProceduralCreativeCreateV2CreativeImageMaterialsImageMode(String value) {
    this.value = value;
  }
  ...
  public static CreativeProceduralCreativeCreateV2CreativeImageMaterialsImageMode fromValue(String value) {
    for (CreativeProceduralCreativeCreateV2CreativeImageMaterialsImageMode b : CreativeProceduralCreativeCreateV2CreativeImageMaterialsImageMode.values()) {
  ...
  public static class Adapter extends TypeAdapter<CreativeProceduralCreativeCreateV2CreativeImageMaterialsImageMode> {
    @Override
    public void write(final JsonWriter jsonWriter, final CreativeProceduralCreativeCreateV2CreativeImageMaterialsImageMode enumeration) throws IOException {
      jsonWriter.value(enumeration.getValue());
    }

    @Override
    public CreativeProceduralCreativeCreateV2CreativeImageMaterialsImageMode read(final JsonReader jsonReader) throws IOException {
      String value = jsonReader.nextString();
      return CreativeProceduralCreativeCreateV2CreativeImageMaterialsImageMode.fromValue(value);
    }
  }
}

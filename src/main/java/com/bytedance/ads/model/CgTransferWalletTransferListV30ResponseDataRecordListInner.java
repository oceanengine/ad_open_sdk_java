...
public class CgTransferWalletTransferListV30ResponseDataRecordListInner {
  ...
  **/
  ...
  @Override
  public int hashCode() {
    return Objects.hash(bizRequestNo, payeeId, remark, remitterId, transferCapitalRecordList, transferOrderSerial, transferTargetAmount, transferTargetCreateTime, transferTargetFinishTime, transferTargetStatus);
  }

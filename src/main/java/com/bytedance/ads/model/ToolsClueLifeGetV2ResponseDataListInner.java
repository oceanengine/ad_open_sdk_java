...
public class ToolsClueLifeGetV2ResponseDataListInner {
  ...
  **/
  ...
  @Override
  public int hashCode() {
    return Objects.hash(actionType, address, advertiserName, age, allocationStatus, authorAwemeId, authorNickname, authorRole, autoCityName, autoProvinceName, carouselId, cityName, clueId, clueOwnerName, clueReturnStatus, clueType, contentId, countyName, createTimeDetail, effectiveState, effectiveStateName, flowEntrance, flowType, followLifeAccountId, followLifeAccountName, followLifeAccountType, followPoiId, followStateName, gender, intentionLifeAccountName, intentionPoiId, isPrivateClue, leadsPage, localAccountId, modifyTime, name, orderId, orderStatus, promotionId, promotionName, provinceName, remark, remarkDict, reqId, sourceCraftsmanDouyinId, sourceCraftsmanNickname, staffAwemeId, staffCommerceNickname, staffNickname, systemTags, tags, telephone, titleId, toolId, videoId, weixin);
  }

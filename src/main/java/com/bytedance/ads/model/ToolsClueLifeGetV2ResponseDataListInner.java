...
public class ToolsClueLifeGetV2ResponseDataListInner {
  ...
  **/
  ...
  @Override
  public int hashCode() {
    return Objects.hash(actionType, address, advertiserName, age, allocationStatus, authorAwemeId, authorNickname, authorRole, cityName, clueId, clueOwnerName, clueType, contentId, countyName, createTimeDetail, effectiveState, effectiveStateName, flowType, followLifeAccountId, followLifeAccountName, followLifeAccountType, followPoiId, followStateName, gender, intentionLifeAccountName, intentionPoiId, leadsPage, localAccountId, modifyTime, name, orderId, promotionId, promotionName, provinceName, remark, remarkDict, reqId, staffAwemeId, staffNickname, systemTags, tags, telephone, toolId);
  }

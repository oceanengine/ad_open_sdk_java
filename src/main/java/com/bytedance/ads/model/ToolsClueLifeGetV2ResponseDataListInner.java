...
import com.bytedance.ads.model.ToolsClueLifeGetV2DataListQcpxTicketStatus;
...
public class ToolsClueLifeGetV2ResponseDataListInner {
  ...
  public static final String SERIALIZED_NAME_COMPONENT_EVENT_TYPE_TAGS = "component_event_type_tags";
  @SerializedName(SERIALIZED_NAME_COMPONENT_EVENT_TYPE_TAGS)
  private List<Long> componentEventTypeTags = null;
  ...
  public static final String SERIALIZED_NAME_QCPX_TICKET_INFO = "qcpx_ticket_info";
  @SerializedName(SERIALIZED_NAME_QCPX_TICKET_INFO)
  private String qcpxTicketInfo = null;

  public static final String SERIALIZED_NAME_QCPX_TICKET_STATUS = "qcpx_ticket_status";
  @SerializedName(SERIALIZED_NAME_QCPX_TICKET_STATUS)
  private ToolsClueLifeGetV2DataListQcpxTicketStatus qcpxTicketStatus = null;
  ...
  **/
  ...
  public ToolsClueLifeGetV2ResponseDataListInner componentEventTypeTags(List<Long> componentEventTypeTags) {
    
    this.componentEventTypeTags = componentEventTypeTags;
    return this;
  }

  public ToolsClueLifeGetV2ResponseDataListInner addComponentEventTypeTagsItem(Long componentEventTypeTagsItem) {
    if (this.componentEventTypeTags == null) {
      this.componentEventTypeTags = new ArrayList<>();
    }
    this.componentEventTypeTags.add(componentEventTypeTagsItem);
    return this;
  }

   /**
   * 营销类型
   * @return componentEventTypeTags
  **/
  @javax.annotation.Nullable
  public List<Long> getComponentEventTypeTags() {
    return componentEventTypeTags;
  }


  public void setComponentEventTypeTags(List<Long> componentEventTypeTags) {
    this.componentEventTypeTags = componentEventTypeTags;
  }
  ...
  **/
  ...
  public ToolsClueLifeGetV2ResponseDataListInner extInfo(String extInfo) {
  ...
  **/
  ...
  public ToolsClueLifeGetV2ResponseDataListInner qcpxTicketInfo(String qcpxTicketInfo) {
    
    this.qcpxTicketInfo = qcpxTicketInfo;
    return this;
  }

   /**
   * 买单补贴券信息
   * @return qcpxTicketInfo
  **/
  @javax.annotation.Nullable
  public String getQcpxTicketInfo() {
    return qcpxTicketInfo;
  }


  public void setQcpxTicketInfo(String qcpxTicketInfo) {
    this.qcpxTicketInfo = qcpxTicketInfo;
  }


  public ToolsClueLifeGetV2ResponseDataListInner qcpxTicketStatus(ToolsClueLifeGetV2DataListQcpxTicketStatus qcpxTicketStatus) {
    
    this.qcpxTicketStatus = qcpxTicketStatus;
    return this;
  }

   /**
   * Get qcpxTicketStatus
   * @return qcpxTicketStatus
  **/
  @javax.annotation.Nullable
  public ToolsClueLifeGetV2DataListQcpxTicketStatus getQcpxTicketStatus() {
    return qcpxTicketStatus;
  }


  public void setQcpxTicketStatus(ToolsClueLifeGetV2DataListQcpxTicketStatus qcpxTicketStatus) {
    this.qcpxTicketStatus = qcpxTicketStatus;
  }
  ...
  **/
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.actionType, toolsClueLifeGetV2ResponseDataListInner.actionType) &&
        ...
        Objects.equals(this.componentEventTypeTags, toolsClueLifeGetV2ResponseDataListInner.componentEventTypeTags) &&
        ...
        Objects.equals(this.extInfo, toolsClueLifeGetV2ResponseDataListInner.extInfo) &&
        ...
        Objects.equals(this.qcpxTicketInfo, toolsClueLifeGetV2ResponseDataListInner.qcpxTicketInfo) &&
        Objects.equals(this.qcpxTicketStatus, toolsClueLifeGetV2ResponseDataListInner.qcpxTicketStatus) &&
  ...
  @Override
  public int hashCode() {
    return Objects.hash(actionType, adType, address, advertiserName, age, allocationStatus, authorAwemeId, authorNickname, authorRole, autoCityName, autoProvinceName, carouselId, cityName, clueId, clueIntention, clueOwnerName, clueReturnStatus, clueType, componentEventTypeTags, contentId, convertStatus, countryName, countyName, createTimeDetail, effectiveState, effectiveStateName, extInfo, flowEntrance, flowType, followLifeAccountId, followLifeAccountName, followLifeAccountType, followPoiId, followStateName, gender, intentionLifeAccountName, intentionPoiId, isPrivateClue, leadsPage, localAccountId, modifyTime, name, orderId, orderStatus, productId, productName, productType, promotionId, promotionName, provinceName, qcpxTicketInfo, qcpxTicketStatus, remark, remarkDict, reqId, searchBidWord, sourceCraftsmanDouyinId, sourceCraftsmanNickname, staffAwemeId, staffCommerceNickname, staffNickname, systemTags, tags, telephone, titleId, toolId, videoId, weixin);
  }
  ...
  public String toString() {
    ...
    sb.append("    componentEventTypeTags: ").append(toIndentedString(componentEventTypeTags)).append("\n");
    ...
    sb.append("    qcpxTicketInfo: ").append(toIndentedString(qcpxTicketInfo)).append("\n");
    sb.append("    qcpxTicketStatus: ").append(toIndentedString(qcpxTicketStatus)).append("\n");
  ...
  static {
    ...
    openapiFields.add("component_event_type_tags");
    ...
    openapiFields.add("qcpx_ticket_info");
    openapiFields.add("qcpx_ticket_status");

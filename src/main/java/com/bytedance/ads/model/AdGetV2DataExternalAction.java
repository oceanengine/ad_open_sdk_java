 ...
 * 
 */
@JsonAdapter(AdGetV2DataExternalAction.Adapter.class)
public enum AdGetV2DataExternalAction {
  ...
  AdGetV2DataExternalAction(String value) {
    this.value = value;
  }
  ...
  public static AdGetV2DataExternalAction fromValue(String value) {
    for (AdGetV2DataExternalAction b : AdGetV2DataExternalAction.values()) {
  ...
  public static class Adapter extends TypeAdapter<AdGetV2DataExternalAction> {
    @Override
    public void write(final JsonWriter jsonWriter, final AdGetV2DataExternalAction enumeration) throws IOException {
      jsonWriter.value(enumeration.getValue());
    }

    @Override
    public AdGetV2DataExternalAction read(final JsonReader jsonReader) throws IOException {
      String value = jsonReader.nextString();
      return AdGetV2DataExternalAction.fromValue(value);
    }
  }
}

 ...
 * 
 */
@JsonAdapter(CreativeCustomCreativeCreateV2CreativeListImageMode.Adapter.class)
public enum CreativeCustomCreativeCreateV2CreativeListImageMode {
  ...
  CreativeCustomCreativeCreateV2CreativeListImageMode(String value) {
    this.value = value;
  }
  ...
  public static CreativeCustomCreativeCreateV2CreativeListImageMode fromValue(String value) {
    for (CreativeCustomCreativeCreateV2CreativeListImageMode b : CreativeCustomCreativeCreateV2CreativeListImageMode.values()) {
  ...
  public static class Adapter extends TypeAdapter<CreativeCustomCreativeCreateV2CreativeListImageMode> {
    @Override
    public void write(final JsonWriter jsonWriter, final CreativeCustomCreativeCreateV2CreativeListImageMode enumeration) throws IOException {
      jsonWriter.value(enumeration.getValue());
    }

    @Override
    public CreativeCustomCreativeCreateV2CreativeListImageMode read(final JsonReader jsonReader) throws IOException {
      String value = jsonReader.nextString();
      return CreativeCustomCreativeCreateV2CreativeListImageMode.fromValue(value);
    }
  }
}

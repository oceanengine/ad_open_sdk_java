...
public class LocalProjectListV30ResponseDataProjectListInner {
  ...
  **/
  ...
  @Override
  public int hashCode() {
    return Objects.hash(adType, bidType, deepExternalAction, deliveryGoal, deliveryPackage, endTime, externalAction, localAccountId, localDeliveryScene, marketingGoal, name, poiInfo, productInfo, projectBid, projectBudget, projectBudgetMode, projectCreateTime, projectId, projectModifyTime, projectStatusFirst, projectStatusSecond, startTime);
  }

 ...
 * 
 */
@JsonAdapter(ToolsIsSupportUniversalGetV2DeepExternalAction.Adapter.class)
public enum ToolsIsSupportUniversalGetV2DeepExternalAction {
  ...
  ToolsIsSupportUniversalGetV2DeepExternalAction(String value) {
    this.value = value;
  }
  ...
  public static ToolsIsSupportUniversalGetV2DeepExternalAction fromValue(String value) {
    for (ToolsIsSupportUniversalGetV2DeepExternalAction b : ToolsIsSupportUniversalGetV2DeepExternalAction.values()) {
  ...
  public static class Adapter extends TypeAdapter<ToolsIsSupportUniversalGetV2DeepExternalAction> {
    @Override
    public void write(final JsonWriter jsonWriter, final ToolsIsSupportUniversalGetV2DeepExternalAction enumeration) throws IOException {
      jsonWriter.value(enumeration.getValue());
    }

    @Override
    public ToolsIsSupportUniversalGetV2DeepExternalAction read(final JsonReader jsonReader) throws IOException {
      String value = jsonReader.nextString();
      return ToolsIsSupportUniversalGetV2DeepExternalAction.fromValue(value);
    }
  }
}

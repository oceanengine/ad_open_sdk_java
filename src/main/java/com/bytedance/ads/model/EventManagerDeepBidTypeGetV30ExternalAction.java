 ...
 * 
 */
@JsonAdapter(EventManagerDeepBidTypeGetV30ExternalAction.Adapter.class)
public enum EventManagerDeepBidTypeGetV30ExternalAction {
  ...
  EventManagerDeepBidTypeGetV30ExternalAction(String value) {
    this.value = value;
  }
  ...
  public static EventManagerDeepBidTypeGetV30ExternalAction fromValue(String value) {
    for (EventManagerDeepBidTypeGetV30ExternalAction b : EventManagerDeepBidTypeGetV30ExternalAction.values()) {
  ...
  public static class Adapter extends TypeAdapter<EventManagerDeepBidTypeGetV30ExternalAction> {
    @Override
    public void write(final JsonWriter jsonWriter, final EventManagerDeepBidTypeGetV30ExternalAction enumeration) throws IOException {
      jsonWriter.value(enumeration.getValue());
    }

    @Override
    public EventManagerDeepBidTypeGetV30ExternalAction read(final JsonReader jsonReader) throws IOException {
      String value = jsonReader.nextString();
      return EventManagerDeepBidTypeGetV30ExternalAction.fromValue(value);
    }
  }
}

 ...
 * 
 */
@JsonAdapter(PromotionListV30DataListPromotionMaterialsTrialPlayMaterialListMaterialStatus.Adapter.class)
public enum PromotionListV30DataListPromotionMaterialsTrialPlayMaterialListMaterialStatus {
  ...
  PromotionListV30DataListPromotionMaterialsTrialPlayMaterialListMaterialStatus(String value) {
    this.value = value;
  }
  ...
  public static PromotionListV30DataListPromotionMaterialsTrialPlayMaterialListMaterialStatus fromValue(String value) {
    for (PromotionListV30DataListPromotionMaterialsTrialPlayMaterialListMaterialStatus b : PromotionListV30DataListPromotionMaterialsTrialPlayMaterialListMaterialStatus.values()) {
  ...
  public static class Adapter extends TypeAdapter<PromotionListV30DataListPromotionMaterialsTrialPlayMaterialListMaterialStatus> {
    @Override
    public void write(final JsonWriter jsonWriter, final PromotionListV30DataListPromotionMaterialsTrialPlayMaterialListMaterialStatus enumeration) throws IOException {
      jsonWriter.value(enumeration.getValue());
    }

    @Override
    public PromotionListV30DataListPromotionMaterialsTrialPlayMaterialListMaterialStatus read(final JsonReader jsonReader) throws IOException {
      String value = jsonReader.nextString();
      return PromotionListV30DataListPromotionMaterialsTrialPlayMaterialListMaterialStatus.fromValue(value);
    }
  }
}

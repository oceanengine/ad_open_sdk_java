...
public class StarDemandOmGetChallengeV2ResponseDataTaskInfoChallengeInfo {
  ...
  **/
  ...
  @Override
  public int hashCode() {
    return Objects.hash(accountDivideDay, anchorTitle, authorList, authorScope, authorTaskName, budget, commissionRate, commissionType, demandDesc, endTime, maxUploadItemCnt, microAppId, omTaskStatus, omTaskTag, participateAuthorRange, sampleDelivery, sampleVideo, settlementInfo, startPage, startTime, taskHeadImage, taskIcon);
  }

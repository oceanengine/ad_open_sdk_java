...
public class QianchuanUniAwemeAdCreateV10Request {
  ...
  **/
  ...
  @Override
  public int hashCode() {
    return Objects.hash(advertiserId, awemeId, creativeSetting, deliverySetting, marketingGoal, multiProductCreativeList, productChannelInfo, productIds, programmaticCreativeMediaList);
  }

 ...
 * 
 */
@JsonAdapter(CreativeCustomCreativeCreateV2CreativeListImageMaterialsImageMode.Adapter.class)
public enum CreativeCustomCreativeCreateV2CreativeListImageMaterialsImageMode {
  ...
  CreativeCustomCreativeCreateV2CreativeListImageMaterialsImageMode(String value) {
    this.value = value;
  }
  ...
  public static CreativeCustomCreativeCreateV2CreativeListImageMaterialsImageMode fromValue(String value) {
    for (CreativeCustomCreativeCreateV2CreativeListImageMaterialsImageMode b : CreativeCustomCreativeCreateV2CreativeListImageMaterialsImageMode.values()) {
  ...
  public static class Adapter extends TypeAdapter<CreativeCustomCreativeCreateV2CreativeListImageMaterialsImageMode> {
    @Override
    public void write(final JsonWriter jsonWriter, final CreativeCustomCreativeCreateV2CreativeListImageMaterialsImageMode enumeration) throws IOException {
      jsonWriter.value(enumeration.getValue());
    }

    @Override
    public CreativeCustomCreativeCreateV2CreativeListImageMaterialsImageMode read(final JsonReader jsonReader) throws IOException {
      String value = jsonReader.nextString();
      return CreativeCustomCreativeCreateV2CreativeListImageMaterialsImageMode.fromValue(value);
    }
  }
}

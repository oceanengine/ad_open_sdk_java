...
public class BrandMaterialListV30ResponseDataMaterialsInner {
  ...
  **/
  ...
  @Override
  public int hashCode() {
    return Objects.hash(categoryInfo, createTime, creativeDisplayMode, creativeIsAigc, creativeTemplate, date, endTime, materialComponent, materialId, materialName, materialStatus, orderId, startTime, trackUrlGroupInfos, trackUrlInfo);
  }

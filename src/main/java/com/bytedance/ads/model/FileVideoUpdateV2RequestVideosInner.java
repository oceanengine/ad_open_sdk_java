...
public class FileVideoUpdateV2RequestVideosInner {
  ...
  **/
  ...
  public FileVideoUpdateV2RequestVideosInner labels(List<String> labels) {
    
    this.labels = labels;
    return this;
  }

  public FileVideoUpdateV2RequestVideosInner addLabelsItem(String labelsItem) {
    if (this.labels == null) {
  ...
  **/
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.filename, fileVideoUpdateV2RequestVideosInner.filename) &&
        Objects.equals(this.labels, fileVideoUpdateV2RequestVideosInner.labels) &&
        Objects.equals(this.videoId, fileVideoUpdateV2RequestVideosInner.videoId);
  }

  @Override
  public int hashCode() {
    return Objects.hash(filename, labels, videoId);
  }

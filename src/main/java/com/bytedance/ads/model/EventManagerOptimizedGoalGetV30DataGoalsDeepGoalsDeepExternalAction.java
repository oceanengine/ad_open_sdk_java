 ...
 * 
 */
@JsonAdapter(EventManagerOptimizedGoalGetV30DataGoalsDeepGoalsDeepExternalAction.Adapter.class)
public enum EventManagerOptimizedGoalGetV30DataGoalsDeepGoalsDeepExternalAction {
  ...
  EventManagerOptimizedGoalGetV30DataGoalsDeepGoalsDeepExternalAction(String value) {
    this.value = value;
  }
  ...
  public static EventManagerOptimizedGoalGetV30DataGoalsDeepGoalsDeepExternalAction fromValue(String value) {
    for (EventManagerOptimizedGoalGetV30DataGoalsDeepGoalsDeepExternalAction b : EventManagerOptimizedGoalGetV30DataGoalsDeepGoalsDeepExternalAction.values()) {
  ...
  public static class Adapter extends TypeAdapter<EventManagerOptimizedGoalGetV30DataGoalsDeepGoalsDeepExternalAction> {
    @Override
    public void write(final JsonWriter jsonWriter, final EventManagerOptimizedGoalGetV30DataGoalsDeepGoalsDeepExternalAction enumeration) throws IOException {
      jsonWriter.value(enumeration.getValue());
    }

    @Override
    public EventManagerOptimizedGoalGetV30DataGoalsDeepGoalsDeepExternalAction read(final JsonReader jsonReader) throws IOException {
      String value = jsonReader.nextString();
      return EventManagerOptimizedGoalGetV30DataGoalsDeepGoalsDeepExternalAction.fromValue(value);
    }
  }
}

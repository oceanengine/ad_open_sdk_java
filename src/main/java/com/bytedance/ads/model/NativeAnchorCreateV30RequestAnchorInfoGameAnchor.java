...
public class NativeAnchorCreateV30RequestAnchorInfoGameAnchor {
  ...
  **/
  ...
  @Override
  public int hashCode() {
    return Objects.hash(anchorImageMode, androidAnchorTitle, androidDownloadUrl, appImages, appTags, gameBonus, gameCharatoristic, gameDescription, gamePackageList, gameType, guideText, headImageList, iconImages, instanceId, iosAnchorTitle, iosDownloadUrl, otherDescription, pathParam, platformType);
  }

 ...
 * 
 */
@JsonAdapter(PromotionListV30DataListPromotionMaterialsTrialPlayMaterialListImageMode.Adapter.class)
public enum PromotionListV30DataListPromotionMaterialsTrialPlayMaterialListImageMode {
  ...
  PromotionListV30DataListPromotionMaterialsTrialPlayMaterialListImageMode(String value) {
    this.value = value;
  }
  ...
  public static PromotionListV30DataListPromotionMaterialsTrialPlayMaterialListImageMode fromValue(String value) {
    for (PromotionListV30DataListPromotionMaterialsTrialPlayMaterialListImageMode b : PromotionListV30DataListPromotionMaterialsTrialPlayMaterialListImageMode.values()) {
  ...
  public static class Adapter extends TypeAdapter<PromotionListV30DataListPromotionMaterialsTrialPlayMaterialListImageMode> {
    @Override
    public void write(final JsonWriter jsonWriter, final PromotionListV30DataListPromotionMaterialsTrialPlayMaterialListImageMode enumeration) throws IOException {
      jsonWriter.value(enumeration.getValue());
    }

    @Override
    public PromotionListV30DataListPromotionMaterialsTrialPlayMaterialListImageMode read(final JsonReader jsonReader) throws IOException {
      String value = jsonReader.nextString();
      return PromotionListV30DataListPromotionMaterialsTrialPlayMaterialListImageMode.fromValue(value);
    }
  }
}

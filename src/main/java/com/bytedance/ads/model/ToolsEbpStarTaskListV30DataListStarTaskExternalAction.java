 ...
 * 
 */
@JsonAdapter(ToolsEbpStarTaskListV30DataListStarTaskExternalAction.Adapter.class)
public enum ToolsEbpStarTaskListV30DataListStarTaskExternalAction {
  ...
  ToolsEbpStarTaskListV30DataListStarTaskExternalAction(String value) {
    this.value = value;
  }
  ...
  public static ToolsEbpStarTaskListV30DataListStarTaskExternalAction fromValue(String value) {
    for (ToolsEbpStarTaskListV30DataListStarTaskExternalAction b : ToolsEbpStarTaskListV30DataListStarTaskExternalAction.values()) {
  ...
  public static class Adapter extends TypeAdapter<ToolsEbpStarTaskListV30DataListStarTaskExternalAction> {
    @Override
    public void write(final JsonWriter jsonWriter, final ToolsEbpStarTaskListV30DataListStarTaskExternalAction enumeration) throws IOException {
      jsonWriter.value(enumeration.getValue());
    }

    @Override
    public ToolsEbpStarTaskListV30DataListStarTaskExternalAction read(final JsonReader jsonReader) throws IOException {
      String value = jsonReader.nextString();
      return ToolsEbpStarTaskListV30DataListStarTaskExternalAction.fromValue(value);
    }
  }
}

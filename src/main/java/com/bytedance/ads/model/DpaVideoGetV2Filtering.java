...
public class DpaVideoGetV2Filtering {
   ...
   * 
   */
  @JsonAdapter(ImageModeEnum.Adapter.class)
  public enum ImageModeEnum {
    ...
    public static class Adapter extends TypeAdapter<ImageModeEnum> {
      @Override
      public void write(final JsonWriter jsonWriter, final ImageModeEnum enumeration) throws IOException {
        jsonWriter.value(enumeration.getValue());
      }

      @Override
      public ImageModeEnum read(final JsonReader jsonReader) throws IOException {
        String value =  jsonReader.nextString();
        return ImageModeEnum.fromValue(value);
      }
    }
  }
  ...
  private ImageModeEnum imageMode = null;
  ...
  **/
  ...
  public DpaVideoGetV2Filtering imageMode(ImageModeEnum imageMode) {

 ...
 * 
 */
@JsonAdapter(ToolsEventConvertOptimizedGoalGetV30DataGoalsDeepGoalsDeepExternalAction.Adapter.class)
public enum ToolsEventConvertOptimizedGoalGetV30DataGoalsDeepGoalsDeepExternalAction {
  ...
  ToolsEventConvertOptimizedGoalGetV30DataGoalsDeepGoalsDeepExternalAction(String value) {
    this.value = value;
  }
  ...
  public static ToolsEventConvertOptimizedGoalGetV30DataGoalsDeepGoalsDeepExternalAction fromValue(String value) {
    for (ToolsEventConvertOptimizedGoalGetV30DataGoalsDeepGoalsDeepExternalAction b : ToolsEventConvertOptimizedGoalGetV30DataGoalsDeepGoalsDeepExternalAction.values()) {
  ...
  public static class Adapter extends TypeAdapter<ToolsEventConvertOptimizedGoalGetV30DataGoalsDeepGoalsDeepExternalAction> {
    @Override
    public void write(final JsonWriter jsonWriter, final ToolsEventConvertOptimizedGoalGetV30DataGoalsDeepGoalsDeepExternalAction enumeration) throws IOException {
      jsonWriter.value(enumeration.getValue());
    }

    @Override
    public ToolsEventConvertOptimizedGoalGetV30DataGoalsDeepGoalsDeepExternalAction read(final JsonReader jsonReader) throws IOException {
      String value = jsonReader.nextString();
      return ToolsEventConvertOptimizedGoalGetV30DataGoalsDeepGoalsDeepExternalAction.fromValue(value);
    }
  }
}

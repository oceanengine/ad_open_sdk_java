 ...
 * 
 */
@JsonAdapter(AdConvertOptimizedTargetGetV30DataListConvertsExternalActionsDeepExternalActionsDeepExternalAction.Adapter.class)
public enum AdConvertOptimizedTargetGetV30DataListConvertsExternalActionsDeepExternalActionsDeepExternalAction {
  ...
  AdConvertOptimizedTargetGetV30DataListConvertsExternalActionsDeepExternalActionsDeepExternalAction(String value) {
    this.value = value;
  }
  ...
  public static AdConvertOptimizedTargetGetV30DataListConvertsExternalActionsDeepExternalActionsDeepExternalAction fromValue(String value) {
    for (AdConvertOptimizedTargetGetV30DataListConvertsExternalActionsDeepExternalActionsDeepExternalAction b : AdConvertOptimizedTargetGetV30DataListConvertsExternalActionsDeepExternalActionsDeepExternalAction.values()) {
  ...
  public static class Adapter extends TypeAdapter<AdConvertOptimizedTargetGetV30DataListConvertsExternalActionsDeepExternalActionsDeepExternalAction> {
    @Override
    public void write(final JsonWriter jsonWriter, final AdConvertOptimizedTargetGetV30DataListConvertsExternalActionsDeepExternalActionsDeepExternalAction enumeration) throws IOException {
      jsonWriter.value(enumeration.getValue());
    }

    @Override
    public AdConvertOptimizedTargetGetV30DataListConvertsExternalActionsDeepExternalActionsDeepExternalAction read(final JsonReader jsonReader) throws IOException {
      String value = jsonReader.nextString();
      return AdConvertOptimizedTargetGetV30DataListConvertsExternalActionsDeepExternalActionsDeepExternalAction.fromValue(value);
    }
  }
}

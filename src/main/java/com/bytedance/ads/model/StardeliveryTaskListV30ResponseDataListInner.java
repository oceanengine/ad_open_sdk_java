...
public class StardeliveryTaskListV30ResponseDataListInner {
  ...
  **/
  ...
  @Override
  public int hashCode() {
    return Objects.hash(starAccountName, starAdCostDivideRatio, starAuthorPending, starId, starMaterialBid, starMaterialBidRange, starMaterialFirstName, starMaterialFirstType, starMaterialSecondName, starMaterialSecondType, starPendingConfirmCount, starSaleCostEndTime, starTaskAlbumId, starTaskAlbumName, starTaskAnchorType, starTaskBid, starTaskBudget, starTaskCanDeliveryItemCount, starTaskCategoryName, starTaskCategoryType, starTaskCreateTime, starTaskExternalAction, starTaskId, starTaskMaterialPurchaseMethod, starTaskModifyTime, starTaskName, starTaskPostEndTime, starTaskPostItemCount, starTaskRelateProjectCount, starTaskSource, starTaskStartTime, starTaskStatus, starTaskSubStatus, starTimeCostEndTime);
  }

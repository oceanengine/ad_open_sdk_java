 ...
 * 
 */
@JsonAdapter(AdlabGroupCreateV30AdInfoExternalAction.Adapter.class)
public enum AdlabGroupCreateV30AdInfoExternalAction {
  ...
  AdlabGroupCreateV30AdInfoExternalAction(String value) {
    this.value = value;
  }
  ...
  public static AdlabGroupCreateV30AdInfoExternalAction fromValue(String value) {
    for (AdlabGroupCreateV30AdInfoExternalAction b : AdlabGroupCreateV30AdInfoExternalAction.values()) {
  ...
  public static class Adapter extends TypeAdapter<AdlabGroupCreateV30AdInfoExternalAction> {
    @Override
    public void write(final JsonWriter jsonWriter, final AdlabGroupCreateV30AdInfoExternalAction enumeration) throws IOException {
      jsonWriter.value(enumeration.getValue());
    }

    @Override
    public AdlabGroupCreateV30AdInfoExternalAction read(final JsonReader jsonReader) throws IOException {
      String value = jsonReader.nextString();
      return AdlabGroupCreateV30AdInfoExternalAction.fromValue(value);
    }
  }
}

...
public class StarDemandCreateAssignV2RequestDemandInfo {
  ...
  **/
  ...
  @Override
  public int hashCode() {
    return Objects.hash(acceptExpirationDay, adSyncConf, attachmentText, attachments, brandName, componentClickMonitorUrl, componentInfo, contactName, contactPhone, demandName, demandRequirement, expectRemainTime, expirationTime, expirationTimeEnd, ignoreScript, ipActId, itemShowMonitorUrl, livestreamDeadline, productCategory, productIndustry, productInformation, productLink, productName, projectId, xingzhitouPreAudit, yuntuIndustryIds, yuntuMainBrand);
  }

...
import com.bytedance.ads.model.StarDemandCreateAssignV2RequestDemandInfoCarBrandListInner;
...
public class StarDemandCreateAssignV2RequestDemandInfo {
  ...
  public static final String SERIALIZED_NAME_CAR_BRAND_LIST = "car_brand_list";
  @SerializedName(SERIALIZED_NAME_CAR_BRAND_LIST)
  private List<StarDemandCreateAssignV2RequestDemandInfoCarBrandListInner> carBrandList = null;

  public static final String SERIALIZED_NAME_CAR_MARKETING_SCENE_TYPE = "car_marketing_scene_type";
  @SerializedName(SERIALIZED_NAME_CAR_MARKETING_SCENE_TYPE)
  private Long carMarketingSceneType = null;
  ...
  public static final String SERIALIZED_NAME_LIVESTREAM_DEADLINE = "livestream_deadline";
  @SerializedName(SERIALIZED_NAME_LIVESTREAM_DEADLINE)
  private Long livestreamDeadline = null;
  ...
  **/
  ...
  public StarDemandCreateAssignV2RequestDemandInfo carBrandList(List<StarDemandCreateAssignV2RequestDemandInfoCarBrandListInner> carBrandList) {
    
    this.carBrandList = carBrandList;
    return this;
  }

  public StarDemandCreateAssignV2RequestDemandInfo addCarBrandListItem(StarDemandCreateAssignV2RequestDemandInfoCarBrandListInner carBrandListItem) {
    if (this.carBrandList == null) {
      this.carBrandList = new ArrayList<>();
    }
    this.carBrandList.add(carBrandListItem);
    return this;
  }
  ...
  **/
  @javax.annotation.Nullable
  public List<StarDemandCreateAssignV2RequestDemandInfoCarBrandListInner> getCarBrandList() {
    return carBrandList;
  }


  public void setCarBrandList(List<StarDemandCreateAssignV2RequestDemandInfoCarBrandListInner> carBrandList) {
    this.carBrandList = carBrandList;
  }


  public StarDemandCreateAssignV2RequestDemandInfo carMarketingSceneType(Long carMarketingSceneType) {
    
    this.carMarketingSceneType = carMarketingSceneType;
    return this;
  }

   /**
   * 营销场景
   * @return carMarketingSceneType
  **/
  @javax.annotation.Nullable
  public Long getCarMarketingSceneType() {
    return carMarketingSceneType;
  }


  public void setCarMarketingSceneType(Long carMarketingSceneType) {
    this.carMarketingSceneType = carMarketingSceneType;
  }
  ...
  **/
  ...
  public StarDemandCreateAssignV2RequestDemandInfo livestreamDeadline(Long livestreamDeadline) {
    
    this.livestreamDeadline = livestreamDeadline;
    return this;
  }

   /**
   * 直播截止时间
   * @return livestreamDeadline
  **/
  @javax.annotation.Nullable
  public Long getLivestreamDeadline() {
    return livestreamDeadline;
  }


  public void setLivestreamDeadline(Long livestreamDeadline) {
    this.livestreamDeadline = livestreamDeadline;
  }
  ...
  **/
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.acceptExpirationDay, starDemandCreateAssignV2RequestDemandInfo.acceptExpirationDay) &&
        ...
        Objects.equals(this.carBrandList, starDemandCreateAssignV2RequestDemandInfo.carBrandList) &&
        Objects.equals(this.carMarketingSceneType, starDemandCreateAssignV2RequestDemandInfo.carMarketingSceneType) &&
        ...
        Objects.equals(this.livestreamDeadline, starDemandCreateAssignV2RequestDemandInfo.livestreamDeadline) &&
  ...
  @Override
  public int hashCode() {
    return Objects.hash(acceptExpirationDay, adSyncConf, attachmentText, attachments, brandName, carBrandList, carMarketingSceneType, componentClickMonitorUrl, componentInfo, contactName, contactPhone, demandName, demandRequirement, expectRemainTime, expirationTime, expirationTimeEnd, ignoreScript, ipActId, itemShowMonitorUrl, livestreamDeadline, productCategory, productIndustry, productInformation, productLink, productName, projectId, xingzhitouPreAudit, yuntuIndustryIds, yuntuMainBrand);
  }
  ...
  public String toString() {
    ...
    sb.append("    carBrandList: ").append(toIndentedString(carBrandList)).append("\n");
    sb.append("    carMarketingSceneType: ").append(toIndentedString(carMarketingSceneType)).append("\n");
    ...
    sb.append("    livestreamDeadline: ").append(toIndentedString(livestreamDeadline)).append("\n");
  ...
  static {
    ...
    openapiFields.add("car_brand_list");
    openapiFields.add("car_marketing_scene_type");
    ...
    openapiFields.add("livestream_deadline");

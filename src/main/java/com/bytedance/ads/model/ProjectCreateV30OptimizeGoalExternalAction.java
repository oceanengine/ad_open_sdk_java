 ...
 * 
 */
@JsonAdapter(ProjectCreateV30OptimizeGoalExternalAction.Adapter.class)
public enum ProjectCreateV30OptimizeGoalExternalAction {
  ...
  ProjectCreateV30OptimizeGoalExternalAction(String value) {
    this.value = value;
  }
  ...
  public static ProjectCreateV30OptimizeGoalExternalAction fromValue(String value) {
    for (ProjectCreateV30OptimizeGoalExternalAction b : ProjectCreateV30OptimizeGoalExternalAction.values()) {
  ...
  public static class Adapter extends TypeAdapter<ProjectCreateV30OptimizeGoalExternalAction> {
    @Override
    public void write(final JsonWriter jsonWriter, final ProjectCreateV30OptimizeGoalExternalAction enumeration) throws IOException {
      jsonWriter.value(enumeration.getValue());
    }

    @Override
    public ProjectCreateV30OptimizeGoalExternalAction read(final JsonReader jsonReader) throws IOException {
      String value = jsonReader.nextString();
      return ProjectCreateV30OptimizeGoalExternalAction.fromValue(value);
    }
  }
}

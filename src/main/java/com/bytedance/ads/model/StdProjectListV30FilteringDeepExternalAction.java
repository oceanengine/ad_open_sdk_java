 ...
 * 深度优化目标
 */
@JsonAdapter(StdProjectListV30FilteringDeepExternalAction.Adapter.class)
public enum StdProjectListV30FilteringDeepExternalAction {
  
  ADD_TO_CART("AD_CONVERT_ADD_TO_CART"),
  ...
  TYPE_EFFECTIVE_ACTIVE("AD_CONVERT_TYPE_EFFECTIVE_ACTIVE"),
  ...
  TYPE_INTENTION_FORM("AD_CONVERT_TYPE_INTENTION_FORM"),
  ...
  TYPE_LTV_ROI_SEVEN("AD_CONVERT_TYPE_LTV_ROI_SEVEN"),
  
  TYPE_LTV_ROI_THIRTY("AD_CONVERT_TYPE_LTV_ROI_THIRTY"),
  ...
  TYPE_MESSAGE_INTENTION_CLUE("AD_CONVERT_TYPE_MESSAGE_INTENTION_CLUE"),
  ...
  TYPE_PLANTING_GRASS("AD_CONVERT_TYPE_PLANTING_GRASS"),
  ...
  TYPE_PURCHASE_ROI_THIRTY("AD_CONVERT_TYPE_PURCHASE_ROI_THIRTY"),
  ...
  TYPE_SERVICE_WITHDRAW("AD_CONVERT_TYPE_SERVICE_WITHDRAW"),
  ...
  TYPE_WECHAT_FIRST_MSG("AD_CONVERT_TYPE_WECHAT_FIRST_MSG"),
  
  TYPE_WECHAT_PAY("AD_CONVERT_TYPE_WECHAT_PAY"),
  
  TYPE_WECHAT_QRCODE_SHOW("AD_CONVERT_TYPE_WECHAT_QRCODE_SHOW"),
  
  TYPE_WECHAT_QRCODE_TRY("AD_CONVERT_TYPE_WECHAT_QRCODE_TRY"),
  ...
  StdProjectListV30FilteringDeepExternalAction(String value) {
    this.value = value;
  }
  ...
  public static StdProjectListV30FilteringDeepExternalAction fromValue(String value) {
    for (StdProjectListV30FilteringDeepExternalAction b : StdProjectListV30FilteringDeepExternalAction.values()) {
  ...
  public static class Adapter extends TypeAdapter<StdProjectListV30FilteringDeepExternalAction> {
    @Override
    public void write(final JsonWriter jsonWriter, final StdProjectListV30FilteringDeepExternalAction enumeration) throws IOException {
      jsonWriter.value(enumeration.getValue());
    }

    @Override
    public StdProjectListV30FilteringDeepExternalAction read(final JsonReader jsonReader) throws IOException {
      String value = jsonReader.nextString();
      return StdProjectListV30FilteringDeepExternalAction.fromValue(value);
    }
  }
}

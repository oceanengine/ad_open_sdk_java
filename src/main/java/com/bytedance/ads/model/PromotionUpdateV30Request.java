...
public class PromotionUpdateV30Request {
  ...
  **/
  ...
  @Override
  public int hashCode() {
    return Objects.hash(_7dRetention, advertiserId, autoExtendTraffic, bid, brandInfo, budget, configId, cpaBid, creativeAutoGenerateSwitch, deepCpabid, firstRoiGoal, isCommentDisable, keywords, name, nativeSetting, promotionId, promotionMaterials, roiGoal, shopMultiRoiGoals, source, unionBidRatio);
  }

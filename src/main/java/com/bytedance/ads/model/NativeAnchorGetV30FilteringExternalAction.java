 ...
 * 
 */
@JsonAdapter(NativeAnchorGetV30FilteringExternalAction.Adapter.class)
public enum NativeAnchorGetV30FilteringExternalAction {
  ...
  NativeAnchorGetV30FilteringExternalAction(String value) {
    this.value = value;
  }
  ...
  public static NativeAnchorGetV30FilteringExternalAction fromValue(String value) {
    for (NativeAnchorGetV30FilteringExternalAction b : NativeAnchorGetV30FilteringExternalAction.values()) {
  ...
  public static class Adapter extends TypeAdapter<NativeAnchorGetV30FilteringExternalAction> {
    @Override
    public void write(final JsonWriter jsonWriter, final NativeAnchorGetV30FilteringExternalAction enumeration) throws IOException {
      jsonWriter.value(enumeration.getValue());
    }

    @Override
    public NativeAnchorGetV30FilteringExternalAction read(final JsonReader jsonReader) throws IOException {
      String value = jsonReader.nextString();
      return NativeAnchorGetV30FilteringExternalAction.fromValue(value);
    }
  }
}

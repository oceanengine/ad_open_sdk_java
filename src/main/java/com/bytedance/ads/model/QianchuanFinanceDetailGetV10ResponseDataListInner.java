...
public class QianchuanFinanceDetailGetV10ResponseDataListInner {
  ...
  **/
  ...
  @Override
  public int hashCode() {
    return Objects.hash(cashBalance, cashCost, cost, date, deductionCost, grantBalance, grantCost, income, qcAwemeCashCost, qcAwemeCost, qcAwemeGrantCost, shareCost, totalBalance, transferIn, transferOut, viewDeliveryType);
  }

 ...
 * 
 */
@JsonAdapter(AdGetV2DataExternalActions.Adapter.class)
public enum AdGetV2DataExternalActions {
  ...
  AdGetV2DataExternalActions(String value) {
    this.value = value;
  }
  ...
  public static AdGetV2DataExternalActions fromValue(String value) {
    for (AdGetV2DataExternalActions b : AdGetV2DataExternalActions.values()) {
  ...
  public static class Adapter extends TypeAdapter<AdGetV2DataExternalActions> {
    @Override
    public void write(final JsonWriter jsonWriter, final AdGetV2DataExternalActions enumeration) throws IOException {
      jsonWriter.value(enumeration.getValue());
    }

    @Override
    public AdGetV2DataExternalActions read(final JsonReader jsonReader) throws IOException {
      String value = jsonReader.nextString();
      return AdGetV2DataExternalActions.fromValue(value);
    }
  }
}

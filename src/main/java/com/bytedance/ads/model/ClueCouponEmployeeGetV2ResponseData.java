...
public class ClueCouponEmployeeGetV2ResponseData {
  ...
  private List<ClueCouponEmployeeCreateV2ResponseDataExistedListInner> _list = null;
  ...
  public ClueCouponEmployeeGetV2ResponseData _list(List<ClueCouponEmployeeCreateV2ResponseDataExistedListInner> _list) {
    
    this._list = _list;
    return this;
  }

  public ClueCouponEmployeeGetV2ResponseData addListItem(ClueCouponEmployeeCreateV2ResponseDataExistedListInner _listItem) {
    if (this._list == null) {
  ...
  **/
  ...
  public List<ClueCouponEmployeeCreateV2ResponseDataExistedListInner> getList() {
    return _list;
  }


  public void setList(List<ClueCouponEmployeeCreateV2ResponseDataExistedListInner> _list) {
    this._list = _list;
  }

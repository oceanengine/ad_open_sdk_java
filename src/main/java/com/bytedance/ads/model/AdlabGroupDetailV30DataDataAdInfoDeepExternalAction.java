 ...
 * 
 */
@JsonAdapter(AdlabGroupDetailV30DataDataAdInfoDeepExternalAction.Adapter.class)
public enum AdlabGroupDetailV30DataDataAdInfoDeepExternalAction {
  ...
  TYPE_GAMESTATION_DOWNLOAD_DOUPLUS("AD_CONVERT_TYPE_GAMESTATION_DOWNLOAD_DOUPLUS"),
  ...
  TYPE_LIVE_BUSINESS_FITTING("AD_CONVERT_TYPE_LIVE_BUSINESS_FITTING"),
  ...
  AdlabGroupDetailV30DataDataAdInfoDeepExternalAction(String value) {
    this.value = value;
  }
  ...
  public static AdlabGroupDetailV30DataDataAdInfoDeepExternalAction fromValue(String value) {
    for (AdlabGroupDetailV30DataDataAdInfoDeepExternalAction b : AdlabGroupDetailV30DataDataAdInfoDeepExternalAction.values()) {
  ...
  public static class Adapter extends TypeAdapter<AdlabGroupDetailV30DataDataAdInfoDeepExternalAction> {
    @Override
    public void write(final JsonWriter jsonWriter, final AdlabGroupDetailV30DataDataAdInfoDeepExternalAction enumeration) throws IOException {
      jsonWriter.value(enumeration.getValue());
    }

    @Override
    public AdlabGroupDetailV30DataDataAdInfoDeepExternalAction read(final JsonReader jsonReader) throws IOException {
      String value = jsonReader.nextString();
      return AdlabGroupDetailV30DataDataAdInfoDeepExternalAction.fromValue(value);
    }
  }
}

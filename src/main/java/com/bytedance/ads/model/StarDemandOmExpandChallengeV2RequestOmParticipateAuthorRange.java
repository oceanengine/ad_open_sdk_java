...
public class StarDemandOmExpandChallengeV2RequestOmParticipateAuthorRange {
  public static final String SERIALIZED_NAME_ADD_OR_CANCEL_AUTHOR_UIDS = "add_or_cancel_author_uids";
  @SerializedName(SERIALIZED_NAME_ADD_OR_CANCEL_AUTHOR_UIDS)
  private List<Long> addOrCancelAuthorUids = null;
  ...
  public StarDemandOmExpandChallengeV2RequestOmParticipateAuthorRange addOrCancelAuthorUids(List<Long> addOrCancelAuthorUids) {
    
    this.addOrCancelAuthorUids = addOrCancelAuthorUids;
    return this;
  }

  public StarDemandOmExpandChallengeV2RequestOmParticipateAuthorRange addAddOrCancelAuthorUidsItem(Long addOrCancelAuthorUidsItem) {
    if (this.addOrCancelAuthorUids == null) {
      this.addOrCancelAuthorUids = new ArrayList<>();
    }
    this.addOrCancelAuthorUids.add(addOrCancelAuthorUidsItem);
    return this;
  }

   /**
   * 增派达人抖音号 专属任务，list，最多200
   * @return addOrCancelAuthorUids
  **/
  @javax.annotation.Nonnull
  public List<Long> getAddOrCancelAuthorUids() {
    return addOrCancelAuthorUids;
  }


  public void setAddOrCancelAuthorUids(List<Long> addOrCancelAuthorUids) {
    this.addOrCancelAuthorUids = addOrCancelAuthorUids;
  }
  ...
  **/
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.addOrCancelAuthorUids, starDemandOmExpandChallengeV2RequestOmParticipateAuthorRange.addOrCancelAuthorUids) &&
        Objects.equals(this.operationType, starDemandOmExpandChallengeV2RequestOmParticipateAuthorRange.operationType);
  }

  @Override
  public int hashCode() {
    return Objects.hash(addOrCancelAuthorUids, operationType);
  }
  ...
  public String toString() {
    ...
    sb.append("    addOrCancelAuthorUids: ").append(toIndentedString(addOrCancelAuthorUids)).append("\n");
  ...
  static {
    ...
    openapiFields.add("add_or_cancel_author_uids");
    openapiFields.add("operation_type");

    // a set of required properties/fields (JSON key names)
    openapiRequiredFields = new HashSet<String>();
    openapiRequiredFields.add("add_or_cancel_author_uids");

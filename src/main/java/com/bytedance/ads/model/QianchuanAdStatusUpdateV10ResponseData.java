...
import com.bytedance.ads.model.QianchuanAdBidUpdateV10ResponseDataErrorsInner;
...
public class QianchuanAdStatusUpdateV10ResponseData {
  ...
  private List<QianchuanAdBidUpdateV10ResponseDataErrorsInner> errors = null;
  ...
  **/
  ...
  public QianchuanAdStatusUpdateV10ResponseData errors(List<QianchuanAdBidUpdateV10ResponseDataErrorsInner> errors) {
    
    this.errors = errors;
    return this;
  }

  public QianchuanAdStatusUpdateV10ResponseData addErrorsItem(QianchuanAdBidUpdateV10ResponseDataErrorsInner errorsItem) {
    if (this.errors == null) {
  ...
  **/
  @javax.annotation.Nullable
  public List<QianchuanAdBidUpdateV10ResponseDataErrorsInner> getErrors() {
    return errors;
  }


  public void setErrors(List<QianchuanAdBidUpdateV10ResponseDataErrorsInner> errors) {
    this.errors = errors;
  }

...
public class QianchuanAdStatusUpdateV10ResponseData {
  ...
  **/
  ...
  public QianchuanAdStatusUpdateV10ResponseData errors(List<AdUpdateBidV2ResponseDataErrorsInner> errors) {
    
    this.errors = errors;
    return this;
  }

  public QianchuanAdStatusUpdateV10ResponseData addErrorsItem(AdUpdateBidV2ResponseDataErrorsInner errorsItem) {
    if (this.errors == null) {

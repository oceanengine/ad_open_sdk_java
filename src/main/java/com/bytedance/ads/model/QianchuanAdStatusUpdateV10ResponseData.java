...
import com.bytedance.ads.model.AdUpdateStatusV2ResponseDataErrorsInner;
...
public class QianchuanAdStatusUpdateV10ResponseData {
  ...
  private List<AdUpdateStatusV2ResponseDataErrorsInner> errors = null;
  ...
  **/
  ...
  public QianchuanAdStatusUpdateV10ResponseData errors(List<AdUpdateStatusV2ResponseDataErrorsInner> errors) {
    
    this.errors = errors;
    return this;
  }

  public QianchuanAdStatusUpdateV10ResponseData addErrorsItem(AdUpdateStatusV2ResponseDataErrorsInner errorsItem) {
    if (this.errors == null) {
  ...
  **/
  @javax.annotation.Nullable
  public List<AdUpdateStatusV2ResponseDataErrorsInner> getErrors() {
    return errors;
  }


  public void setErrors(List<AdUpdateStatusV2ResponseDataErrorsInner> errors) {
    this.errors = errors;
  }

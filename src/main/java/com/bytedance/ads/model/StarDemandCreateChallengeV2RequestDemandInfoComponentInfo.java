...
import com.bytedance.ads.model.StarDemandCreateChallengeV2RequestDemandInfoComponentInfoEcomCartInner;
import com.bytedance.ads.model.StarDemandCreateChallengeV2RequestDemandInfoComponentInfoPaidContentComponent;
...
public class StarDemandCreateChallengeV2RequestDemandInfoComponentInfo {
  public static final String SERIALIZED_NAME_COMMON_COMPONENT_IDS = "common_component_ids";
  @SerializedName(SERIALIZED_NAME_COMMON_COMPONENT_IDS)
  private List<Long> commonComponentIds = null;

  public static final String SERIALIZED_NAME_ECOM_CART = "ecom_cart";
  @SerializedName(SERIALIZED_NAME_ECOM_CART)
  private List<StarDemandCreateChallengeV2RequestDemandInfoComponentInfoEcomCartInner> ecomCart = null;
  ...
  public static final String SERIALIZED_NAME_PAID_CONTENT_COMPONENT = "paid_content_component";
  @SerializedName(SERIALIZED_NAME_PAID_CONTENT_COMPONENT)
  private StarDemandCreateChallengeV2RequestDemandInfoComponentInfoPaidContentComponent paidContentComponent = null;

  public StarDemandCreateChallengeV2RequestDemandInfoComponentInfo() {
  }

  public StarDemandCreateChallengeV2RequestDemandInfoComponentInfo commonComponentIds(List<Long> commonComponentIds) {
    
    this.commonComponentIds = commonComponentIds;
    return this;
  }

  public StarDemandCreateChallengeV2RequestDemandInfoComponentInfo addCommonComponentIdsItem(Long commonComponentIdsItem) {
    if (this.commonComponentIds == null) {
      this.commonComponentIds = new ArrayList<>();
    }
    this.commonComponentIds.add(commonComponentIdsItem);
    return this;
  }

   /**
   * 
   * @return commonComponentIds
  **/
  @javax.annotation.Nullable
  public List<Long> getCommonComponentIds() {
    return commonComponentIds;
  }


  public void setCommonComponentIds(List<Long> commonComponentIds) {
    this.commonComponentIds = commonComponentIds;
  }


  public StarDemandCreateChallengeV2RequestDemandInfoComponentInfo ecomCart(List<StarDemandCreateChallengeV2RequestDemandInfoComponentInfoEcomCartInner> ecomCart) {
    
    this.ecomCart = ecomCart;
    return this;
  }

  public StarDemandCreateChallengeV2RequestDemandInfoComponentInfo addEcomCartItem(StarDemandCreateChallengeV2RequestDemandInfoComponentInfoEcomCartInner ecomCartItem) {
  ...
  **/
  @javax.annotation.Nullable
  public List<StarDemandCreateChallengeV2RequestDemandInfoComponentInfoEcomCartInner> getEcomCart() {
    return ecomCart;
  }


  public void setEcomCart(List<StarDemandCreateChallengeV2RequestDemandInfoComponentInfoEcomCartInner> ecomCart) {
    this.ecomCart = ecomCart;
  }
  ...
  **/
  ...
  public StarDemandCreateChallengeV2RequestDemandInfoComponentInfo paidContentComponent(StarDemandCreateChallengeV2RequestDemandInfoComponentInfoPaidContentComponent paidContentComponent) {
    
    this.paidContentComponent = paidContentComponent;
    return this;
  }

   /**
   * Get paidContentComponent
   * @return paidContentComponent
  **/
  @javax.annotation.Nullable
  public StarDemandCreateChallengeV2RequestDemandInfoComponentInfoPaidContentComponent getPaidContentComponent() {
    return paidContentComponent;
  }


  public void setPaidContentComponent(StarDemandCreateChallengeV2RequestDemandInfoComponentInfoPaidContentComponent paidContentComponent) {
    this.paidContentComponent = paidContentComponent;
  }
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.commonComponentIds, starDemandCreateChallengeV2RequestDemandInfoComponentInfo.commonComponentIds) &&
        Objects.equals(this.ecomCart, starDemandCreateChallengeV2RequestDemandInfoComponentInfo.ecomCart) &&
        Objects.equals(this.industryComponentId, starDemandCreateChallengeV2RequestDemandInfoComponentInfo.industryComponentId) &&
        ...
        Objects.equals(this.paidContentComponent, starDemandCreateChallengeV2RequestDemandInfoComponentInfo.paidContentComponent);
  }

  @Override
  public int hashCode() {
    return Objects.hash(commonComponentIds, ecomCart, industryComponentId, linkComponentIds, liveAttractComponentId, paidContentComponent);
  }
  ...
  public String toString() {
    ...
    sb.append("    commonComponentIds: ").append(toIndentedString(commonComponentIds)).append("\n");
    ...
    sb.append("    paidContentComponent: ").append(toIndentedString(paidContentComponent)).append("\n");
    sb.append("}");
    return sb.toString();
  }
  ...
  static {
    ...
    openapiFields.add("common_component_ids");
    ...
    openapiFields.add("paid_content_component");

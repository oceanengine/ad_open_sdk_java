 ...
 * 
 */
@JsonAdapter(PromotionListV30DataListPromotionRelatedProductImageMaterialListImagesMaterialStatus.Adapter.class)
public enum PromotionListV30DataListPromotionRelatedProductImageMaterialListImagesMaterialStatus {
  ...
  PromotionListV30DataListPromotionRelatedProductImageMaterialListImagesMaterialStatus(String value) {
    this.value = value;
  }
  ...
  public static PromotionListV30DataListPromotionRelatedProductImageMaterialListImagesMaterialStatus fromValue(String value) {
    for (PromotionListV30DataListPromotionRelatedProductImageMaterialListImagesMaterialStatus b : PromotionListV30DataListPromotionRelatedProductImageMaterialListImagesMaterialStatus.values()) {
  ...
  public static class Adapter extends TypeAdapter<PromotionListV30DataListPromotionRelatedProductImageMaterialListImagesMaterialStatus> {
    @Override
    public void write(final JsonWriter jsonWriter, final PromotionListV30DataListPromotionRelatedProductImageMaterialListImagesMaterialStatus enumeration) throws IOException {
      jsonWriter.value(enumeration.getValue());
    }

    @Override
    public PromotionListV30DataListPromotionRelatedProductImageMaterialListImagesMaterialStatus read(final JsonReader jsonReader) throws IOException {
      String value = jsonReader.nextString();
      return PromotionListV30DataListPromotionRelatedProductImageMaterialListImagesMaterialStatus.fromValue(value);
    }
  }
}

 ...
 * 
 */
@JsonAdapter(ReportCreativeGetV2DataListImageMode.Adapter.class)
public enum ReportCreativeGetV2DataListImageMode {
  ...
  ReportCreativeGetV2DataListImageMode(String value) {
    this.value = value;
  }
  ...
  public static ReportCreativeGetV2DataListImageMode fromValue(String value) {
    for (ReportCreativeGetV2DataListImageMode b : ReportCreativeGetV2DataListImageMode.values()) {
  ...
  public static class Adapter extends TypeAdapter<ReportCreativeGetV2DataListImageMode> {
    @Override
    public void write(final JsonWriter jsonWriter, final ReportCreativeGetV2DataListImageMode enumeration) throws IOException {
      jsonWriter.value(enumeration.getValue());
    }

    @Override
    public ReportCreativeGetV2DataListImageMode read(final JsonReader jsonReader) throws IOException {
      String value = jsonReader.nextString();
      return ReportCreativeGetV2DataListImageMode.fromValue(value);
    }
  }
}

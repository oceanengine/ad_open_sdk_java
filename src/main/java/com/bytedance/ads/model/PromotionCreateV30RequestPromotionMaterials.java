...
public class PromotionCreateV30RequestPromotionMaterials {
  ...
  **/
  ...
  @Override
  public int hashCode() {
    return Objects.hash(advancedDcSettings, anchorMaterialList, blueFlowMaterialRecommend, callToActionButtons, carouselMaterialList, componentMaterialList, decorationMaterial, dynamicCreativeSwitch, externalUrlField, externalUrlMaterialList, externalUrlParams, imageMaterialList, intelligentGeneration, miniProgramInfo, openUrl, openUrlField, openUrlParams, openUrlType, openUrls, originalVideoTitle, paramsType, playletSeriesUrlList, productInfo, textAbstractList, titleMaterialList, ulink, ulinkType, videoMaterialList, webUrlMaterialList);
  }

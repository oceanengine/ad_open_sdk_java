 ...
 * 
 */
@JsonAdapter(EventManagerDbtGetV30DataDeepBidType.Adapter.class)
public enum EventManagerDbtGetV30DataDeepBidType {
  ...
  EventManagerDbtGetV30DataDeepBidType(String value) {
    this.value = value;
  }
  ...
  public static EventManagerDbtGetV30DataDeepBidType fromValue(String value) {
    for (EventManagerDbtGetV30DataDeepBidType b : EventManagerDbtGetV30DataDeepBidType.values()) {
  ...
  public static class Adapter extends TypeAdapter<EventManagerDbtGetV30DataDeepBidType> {
    @Override
    public void write(final JsonWriter jsonWriter, final EventManagerDbtGetV30DataDeepBidType enumeration) throws IOException {
      jsonWriter.value(enumeration.getValue());
    }

    @Override
    public EventManagerDbtGetV30DataDeepBidType read(final JsonReader jsonReader) throws IOException {
      String value = jsonReader.nextString();
      return EventManagerDbtGetV30DataDeepBidType.fromValue(value);
    }
  }
}

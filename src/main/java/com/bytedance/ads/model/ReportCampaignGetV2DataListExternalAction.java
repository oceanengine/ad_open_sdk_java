 ...
 * 
 */
@JsonAdapter(ReportCampaignGetV2DataListExternalAction.Adapter.class)
public enum ReportCampaignGetV2DataListExternalAction {
  ...
  ReportCampaignGetV2DataListExternalAction(String value) {
    this.value = value;
  }
  ...
  public static ReportCampaignGetV2DataListExternalAction fromValue(String value) {
    for (ReportCampaignGetV2DataListExternalAction b : ReportCampaignGetV2DataListExternalAction.values()) {
  ...
  public static class Adapter extends TypeAdapter<ReportCampaignGetV2DataListExternalAction> {
    @Override
    public void write(final JsonWriter jsonWriter, final ReportCampaignGetV2DataListExternalAction enumeration) throws IOException {
      jsonWriter.value(enumeration.getValue());
    }

    @Override
    public ReportCampaignGetV2DataListExternalAction read(final JsonReader jsonReader) throws IOException {
      String value = jsonReader.nextString();
      return ReportCampaignGetV2DataListExternalAction.fromValue(value);
    }
  }
}

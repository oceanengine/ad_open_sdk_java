...
public class AgentAdvertiserInfoQueryV2ResponseDataAccountDetailListInner {
  ...
  **/
  ...
  @Override
  public int hashCode() {
    return Objects.hash(advCompanyId, advCompanyName, advertiserId, advertiserName, advertiserStatus, authExpireDate, bindTime, brandCollaborators, brandOptimizerId, brandOptimizerName, collaborators, contactName, createTime, customerSaleName, firstAgentCompanyId, firstAgentCompanyName, firstAgentId, firstAgentName, firstIndustryName, optimizerId, optimizerName, secondIndustryName, selfOperationTag);
  }

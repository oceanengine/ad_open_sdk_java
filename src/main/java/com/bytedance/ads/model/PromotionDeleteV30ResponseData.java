...
public class PromotionDeleteV30ResponseData {
  ...
  public PromotionDeleteV30ResponseData errors(List<PromotionBidUpdateV30ResponseDataErrorsInner> errors) {
    
    this.errors = errors;
    return this;
  }

  public PromotionDeleteV30ResponseData addErrorsItem(PromotionBidUpdateV30ResponseDataErrorsInner errorsItem) {
    if (this.errors == null) {

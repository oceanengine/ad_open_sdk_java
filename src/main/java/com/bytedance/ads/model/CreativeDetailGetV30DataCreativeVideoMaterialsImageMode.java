 ...
 * 
 */
@JsonAdapter(CreativeDetailGetV30DataCreativeVideoMaterialsImageMode.Adapter.class)
public enum CreativeDetailGetV30DataCreativeVideoMaterialsImageMode {
  ...
  CreativeDetailGetV30DataCreativeVideoMaterialsImageMode(String value) {
    this.value = value;
  }
  ...
  public static CreativeDetailGetV30DataCreativeVideoMaterialsImageMode fromValue(String value) {
    for (CreativeDetailGetV30DataCreativeVideoMaterialsImageMode b : CreativeDetailGetV30DataCreativeVideoMaterialsImageMode.values()) {
  ...
  public static class Adapter extends TypeAdapter<CreativeDetailGetV30DataCreativeVideoMaterialsImageMode> {
    @Override
    public void write(final JsonWriter jsonWriter, final CreativeDetailGetV30DataCreativeVideoMaterialsImageMode enumeration) throws IOException {
      jsonWriter.value(enumeration.getValue());
    }

    @Override
    public CreativeDetailGetV30DataCreativeVideoMaterialsImageMode read(final JsonReader jsonReader) throws IOException {
      String value = jsonReader.nextString();
      return CreativeDetailGetV30DataCreativeVideoMaterialsImageMode.fromValue(value);
    }
  }
}

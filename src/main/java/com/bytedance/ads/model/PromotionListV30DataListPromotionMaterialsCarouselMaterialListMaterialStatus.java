 ...
 * 
 */
@JsonAdapter(PromotionListV30DataListPromotionMaterialsCarouselMaterialListMaterialStatus.Adapter.class)
public enum PromotionListV30DataListPromotionMaterialsCarouselMaterialListMaterialStatus {
  ...
  PromotionListV30DataListPromotionMaterialsCarouselMaterialListMaterialStatus(String value) {
    this.value = value;
  }
  ...
  public static PromotionListV30DataListPromotionMaterialsCarouselMaterialListMaterialStatus fromValue(String value) {
    for (PromotionListV30DataListPromotionMaterialsCarouselMaterialListMaterialStatus b : PromotionListV30DataListPromotionMaterialsCarouselMaterialListMaterialStatus.values()) {
  ...
  public static class Adapter extends TypeAdapter<PromotionListV30DataListPromotionMaterialsCarouselMaterialListMaterialStatus> {
    @Override
    public void write(final JsonWriter jsonWriter, final PromotionListV30DataListPromotionMaterialsCarouselMaterialListMaterialStatus enumeration) throws IOException {
      jsonWriter.value(enumeration.getValue());
    }

    @Override
    public PromotionListV30DataListPromotionMaterialsCarouselMaterialListMaterialStatus read(final JsonReader jsonReader) throws IOException {
      String value = jsonReader.nextString();
      return PromotionListV30DataListPromotionMaterialsCarouselMaterialListMaterialStatus.fromValue(value);
    }
  }
}

 ...
 * 
 */
@JsonAdapter(PromotionListV30DataListPromotionRelatedProductVideoMateralListMaterialStatus.Adapter.class)
public enum PromotionListV30DataListPromotionRelatedProductVideoMateralListMaterialStatus {
  ...
  PromotionListV30DataListPromotionRelatedProductVideoMateralListMaterialStatus(String value) {
    this.value = value;
  }
  ...
  public static PromotionListV30DataListPromotionRelatedProductVideoMateralListMaterialStatus fromValue(String value) {
    for (PromotionListV30DataListPromotionRelatedProductVideoMateralListMaterialStatus b : PromotionListV30DataListPromotionRelatedProductVideoMateralListMaterialStatus.values()) {
  ...
  public static class Adapter extends TypeAdapter<PromotionListV30DataListPromotionRelatedProductVideoMateralListMaterialStatus> {
    @Override
    public void write(final JsonWriter jsonWriter, final PromotionListV30DataListPromotionRelatedProductVideoMateralListMaterialStatus enumeration) throws IOException {
      jsonWriter.value(enumeration.getValue());
    }

    @Override
    public PromotionListV30DataListPromotionRelatedProductVideoMateralListMaterialStatus read(final JsonReader jsonReader) throws IOException {
      String value = jsonReader.nextString();
      return PromotionListV30DataListPromotionRelatedProductVideoMateralListMaterialStatus.fromValue(value);
    }
  }
}

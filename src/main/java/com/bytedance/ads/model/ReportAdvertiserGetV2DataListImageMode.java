 ...
 * 
 */
@JsonAdapter(ReportAdvertiserGetV2DataListImageMode.Adapter.class)
public enum ReportAdvertiserGetV2DataListImageMode {
  ...
  ReportAdvertiserGetV2DataListImageMode(String value) {
    this.value = value;
  }
  ...
  public static ReportAdvertiserGetV2DataListImageMode fromValue(String value) {
    for (ReportAdvertiserGetV2DataListImageMode b : ReportAdvertiserGetV2DataListImageMode.values()) {
  ...
  public static class Adapter extends TypeAdapter<ReportAdvertiserGetV2DataListImageMode> {
    @Override
    public void write(final JsonWriter jsonWriter, final ReportAdvertiserGetV2DataListImageMode enumeration) throws IOException {
      jsonWriter.value(enumeration.getValue());
    }

    @Override
    public ReportAdvertiserGetV2DataListImageMode read(final JsonReader jsonReader) throws IOException {
      String value = jsonReader.nextString();
      return ReportAdvertiserGetV2DataListImageMode.fromValue(value);
    }
  }
}

 ...
 * 
 */
@JsonAdapter(CreativeGetV2DataListImageMode.Adapter.class)
public enum CreativeGetV2DataListImageMode {
  ...
  CreativeGetV2DataListImageMode(String value) {
    this.value = value;
  }
  ...
  public static CreativeGetV2DataListImageMode fromValue(String value) {
    for (CreativeGetV2DataListImageMode b : CreativeGetV2DataListImageMode.values()) {
  ...
  public static class Adapter extends TypeAdapter<CreativeGetV2DataListImageMode> {
    @Override
    public void write(final JsonWriter jsonWriter, final CreativeGetV2DataListImageMode enumeration) throws IOException {
      jsonWriter.value(enumeration.getValue());
    }

    @Override
    public CreativeGetV2DataListImageMode read(final JsonReader jsonReader) throws IOException {
      String value = jsonReader.nextString();
      return CreativeGetV2DataListImageMode.fromValue(value);
    }
  }
}

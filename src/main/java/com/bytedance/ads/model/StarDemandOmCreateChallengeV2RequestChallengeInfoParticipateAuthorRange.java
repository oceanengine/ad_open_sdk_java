...
public class StarDemandOmCreateChallengeV2RequestChallengeInfoParticipateAuthorRange {
  ...
  private List<Long> uniqueIds = null;

  public StarDemandOmCreateChallengeV2RequestChallengeInfoParticipateAuthorRange() {
  }

  public StarDemandOmCreateChallengeV2RequestChallengeInfoParticipateAuthorRange uniqueIds(List<Long> uniqueIds) {
    
    this.uniqueIds = uniqueIds;
    return this;
  }

  public StarDemandOmCreateChallengeV2RequestChallengeInfoParticipateAuthorRange addUniqueIdsItem(Long uniqueIdsItem) {

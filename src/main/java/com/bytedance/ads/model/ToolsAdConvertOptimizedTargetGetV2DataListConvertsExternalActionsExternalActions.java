 ...
 * 
 */
@JsonAdapter(ToolsAdConvertOptimizedTargetGetV2DataListConvertsExternalActionsExternalActions.Adapter.class)
public enum ToolsAdConvertOptimizedTargetGetV2DataListConvertsExternalActionsExternalActions {
  ...
  ToolsAdConvertOptimizedTargetGetV2DataListConvertsExternalActionsExternalActions(String value) {
    this.value = value;
  }
  ...
  public static ToolsAdConvertOptimizedTargetGetV2DataListConvertsExternalActionsExternalActions fromValue(String value) {
    for (ToolsAdConvertOptimizedTargetGetV2DataListConvertsExternalActionsExternalActions b : ToolsAdConvertOptimizedTargetGetV2DataListConvertsExternalActionsExternalActions.values()) {
  ...
  public static class Adapter extends TypeAdapter<ToolsAdConvertOptimizedTargetGetV2DataListConvertsExternalActionsExternalActions> {
    @Override
    public void write(final JsonWriter jsonWriter, final ToolsAdConvertOptimizedTargetGetV2DataListConvertsExternalActionsExternalActions enumeration) throws IOException {
      jsonWriter.value(enumeration.getValue());
    }

    @Override
    public ToolsAdConvertOptimizedTargetGetV2DataListConvertsExternalActionsExternalActions read(final JsonReader jsonReader) throws IOException {
      String value = jsonReader.nextString();
      return ToolsAdConvertOptimizedTargetGetV2DataListConvertsExternalActionsExternalActions.fromValue(value);
    }
  }
}

...
public class PromotionScheduleTimeUpdateV30ResponseData {
  ...
  public PromotionScheduleTimeUpdateV30ResponseData errors(List<PromotionBidUpdateV30ResponseDataErrorsInner> errors) {
    
    this.errors = errors;
    return this;
  }

  public PromotionScheduleTimeUpdateV30ResponseData addErrorsItem(PromotionBidUpdateV30ResponseDataErrorsInner errorsItem) {
    if (this.errors == null) {

 ...
 * 
 */
@JsonAdapter(AdlabGroupListV30DataGroupsAdInfoDeepExternalAction.Adapter.class)
public enum AdlabGroupListV30DataGroupsAdInfoDeepExternalAction {
  ...
  AdlabGroupListV30DataGroupsAdInfoDeepExternalAction(String value) {
    this.value = value;
  }
  ...
  public static AdlabGroupListV30DataGroupsAdInfoDeepExternalAction fromValue(String value) {
    for (AdlabGroupListV30DataGroupsAdInfoDeepExternalAction b : AdlabGroupListV30DataGroupsAdInfoDeepExternalAction.values()) {
  ...
  public static class Adapter extends TypeAdapter<AdlabGroupListV30DataGroupsAdInfoDeepExternalAction> {
    @Override
    public void write(final JsonWriter jsonWriter, final AdlabGroupListV30DataGroupsAdInfoDeepExternalAction enumeration) throws IOException {
      jsonWriter.value(enumeration.getValue());
    }

    @Override
    public AdlabGroupListV30DataGroupsAdInfoDeepExternalAction read(final JsonReader jsonReader) throws IOException {
      String value = jsonReader.nextString();
      return AdlabGroupListV30DataGroupsAdInfoDeepExternalAction.fromValue(value);
    }
  }
}

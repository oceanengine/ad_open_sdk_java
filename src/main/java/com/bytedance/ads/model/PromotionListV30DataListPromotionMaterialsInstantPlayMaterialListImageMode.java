 ...
 * 
 */
@JsonAdapter(PromotionListV30DataListPromotionMaterialsInstantPlayMaterialListImageMode.Adapter.class)
public enum PromotionListV30DataListPromotionMaterialsInstantPlayMaterialListImageMode {
  ...
  PromotionListV30DataListPromotionMaterialsInstantPlayMaterialListImageMode(String value) {
    this.value = value;
  }
  ...
  public static PromotionListV30DataListPromotionMaterialsInstantPlayMaterialListImageMode fromValue(String value) {
    for (PromotionListV30DataListPromotionMaterialsInstantPlayMaterialListImageMode b : PromotionListV30DataListPromotionMaterialsInstantPlayMaterialListImageMode.values()) {
  ...
  public static class Adapter extends TypeAdapter<PromotionListV30DataListPromotionMaterialsInstantPlayMaterialListImageMode> {
    @Override
    public void write(final JsonWriter jsonWriter, final PromotionListV30DataListPromotionMaterialsInstantPlayMaterialListImageMode enumeration) throws IOException {
      jsonWriter.value(enumeration.getValue());
    }

    @Override
    public PromotionListV30DataListPromotionMaterialsInstantPlayMaterialListImageMode read(final JsonReader jsonReader) throws IOException {
      String value = jsonReader.nextString();
      return PromotionListV30DataListPromotionMaterialsInstantPlayMaterialListImageMode.fromValue(value);
    }
  }
}

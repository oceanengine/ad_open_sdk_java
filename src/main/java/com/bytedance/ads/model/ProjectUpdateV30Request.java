...
public class ProjectUpdateV30Request {
  ...
  **/
  ...
  @Override
  public int hashCode() {
    return Objects.hash(advertiserId, aigcDynamicCreativeSwitch, audience, audienceExtend, autoExtendTraffic, blueFlowPackage, deliverySetting, downloadMode, dpaCategories, dpaProductTarget, keywords, name, openUrl, openUrlField, openUrlParams, projectId, relatedProduct, searchBidRatio, trackUrlSetting, ulinkUrl);
  }

...
public class ProjectUpdateV30Request {
  ...
  **/
  ...
  @Override
  public int hashCode() {
    return Objects.hash(advertiserId, aigcDynamicCreativeSwitch, audience, audienceExtend, deliverySetting, downloadMode, dpaCategories, dpaProductTarget, keywords, name, openUrl, openUrlField, openUrlParams, projectId, searchBidRatio, trackUrlSetting, ulinkUrl);
  }

...
public class ProjectListV30Filtering {
  ...
  **/
  ...
  @Override
  public int hashCode() {
    return Objects.hash(adType, appPromotionType, blueFlowPackageSetting, budgetGroupId, deliveryMode, deliveryType, ids, inventoryType, landingType, marketingGoal, name, platform, pricing, projectCreateTime, projectModifyTime, starDeliveryType, status, statusFirst, statusSecond);
  }

...
public class QianchuanAwemeOrderDetailGetV10ResponseData {
  ...
  **/
  ...
  @Override
  public int hashCode() {
    return Objects.hash(adId, audience, auditRecord, awemeInfo, couponInfo, deliverySetting, marketingGoal, orderCreateTime, orderId, productInfo, roomInfo, status, videoInfo);
  }

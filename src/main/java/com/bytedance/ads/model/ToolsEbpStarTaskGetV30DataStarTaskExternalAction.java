 ...
 * 任务内选择的优化目标
 */
@JsonAdapter(ToolsEbpStarTaskGetV30DataStarTaskExternalAction.Adapter.class)
public enum ToolsEbpStarTaskGetV30DataStarTaskExternalAction {
  ...
  ToolsEbpStarTaskGetV30DataStarTaskExternalAction(String value) {
    this.value = value;
  }
  ...
  public static ToolsEbpStarTaskGetV30DataStarTaskExternalAction fromValue(String value) {
    for (ToolsEbpStarTaskGetV30DataStarTaskExternalAction b : ToolsEbpStarTaskGetV30DataStarTaskExternalAction.values()) {
  ...
  public static class Adapter extends TypeAdapter<ToolsEbpStarTaskGetV30DataStarTaskExternalAction> {
    @Override
    public void write(final JsonWriter jsonWriter, final ToolsEbpStarTaskGetV30DataStarTaskExternalAction enumeration) throws IOException {
      jsonWriter.value(enumeration.getValue());
    }

    @Override
    public ToolsEbpStarTaskGetV30DataStarTaskExternalAction read(final JsonReader jsonReader) throws IOException {
      String value = jsonReader.nextString();
      return ToolsEbpStarTaskGetV30DataStarTaskExternalAction.fromValue(value);
    }
  }
}

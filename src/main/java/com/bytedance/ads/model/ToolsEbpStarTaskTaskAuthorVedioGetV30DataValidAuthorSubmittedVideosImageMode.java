 ...
 * 
 */
@JsonAdapter(ToolsEbpStarTaskTaskAuthorVedioGetV30DataValidAuthorSubmittedVideosImageMode.Adapter.class)
public enum ToolsEbpStarTaskTaskAuthorVedioGetV30DataValidAuthorSubmittedVideosImageMode {
  ...
  ToolsEbpStarTaskTaskAuthorVedioGetV30DataValidAuthorSubmittedVideosImageMode(String value) {
    this.value = value;
  }
  ...
  public static ToolsEbpStarTaskTaskAuthorVedioGetV30DataValidAuthorSubmittedVideosImageMode fromValue(String value) {
    for (ToolsEbpStarTaskTaskAuthorVedioGetV30DataValidAuthorSubmittedVideosImageMode b : ToolsEbpStarTaskTaskAuthorVedioGetV30DataValidAuthorSubmittedVideosImageMode.values()) {
  ...
  public static class Adapter extends TypeAdapter<ToolsEbpStarTaskTaskAuthorVedioGetV30DataValidAuthorSubmittedVideosImageMode> {
    @Override
    public void write(final JsonWriter jsonWriter, final ToolsEbpStarTaskTaskAuthorVedioGetV30DataValidAuthorSubmittedVideosImageMode enumeration) throws IOException {
      jsonWriter.value(enumeration.getValue());
    }

    @Override
    public ToolsEbpStarTaskTaskAuthorVedioGetV30DataValidAuthorSubmittedVideosImageMode read(final JsonReader jsonReader) throws IOException {
      String value = jsonReader.nextString();
      return ToolsEbpStarTaskTaskAuthorVedioGetV30DataValidAuthorSubmittedVideosImageMode.fromValue(value);
    }
  }
}

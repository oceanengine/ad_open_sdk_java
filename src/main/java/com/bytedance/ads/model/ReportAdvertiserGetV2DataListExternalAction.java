 ...
 * 
 */
@JsonAdapter(ReportAdvertiserGetV2DataListExternalAction.Adapter.class)
public enum ReportAdvertiserGetV2DataListExternalAction {
  ...
  ReportAdvertiserGetV2DataListExternalAction(String value) {
    this.value = value;
  }
  ...
  public static ReportAdvertiserGetV2DataListExternalAction fromValue(String value) {
    for (ReportAdvertiserGetV2DataListExternalAction b : ReportAdvertiserGetV2DataListExternalAction.values()) {
  ...
  public static class Adapter extends TypeAdapter<ReportAdvertiserGetV2DataListExternalAction> {
    @Override
    public void write(final JsonWriter jsonWriter, final ReportAdvertiserGetV2DataListExternalAction enumeration) throws IOException {
      jsonWriter.value(enumeration.getValue());
    }

    @Override
    public ReportAdvertiserGetV2DataListExternalAction read(final JsonReader jsonReader) throws IOException {
      String value = jsonReader.nextString();
      return ReportAdvertiserGetV2DataListExternalAction.fromValue(value);
    }
  }
}

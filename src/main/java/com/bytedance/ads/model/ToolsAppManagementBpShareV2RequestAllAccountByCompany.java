...
public class ToolsAppManagementBpShareV2RequestAllAccountByCompany {
  ...
  public ToolsAppManagementBpShareV2RequestAllAccountByCompany accountType(List<String> accountType) {
    
    this.accountType = accountType;
    return this;
  }

  public ToolsAppManagementBpShareV2RequestAllAccountByCompany addAccountTypeItem(String accountTypeItem) {

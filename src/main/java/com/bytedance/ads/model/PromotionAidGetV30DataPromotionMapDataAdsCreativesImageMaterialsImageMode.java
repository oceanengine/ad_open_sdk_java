 ...
 * 
 */
@JsonAdapter(PromotionAidGetV30DataPromotionMapDataAdsCreativesImageMaterialsImageMode.Adapter.class)
public enum PromotionAidGetV30DataPromotionMapDataAdsCreativesImageMaterialsImageMode {
  ...
  PromotionAidGetV30DataPromotionMapDataAdsCreativesImageMaterialsImageMode(String value) {
    this.value = value;
  }
  ...
  public static PromotionAidGetV30DataPromotionMapDataAdsCreativesImageMaterialsImageMode fromValue(String value) {
    for (PromotionAidGetV30DataPromotionMapDataAdsCreativesImageMaterialsImageMode b : PromotionAidGetV30DataPromotionMapDataAdsCreativesImageMaterialsImageMode.values()) {
  ...
  public static class Adapter extends TypeAdapter<PromotionAidGetV30DataPromotionMapDataAdsCreativesImageMaterialsImageMode> {
    @Override
    public void write(final JsonWriter jsonWriter, final PromotionAidGetV30DataPromotionMapDataAdsCreativesImageMaterialsImageMode enumeration) throws IOException {
      jsonWriter.value(enumeration.getValue());
    }

    @Override
    public PromotionAidGetV30DataPromotionMapDataAdsCreativesImageMaterialsImageMode read(final JsonReader jsonReader) throws IOException {
      String value = jsonReader.nextString();
      return PromotionAidGetV30DataPromotionMapDataAdsCreativesImageMaterialsImageMode.fromValue(value);
    }
  }
}

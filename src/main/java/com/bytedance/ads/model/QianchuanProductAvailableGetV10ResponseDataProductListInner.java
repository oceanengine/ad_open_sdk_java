...
public class QianchuanProductAvailableGetV10ResponseDataProductListInner {
  ...
  **/
  ...
  @Override
  public int hashCode() {
    return Objects.hash(categoryName, discountHigherPrice, discountLowerPrice, discountPrice, id, img, imgList, inventory, marketPrice, name, productRate, saleTime, supportProductNewOpen, tags);
  }

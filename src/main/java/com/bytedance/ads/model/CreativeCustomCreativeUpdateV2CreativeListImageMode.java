 ...
 * 
 */
@JsonAdapter(CreativeCustomCreativeUpdateV2CreativeListImageMode.Adapter.class)
public enum CreativeCustomCreativeUpdateV2CreativeListImageMode {
  ...
  CreativeCustomCreativeUpdateV2CreativeListImageMode(String value) {
    this.value = value;
  }
  ...
  public static CreativeCustomCreativeUpdateV2CreativeListImageMode fromValue(String value) {
    for (CreativeCustomCreativeUpdateV2CreativeListImageMode b : CreativeCustomCreativeUpdateV2CreativeListImageMode.values()) {
  ...
  public static class Adapter extends TypeAdapter<CreativeCustomCreativeUpdateV2CreativeListImageMode> {
    @Override
    public void write(final JsonWriter jsonWriter, final CreativeCustomCreativeUpdateV2CreativeListImageMode enumeration) throws IOException {
      jsonWriter.value(enumeration.getValue());
    }

    @Override
    public CreativeCustomCreativeUpdateV2CreativeListImageMode read(final JsonReader jsonReader) throws IOException {
      String value = jsonReader.nextString();
      return CreativeCustomCreativeUpdateV2CreativeListImageMode.fromValue(value);
    }
  }
}

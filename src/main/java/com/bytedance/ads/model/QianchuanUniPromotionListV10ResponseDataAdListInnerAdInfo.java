...
public class QianchuanUniPromotionListV10ResponseDataAdListInnerAdInfo {
  ...
  **/
  ...
  @Override
  public int hashCode() {
    return Objects.hash(budget, budgetMode, compensateInfo, createTime, dailyDeliveryTime, deepExternalAction, deliverySeconds, endTime, id, marketingGoal, modifyTime, name, optStatus, roi2Goal, smartBidType, startTime, status);
  }

 ...
 * 
 */
@JsonAdapter(PromotionListV30DataListPromotionRelatedProductVideoMaterialListMaterialStatus.Adapter.class)
public enum PromotionListV30DataListPromotionRelatedProductVideoMaterialListMaterialStatus {
  ...
  PromotionListV30DataListPromotionRelatedProductVideoMaterialListMaterialStatus(String value) {
    this.value = value;
  }
  ...
  public static PromotionListV30DataListPromotionRelatedProductVideoMaterialListMaterialStatus fromValue(String value) {
    for (PromotionListV30DataListPromotionRelatedProductVideoMaterialListMaterialStatus b : PromotionListV30DataListPromotionRelatedProductVideoMaterialListMaterialStatus.values()) {
  ...
  public static class Adapter extends TypeAdapter<PromotionListV30DataListPromotionRelatedProductVideoMaterialListMaterialStatus> {
    @Override
    public void write(final JsonWriter jsonWriter, final PromotionListV30DataListPromotionRelatedProductVideoMaterialListMaterialStatus enumeration) throws IOException {
      jsonWriter.value(enumeration.getValue());
    }

    @Override
    public PromotionListV30DataListPromotionRelatedProductVideoMaterialListMaterialStatus read(final JsonReader jsonReader) throws IOException {
      String value = jsonReader.nextString();
      return PromotionListV30DataListPromotionRelatedProductVideoMaterialListMaterialStatus.fromValue(value);
    }
  }
}

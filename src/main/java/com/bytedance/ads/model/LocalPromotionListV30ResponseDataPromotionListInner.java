...
public class LocalPromotionListV30ResponseDataPromotionListInner {
  ...
  **/
  ...
  @Override
  public int hashCode() {
    return Objects.hash(adType, awemeId, awemeName, learningPhase, localAccountId, localDeliveryScene, projectId, promotionCreateTime, promotionId, promotionModifyTime, promotionName, promotionStatusFirst, promotionStatusSecond);
  }

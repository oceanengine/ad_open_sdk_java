 ...
 * 
 */
@JsonAdapter(AdGetV2DataDeepExternalAction.Adapter.class)
public enum AdGetV2DataDeepExternalAction {
  ...
  AdGetV2DataDeepExternalAction(String value) {
    this.value = value;
  }
  ...
  public static AdGetV2DataDeepExternalAction fromValue(String value) {
    for (AdGetV2DataDeepExternalAction b : AdGetV2DataDeepExternalAction.values()) {
  ...
  public static class Adapter extends TypeAdapter<AdGetV2DataDeepExternalAction> {
    @Override
    public void write(final JsonWriter jsonWriter, final AdGetV2DataDeepExternalAction enumeration) throws IOException {
      jsonWriter.value(enumeration.getValue());
    }

    @Override
    public AdGetV2DataDeepExternalAction read(final JsonReader jsonReader) throws IOException {
      String value = jsonReader.nextString();
      return AdGetV2DataDeepExternalAction.fromValue(value);
    }
  }
}

 ...
 * 
 */
@JsonAdapter(AdlabGroupDetailV30DataDataAdInfoExternalAction.Adapter.class)
public enum AdlabGroupDetailV30DataDataAdInfoExternalAction {
  ...
  AdlabGroupDetailV30DataDataAdInfoExternalAction(String value) {
    this.value = value;
  }
  ...
  public static AdlabGroupDetailV30DataDataAdInfoExternalAction fromValue(String value) {
    for (AdlabGroupDetailV30DataDataAdInfoExternalAction b : AdlabGroupDetailV30DataDataAdInfoExternalAction.values()) {
  ...
  public static class Adapter extends TypeAdapter<AdlabGroupDetailV30DataDataAdInfoExternalAction> {
    @Override
    public void write(final JsonWriter jsonWriter, final AdlabGroupDetailV30DataDataAdInfoExternalAction enumeration) throws IOException {
      jsonWriter.value(enumeration.getValue());
    }

    @Override
    public AdlabGroupDetailV30DataDataAdInfoExternalAction read(final JsonReader jsonReader) throws IOException {
      String value = jsonReader.nextString();
      return AdlabGroupDetailV30DataDataAdInfoExternalAction.fromValue(value);
    }
  }
}

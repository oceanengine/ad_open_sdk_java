 ...
 * 
 */
@JsonAdapter(StdProjectCreateV30ExternalAction.Adapter.class)
public enum StdProjectCreateV30ExternalAction {
  ...
  StdProjectCreateV30ExternalAction(String value) {
    this.value = value;
  }
  ...
  public static StdProjectCreateV30ExternalAction fromValue(String value) {
    for (StdProjectCreateV30ExternalAction b : StdProjectCreateV30ExternalAction.values()) {
  ...
  public static class Adapter extends TypeAdapter<StdProjectCreateV30ExternalAction> {
    @Override
    public void write(final JsonWriter jsonWriter, final StdProjectCreateV30ExternalAction enumeration) throws IOException {
      jsonWriter.value(enumeration.getValue());
    }

    @Override
    public StdProjectCreateV30ExternalAction read(final JsonReader jsonReader) throws IOException {
      String value = jsonReader.nextString();
      return StdProjectCreateV30ExternalAction.fromValue(value);
    }
  }
}

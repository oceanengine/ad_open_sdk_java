...
public class AssetsCreativeComponentGetV2Filtering {
  ...
  **/
  ...
  public AssetsCreativeComponentGetV2Filtering componentTypes(List<String> componentTypes) {
    
    this.componentTypes = componentTypes;
    return this;
  }

  public AssetsCreativeComponentGetV2Filtering addComponentTypesItem(String componentTypesItem) {
  ...
  **/
  ...
  public AssetsCreativeComponentGetV2Filtering status(List<String> status) {
    
    this.status = status;
    return this;
  }

  public AssetsCreativeComponentGetV2Filtering addStatusItem(String statusItem) {
    if (this.status == null) {

...
public class PromotionCreateV30Request {
  ...
  **/
  ...
  @Override
  public int hashCode() {
    return Objects.hash(_7dRetention, adDownloadStatus, advertiserId, autoExtendTraffic, bid, brandInfo, budget, budgetMode, configId, cpaBid, creativeAutoGenerateSwitch, deepCpabid, isCommentDisable, keywords, materialsType, name, nativeSetting, operation, projectId, promotionMaterials, roiGoal, shopMultiRoiGoals, source, unionBidRatio);
  }

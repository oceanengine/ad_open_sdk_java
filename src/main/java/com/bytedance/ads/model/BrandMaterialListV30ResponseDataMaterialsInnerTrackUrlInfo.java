...
public class BrandMaterialListV30ResponseDataMaterialsInnerTrackUrlInfo {
  ...
  public static final String SERIALIZED_NAME_CONTENT_TRACK_URL = "content_track_url";
  @SerializedName(SERIALIZED_NAME_CONTENT_TRACK_URL)
  private List<String> contentTrackUrl = null;
  ...
  **/
  ...
  public BrandMaterialListV30ResponseDataMaterialsInnerTrackUrlInfo contentTrackUrl(List<String> contentTrackUrl) {
    
    this.contentTrackUrl = contentTrackUrl;
    return this;
  }

  public BrandMaterialListV30ResponseDataMaterialsInnerTrackUrlInfo addContentTrackUrlItem(String contentTrackUrlItem) {
    if (this.contentTrackUrl == null) {
      this.contentTrackUrl = new ArrayList<>();
    }
    this.contentTrackUrl.add(contentTrackUrlItem);
    return this;
  }

   /**
   * 第三方上下文内容监测链接
   * @return contentTrackUrl
  **/
  @javax.annotation.Nullable
  public List<String> getContentTrackUrl() {
    return contentTrackUrl;
  }


  public void setContentTrackUrl(List<String> contentTrackUrl) {
    this.contentTrackUrl = contentTrackUrl;
  }
  ...
  **/
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.actionTrackUrl, brandMaterialListV30ResponseDataMaterialsInnerTrackUrlInfo.actionTrackUrl) &&
        ...
        Objects.equals(this.contentTrackUrl, brandMaterialListV30ResponseDataMaterialsInnerTrackUrlInfo.contentTrackUrl) &&
  ...
  @Override
  public int hashCode() {
    return Objects.hash(actionTrackUrl, cardShowTrackUrl, commentTrackUrl, contentTrackUrl, effectiveFrame, firstFrame, interactTrackUrl, lastFrame, likeCancelTrackUrl, likeTrackUrl, manualFrame, shareTrackUrl, trackUrl, trackUrlSendType);
  }
  ...
  public String toString() {
    ...
    sb.append("    contentTrackUrl: ").append(toIndentedString(contentTrackUrl)).append("\n");
  ...
  static {
    ...
    openapiFields.add("content_track_url");

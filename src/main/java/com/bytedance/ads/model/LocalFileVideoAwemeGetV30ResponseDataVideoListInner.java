...
public class LocalFileVideoAwemeGetV30ResponseDataVideoListInner {
  ...
  **/
  ...
  @Override
  public int hashCode() {
    return Objects.hash(awemeId, awemeName, awemeVideoUrl, canDelivery, coverImageUrl, duration, imageMode, itemId, legoMaterialId, notDeliveryReason, title, videoHeigh, videoId, videoWidth);
  }

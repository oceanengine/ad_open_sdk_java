...
public class PromotionListV30ResponseDataListInnerPromotionMaterials {
  ...
  **/
  ...
  @Override
  public int hashCode() {
    return Objects.hash(anchorMaterialList, callToActionButtons, componentMaterialList, decorationMaterial, dynamicCreativeSwitch, externalUrlField, externalUrlMaterialList, externalUrlParams, imageMaterialList, intelligentGeneration, miniProgramInfo, openUrl, openUrlField, openUrlParams, openUrlType, paramsType, playableUrlMaterialList, productInfo, textAbstractList, titleMaterialList, ulink, ulinkUrl, videoMaterialList, webUrlMaterialList);
  }

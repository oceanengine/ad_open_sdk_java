...
public class PromotionListV30ResponseDataListInnerPromotionMaterials {
  ...
  **/
  ...
  @Override
  public int hashCode() {
    return Objects.hash(advancedDcSettings, anchorMaterialList, blueFlowMaterialRecommend, callToActionButtons, carouselMaterialList, componentMaterialList, decorationMaterial, dynamicCreativeSwitch, externalUrlField, externalUrlMaterialList, externalUrlParams, imageMaterialList, intelligentGeneration, miniProgramInfo, openUrl, openUrlField, openUrlParams, openUrlType, openUrls, originalVideoTitle, paramsType, playableUrlMaterialList, playletSeriesUrlList, productInfo, textAbstractList, titleMaterialList, ulink, ulinkType, ulinkUrl, videoMaterialList, webUrlMaterialList);
  }

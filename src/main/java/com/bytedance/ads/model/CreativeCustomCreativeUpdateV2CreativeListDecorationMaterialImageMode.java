 ...
 * 
 */
@JsonAdapter(CreativeCustomCreativeUpdateV2CreativeListDecorationMaterialImageMode.Adapter.class)
public enum CreativeCustomCreativeUpdateV2CreativeListDecorationMaterialImageMode {
  ...
  CreativeCustomCreativeUpdateV2CreativeListDecorationMaterialImageMode(String value) {
    this.value = value;
  }
  ...
  public static CreativeCustomCreativeUpdateV2CreativeListDecorationMaterialImageMode fromValue(String value) {
    for (CreativeCustomCreativeUpdateV2CreativeListDecorationMaterialImageMode b : CreativeCustomCreativeUpdateV2CreativeListDecorationMaterialImageMode.values()) {
  ...
  public static class Adapter extends TypeAdapter<CreativeCustomCreativeUpdateV2CreativeListDecorationMaterialImageMode> {
    @Override
    public void write(final JsonWriter jsonWriter, final CreativeCustomCreativeUpdateV2CreativeListDecorationMaterialImageMode enumeration) throws IOException {
      jsonWriter.value(enumeration.getValue());
    }

    @Override
    public CreativeCustomCreativeUpdateV2CreativeListDecorationMaterialImageMode read(final JsonReader jsonReader) throws IOException {
      String value = jsonReader.nextString();
      return CreativeCustomCreativeUpdateV2CreativeListDecorationMaterialImageMode.fromValue(value);
    }
  }
}

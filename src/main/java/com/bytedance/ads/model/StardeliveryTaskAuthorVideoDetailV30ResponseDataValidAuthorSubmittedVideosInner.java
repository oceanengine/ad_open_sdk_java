...
public class StardeliveryTaskAuthorVideoDetailV30ResponseDataValidAuthorSubmittedVideosInner {
  ...
  **/
  ...
  @Override
  public int hashCode() {
    return Objects.hash(awemeId, duration, imageMode, itemId, materialId, starVideoPublishTime, starVideoStatus, videoCoverId, videoCoverUrl, videoId, videoPlayLink, videoTitle);
  }

...
public class StardeliveryTaskAuthorVideoDetailV30ResponseDataValidAuthorSubmittedVideosInner {
  ...
  **/
  ...
  @Override
  public int hashCode() {
    return Objects.hash(awemeId, duration, imageMode, itemId, materialId, materialProperties, starVideoBanReasonDetail, starVideoCusApprovalTime, starVideoDeliveryStatus, starVideoPublishTime, starVideoStatus, videoCoverId, videoCoverUrl, videoId, videoPlayLink, videoTitle);
  }

...
public class ToolsEventAllAssetsDetailV2ResponseDataAssetListInner {
  ...
  **/
  ...
  @Override
  public int hashCode() {
    return Objects.hash(appId, appName, appType, assetId, assetName, assetType, downloadUrl, microAppId, packageId, packageName, quickAppId, quickAppPackageName, siteId);
  }

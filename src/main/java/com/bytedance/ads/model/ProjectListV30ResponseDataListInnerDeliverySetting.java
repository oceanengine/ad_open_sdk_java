...
public class ProjectListV30ResponseDataListInnerDeliverySetting {
  ...
  **/
  ...
  @Override
  public int hashCode() {
    return Objects.hash(alreadyDeliveryDuration, bid, bidSpeed, bidType, budget, budgetMode, budgetOptimizeSwitch, cpaBid, deepBidType, deepCpabid, endTime, filterNightSwitch, firstRoiGoal, liveDuration, projectCustom, roiGoal, scheduleTime, scheduleType, searchContinueDelivery, sevenRoiGoal, shopMultiRoiGoals, startTime);
  }

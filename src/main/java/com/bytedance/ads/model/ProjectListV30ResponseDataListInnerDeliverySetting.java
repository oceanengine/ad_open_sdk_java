...
public class ProjectListV30ResponseDataListInnerDeliverySetting {
  ...
  **/
  ...
  @Override
  public int hashCode() {
    return Objects.hash(bid, bidSpeed, bidType, budget, budgetMode, budgetOptimizeSwitch, cpaBid, deepBidType, deepCpabid, endTime, filterNightSwitch, firstRoiGoal, projectCustom, roiGoal, scheduleTime, scheduleType, searchContinueDelivery, startTime);
  }

...
public class StarChallengeGetCustomTaskDataV2ResponseDataItemListInner {
  ...
  **/
  ...
  @Override
  public int hashCode() {
    return Objects.hash(androidConvertCount, authorInfo, comment, componentClickCount, contractMcnId, contractMcnName, convertCount, createTime, invalidAndroidConvertCount, invalidIosConvertCount, iosConvertCount, itemId, likeCnt, play, reserveCnt, reserveInstallCnt, rewardAmount, share, shareVv, title, uncorrelated, url, whiteComment, whiteLikeCnt, whiteShare);
  }

...
public class StarMcnGetContractChallengeAuthorItemListV2V2ResponseDataDataInner {
  ...
  **/
  ...
  @Override
  public int hashCode() {
    return Objects.hash(androidConvertCount, authorAmount, authorId, authorName, channelId, clueCnt, demandId, demandName, installFinishCnt, iosConvertCount, isOwn, itemId, mcnAmount, play, publishTime, sharePrice, sharePriceTotal, shareVv);
  }

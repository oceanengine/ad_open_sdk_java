...
public class StarMcnGetContractChallengeAuthorItemListV2V2ResponseDataDataInner {
  ...
  **/
  ...
  public StarMcnGetContractChallengeAuthorItemListV2V2ResponseDataDataInner settleTime(String settleTime) {
  ...
  **/
  ...
  @Override
  public int hashCode() {
    return Objects.hash(androidConvertCount, authorAmount, authorId, authorName, billDetail, channelId, clueCnt, coverUrl, demandId, demandName, douyinId, iaaCommercialIncomeHour, iaaIncome, iapOrderIncomeHour, installFinishCnt, iosConvertCount, isOwn, isViolated, itemClickRate, itemClickRateDouble, itemComment, itemFeelGood, itemForward, itemId, itemInfoDailyList, itemInteractRate, itemUrl, itemView, liveEffectData, mcnAmount, openState, overallAuditStatus, play, publishTime, serviceProviderAmount, settleTime, sharePrice, sharePriceHour, sharePriceTotal, sharePriceTotalHour, shareVv, smallGameSettle, uncorrelated, videoDurationMs, videoParticipateProviderChannel);
  }

...
public class StarMcnGetContractChallengeAuthorItemListV2V2ResponseDataDataInner {
  ...
  **/
  ...
  @Override
  public int hashCode() {
    return Objects.hash(androidConvertCount, authorAmount, authorId, authorName, billDetail, channelId, clueCnt, demandId, demandName, douyinId, iaaCommercialIncomeHour, iaaIncome, iapOrderIncomeHour, installFinishCnt, iosConvertCount, isOwn, isViolated, itemClickRate, itemClickRateDouble, itemComment, itemFeelGood, itemForward, itemId, itemInfoDailyList, itemInteractRate, itemView, mcnAmount, openState, overallAuditStatus, play, publishTime, serviceProviderAmount, sharePrice, sharePriceHour, sharePriceTotal, sharePriceTotalHour, shareVv, uncorrelated, videoParticipateProviderChannel);
  }

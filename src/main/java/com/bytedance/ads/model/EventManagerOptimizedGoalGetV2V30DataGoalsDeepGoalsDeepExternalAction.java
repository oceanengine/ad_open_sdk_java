 ...
 * 
 */
@JsonAdapter(EventManagerOptimizedGoalGetV2V30DataGoalsDeepGoalsDeepExternalAction.Adapter.class)
public enum EventManagerOptimizedGoalGetV2V30DataGoalsDeepGoalsDeepExternalAction {
  ...
  EventManagerOptimizedGoalGetV2V30DataGoalsDeepGoalsDeepExternalAction(String value) {
    this.value = value;
  }
  ...
  public static EventManagerOptimizedGoalGetV2V30DataGoalsDeepGoalsDeepExternalAction fromValue(String value) {
    for (EventManagerOptimizedGoalGetV2V30DataGoalsDeepGoalsDeepExternalAction b : EventManagerOptimizedGoalGetV2V30DataGoalsDeepGoalsDeepExternalAction.values()) {
  ...
  public static class Adapter extends TypeAdapter<EventManagerOptimizedGoalGetV2V30DataGoalsDeepGoalsDeepExternalAction> {
    @Override
    public void write(final JsonWriter jsonWriter, final EventManagerOptimizedGoalGetV2V30DataGoalsDeepGoalsDeepExternalAction enumeration) throws IOException {
      jsonWriter.value(enumeration.getValue());
    }

    @Override
    public EventManagerOptimizedGoalGetV2V30DataGoalsDeepGoalsDeepExternalAction read(final JsonReader jsonReader) throws IOException {
      String value = jsonReader.nextString();
      return EventManagerOptimizedGoalGetV2V30DataGoalsDeepGoalsDeepExternalAction.fromValue(value);
    }
  }
}

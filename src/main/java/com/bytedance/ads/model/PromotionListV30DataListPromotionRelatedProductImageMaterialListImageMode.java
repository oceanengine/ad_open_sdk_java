 ...
 * 
 */
@JsonAdapter(PromotionListV30DataListPromotionRelatedProductImageMaterialListImageMode.Adapter.class)
public enum PromotionListV30DataListPromotionRelatedProductImageMaterialListImageMode {
  ...
  PromotionListV30DataListPromotionRelatedProductImageMaterialListImageMode(String value) {
    this.value = value;
  }
  ...
  public static PromotionListV30DataListPromotionRelatedProductImageMaterialListImageMode fromValue(String value) {
    for (PromotionListV30DataListPromotionRelatedProductImageMaterialListImageMode b : PromotionListV30DataListPromotionRelatedProductImageMaterialListImageMode.values()) {
  ...
  public static class Adapter extends TypeAdapter<PromotionListV30DataListPromotionRelatedProductImageMaterialListImageMode> {
    @Override
    public void write(final JsonWriter jsonWriter, final PromotionListV30DataListPromotionRelatedProductImageMaterialListImageMode enumeration) throws IOException {
      jsonWriter.value(enumeration.getValue());
    }

    @Override
    public PromotionListV30DataListPromotionRelatedProductImageMaterialListImageMode read(final JsonReader jsonReader) throws IOException {
      String value = jsonReader.nextString();
      return PromotionListV30DataListPromotionRelatedProductImageMaterialListImageMode.fromValue(value);
    }
  }
}
